...
(function(){
  ...
  function renderTemplateInstallStatus(result){
    ...
    const title = template === 'weather' ? 'Weather demo installed' : (template === 'notes' ? 'Notes app installed' : (template === 'kanban' ? 'Kanban board installed' : (template === 'research' ? 'Research harness installed' : (template === 'dashboard' ? 'Dashboard demo installed' : (template === 'camera' ? 'Camera dashboard installed' : (template === 'browser' ? 'Browser surface installed' : (template === 'stock' ? 'Stock chart installed' : (template === 'service' ? 'Local service dashboard installed' : (template === 'model-setup' ? 'Model setup installed' : 'Template installed')))))))));
    const openLabel = template === 'weather' ? 'Open weather demo' : (template === 'notes' ? 'Open notes app' : (template === 'kanban' ? 'Open kanban board' : (template === 'research' ? 'Open research harness' : (template === 'dashboard' ? 'Open dashboard demo' : (template === 'camera' ? 'Open camera dashboard' : (template === 'browser' ? 'Open browser surface' : (template === 'stock' ? 'Open stock chart' : (template === 'service' ? 'Open local service dashboard' : (template === 'model-setup' ? 'Open model setup' : 'Open Space')))))))));
    const manageLabel = template === 'weather' ? 'Manage weather widget' : (template === 'notes' ? 'Manage notes widgets' : (template === 'kanban' ? 'Manage kanban widgets' : (template === 'research' ? 'Manage research widgets' : (template === 'dashboard' ? 'Manage dashboard widgets' : (template === 'camera' ? 'Manage camera widgets' : (template === 'browser' ? 'Manage browser widgets' : (template === 'stock' ? 'Manage stock widgets' : (template === 'service' ? 'Manage service widgets' : (template === 'model-setup' ? 'Manage provider widgets' : 'Manage widgets')))))))));
