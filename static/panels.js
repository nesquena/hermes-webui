...
async function promptWorkspacePath(){
  ...
  if(!S.session){
    ...
    try{
      ...
      if(r&&r.session){S._pendingSessionToolsets=null;if(typeof setWorkspaceSearchSession==='function')setWorkspaceSearchSession(r.session);S.messages=[];if(typeof syncTopbar==='function')syncTopbar();if(typeof renderMessages==='function')renderMessages();if(typeof renderSessionList==='function')await renderSessionList();}
