...
const LOCALES = {
  ...
  folder_add_as_space_title: 'Add as Space?',
    ...
    login_title: 'Sign in',
    mcp_servers_title: 'سيرفرات MCP',
    mcp_servers_desc: 'عرض سيرفرات MCP المُعدّة في config.yaml',
    mcp_no_servers: 'لم يتم إعداد أي سيرفرات MCP',
    mcp_add_server: '+ إضافة سيرفر',
    mcp_field_name: 'اسم السيرفر',
    mcp_transport_label: 'نوع النقل',
    mcp_field_command: 'الأمر',
    mcp_field_args: 'المعاملات (مفصولة بفاصلة)',
    mcp_field_url: 'الرابط',
    mcp_field_timeout: 'مهلة الانتظار (بالثواني)',
    mcp_save: 'حفظ',
    mcp_cancel: 'إلغاء',
    mcp_name_required: 'اسم السيرفر مطلوب',
    mcp_url_required: 'الرابط مطلوب لنقل HTTP',
    mcp_command_required: 'الأمر مطلوب لنقل stdio',
    mcp_saved: 'تم حفظ سيرفر MCP',
    mcp_save_failed: 'فشل حفظ سيرفر MCP',
    mcp_delete_confirm_title: 'حذف سيرفر MCP',
    mcp_delete_confirm_message: 'حذف سيرفر MCP "{0}"؟ لا يمكن التراجع عن هذا الإجراء.',
    diff_loading: 'تحميل المقارنة',
    diff_error: 'تعذر تحميل ملف التصحيح',
    diff_too_large: 'ملف التصحيح كبير جداً للعرض',
    error: 'خطأ',
    failed: 'فشل',
    pasted: 'تم اللصق',
    selected_text_reply: 'رد بالتحديد',
    selected_text_reply_title: 'إلحاق نص المحادثة المحدد كسياق مقتبس',
    selected_text_reply_appended: 'تمت إضافة النص المحدد إلى المحرر',
  ...
  ar: {
    ...
    offline_browser_detail: 'المتصفح يشير إلى أن هذا الجهاز غير متصل بالإنترنت.',
    offline_network_detail: 'Hermes لا يمكن الوصول إليه من هذا المتصفح حالياً.',
    offline_autorefresh: 'سيتم تحديث الصفحة تلقائياً عند استعادة الاتصال.',
    offline_check_now: 'تحقق الآن',
    offline_checking: 'جارٍ التحقق…',
    offline_stream_waiting: 'انقطع الاتصال. في انتظار التحديث…',
    cancelling: 'جارٍ الإلغاء…',
    cancel_failed: 'فشل الإلغاء: ',
    mic_denied: 'تم رفض الوصول إلى الميكروفون. تحقق من أذونات المتصفح.',
    mic_no_speech: 'لم يتم اكتشاف أي كلام. حاول مرة أخرى.',
    ...
    voice_speaking: 'جارٍ التحدث…',
    voice_thinking: 'جارٍ التفكير…',
    voice_error: 'الوضع الصوتي غير مدعوم في هذا المتصفح',
    voice_mode_active: 'الوضع الصوتي مفعّل',
    voice_mode_off: 'الوضع الصوتي معطّل',
    session_imported: 'تم استيراد المحادثة',
    ...
    reconnect_active: 'الرد لا يزال قيد التوليد. هل تريد التحديث؟',
    reconnect_finished: 'كان هناك رد قيد التوليد عند آخر مغادرة. ربما تم تحديث الرسائل.',
    approval_heading: 'مطلوب موافقة',
    approval_desc_prefix: 'تم اكتشاف أمر خطير',
    approval_btn_once: 'اسمح مرة واحدة',
    approval_btn_once_title: 'السماح بهذا الأمر لمرة واحدة (Enter)',
    approval_btn_session: 'اسمح للجلسة',
    approval_btn_session_title: 'السماح لجلسة المحادثة هذه',
    approval_btn_always: 'اسمح دائماً',
    approval_btn_always_title: 'السماح دائماً بهذا النمط من الأوامر',
    approval_btn_deny: 'ارفض',
    approval_btn_deny_title: 'ارفض — لا تقم بتشغيل هذا الأمر',
    approval_responding: 'جارٍ الرد…',
    clarify_heading: 'مطلوب توضيح',
    clarify_hint: 'اختر إجابة، أو اكتب ردك أدناه.',
    clarify_other: 'أخرى',
    clarify_send: 'إرسال',
    clarify_input_placeholder: 'اكتب ردك…',
    clarify_responding: 'جارٍ الرد…',
    untitled: 'بدون عنوان',
    load_older_messages: '↑ مرر للأعلى أو انقر لتحميل الرسائل القديمة',
    session_jump_start: 'البداية',
    session_jump_start_label: 'الانتقال إلى بداية المحادثة',
    session_jump_end: 'النهاية',
    session_jump_end_label: 'الانتقال إلى نهاية المحادثة',
    jump_to_question: 'إلى السؤال',
    jump_to_question_label: 'الانتقال إلى السؤال الخاص بهذا الرد',
    queued_label: 'يرسل بعد الرد',
    queued_cancel: 'إلغاء الرسالة المنتظرة',
    model_unavailable: ' (غير متاح)',
    model_unavailable_title: 'هذا النموذج لم يعد موجوداً في قائمة المزوّدين',
    model_custom_label: 'معرف نموذج مخصص',
    model_custom_placeholder: 'مثال: openai/gpt-5.4',
    model_search_placeholder: 'ابحث عن النماذج…',
    model_search_no_results: 'لم يتم العثور على نماذج',
    model_group_configured: 'مُعدّ',
    model_scope_advisory: 'يُطبّق على هذه المحادثة من رسالتك التالية.',
    model_scope_toast: 'يُطبّق على هذه المحادثة من رسالتك التالية.',
    cmd_clear: 'مسح رسائل المحادثة',
    cmd_compress: 'ضغط سياق المحادثة يدوياً',
    ctx_compress_hint: 'ضغط السياق لتوفير المساحة →',
    ctx_compress_action: '⚠ اضغط الآن لتحرير السياق',
    cmd_compact_alias: 'اسم مستعار قديم لـ /compress',
    cmd_model: 'تبديل النموذج (مثال: /model gpt-4o)',
    cmd_workspace: 'تبديل مساحة العمل بالاسم',
    cmd_terminal: 'فتح الطرفية',
    cmd_new: 'بدء محادثة جديدة',
    cmd_usage: 'تشغيل/إيقاف عرض استخدام الرموز',
    cmd_theme: 'تبديل المظهر (theme: system/dark/light, skin: ...)',
    cmd_personality: 'تبديل شخصية الوكيل',
    cmd_skills: 'عرض مهارات Hermes المتاحة',
    ...
    reference_only_label: 'للمرجع فقط',
    model_usage: 'الاستخدام: /model <الاسم>',
    token_usage_on: 'عرض الرموز مفعّل',
    token_usage_off: 'عرض الرموز معطّل',
    theme_usage: 'الاستخدام: /theme ',
    no_active_session: 'لا توجد جلسة نشطة',
    cmd_queue: 'إضافة رسالة إلى قائمة الانتظار للدورة التالية',
    cmd_goal: 'تعيين أو فحص هدف دائم',
    cmd_interrupt: 'إلغاء الدورة الحالية وإرسال رسالة جديدة',
    cmd_steer: 'حقن تصحيح منتصف الدورة دون مقاطعة الوكيل',
    cmd_stop: 'إيقاف الرد الحالي',
    cmd_title: 'عرض أو تعيين عنوان المحادثة',
    cmd_retry: 'إعادة إرسال آخر رسالة',
    cmd_undo: 'حذف آخر تبادل',
    cmd_btw: 'طرح سؤال جانبي (مؤقت)',
    cmd_background: 'تشغيل موجه في الخلفية',
    cmd_branch: 'تفرع هذه المحادثة إلى جلسة جديدة',
    cmd_status: 'عرض معلومات الجلسة',
    cmd_voice: 'تبديل إدخال الميكروفون',
    stream_stopped: 'تم إيقاف الرد.',
    no_active_task: 'لا توجد مهمة نشطة للإيقاف.',
    cancel_unavailable: 'الإلغاء غير متاح.',
    undo_exchange: 'التراجع عن آخر تبادل',
    status_heading: 'حالة المحادثة',
    status_session_id: 'معرف الجلسة',
    ...
    status_hermes_home: 'مجلد Hermes',
    status_started: 'بدأت',
    status_updated: 'حُدثت',
    status_tokens: 'الرموز',
    status_ephemeral: 'لقطة مؤقتة — لم تُحفظ في سجل المحادثات.',
    status_no_tokens: 'لم تُستخدم أي رموز',
    ...
    workspace_empty_no_path: 'لم يتم تحديد مساحة عمل. حدد مساحة عمل في الإعدادات لتصفح الملفات.',
    workspace_empty_dir: 'مساحة العمل هذه فارغة.',
    workspace_show_hidden_files: 'إظهار الملفات المخفية',
    workspace_options: 'خيارات مساحة العمل',
    dialog_confirm_title: 'تأكيد الإجراء',
    dialog_prompt_title: 'أدخل قيمة',
    dialog_confirm_btn: 'تأكيد',
    unsaved_confirm: 'لديك تغييرات غير محفوظة. هل تريد تجاهلها والانتقال؟',
    discard: 'تجاهل',
    save: 'حفظ',
    edit: 'تعديل',
    clear: 'مسح',
    ...
    path_copied: 'تم نسخ مسار الملف إلى الحافظة',
    path_copy_failed: 'فشل نسخ المسار: ',
    session_rename: 'إعادة تسمية المحادثة',
    session_rename_desc: 'تعديل عنوان هذه المحادثة',
    ...
    session_unpin: 'إلغاء التثبيت',
    session_archive: 'أرشفة المحادثة',
    session_restore: 'استعادة المحادثة',
    session_archived: 'تمت أرشفة المحادثة',
    session_restored: 'تمت استعادة المحادثة',
    session_duplicate: 'نسخ المحادثة',
    session_duplicated: 'تم نسخ المحادثة',
    session_delete: 'حذف المحادثة',
    session_delete_confirm: 'حذف هذه المحادثة؟',
    session_deleted: 'تم حذف المحادثة',
    ...
    settings_heading_subtitle: 'التفضيلات، أدوات المحادثة، وإعدادات النظام.',
    ...
    settings_section_preferences_meta: 'الإعدادات الافتراضية وسلوك واجهة Hermes.',
    settings_section_system_title: 'النظام',
    settings_section_system_meta: 'إصدار النسخة وإعدادات الوصول.',
    settings_tab_conversation: 'المحادثة',
    settings_tab_appearance: 'المظهر',
    settings_tab_preferences: 'التفضيلات',
    settings_tab_plugins: 'الإضافات',
    ...
    settings_autosave_saving: 'جارٍ الحفظ…',
    ...
    settings_label_external_sessions: 'إظهار جلسات CLI',
    settings_label_sync_insights: 'مزامنة مع الإحصائيات',
    settings_label_check_updates: 'التحقق من التحديثات',
    settings_label_bot_name: 'اسم المساعد',
    settings_label_password: 'كلمة المرور',
    ...
    settings_label_rtl: 'اتجاه النص من اليمين لليسار (RTL)',
    settings_desc_rtl: 'عكس اتجاه نص المحادثة للغات التي تكتب من اليمين لليسار.',
    settings_label_sound: 'الأصوات',
    settings_desc_sound: 'تشغيل صوت عند اكتمال الردود.',
    settings_label_tts: 'تحويل النص إلى كلام (TTS)',
    settings_desc_tts: 'تمكين زر القراءة الصوتية على الرسائل.',
    settings_label_tts_auto_read: 'قراءة تلقائية',
    settings_label_tts_voice: 'الصوت',
    settings_label_tts_rate: 'السرعة',
    settings_label_tts_pitch: 'النغمة',
    settings_label_notifications: 'الإشعارات',
    settings_label_api_redact: 'إخفاء مفاتيح API في السجلات',
    settings_label_workspace_panel_open: 'إبقاء لوحة مساحة العمل مفتوحة',
    settings_label_session_jump_buttons: 'إظهار أزرار التنقل في المحادثة',
    settings_label_session_endless_scroll: 'تحميل الرسائل القديمة أثناء التمرير',
    settings_label_fade_text_effect: 'تأثير تلاشي النص',
    settings_label_busy_input_mode: 'وضع الإدخال أثناء الانشغال',
    settings_busy_input_mode_queue: 'انتظار في الطابور',
    settings_busy_input_mode_interrupt: 'مقاطعة الدورة الحالية',
    settings_busy_input_mode_steer: 'توجيه (تصحيح منتصف الدورة)',
    settings_sidebar_density_compact: 'مضغوط',
    settings_sidebar_density_detailed: 'مفصّل',
    settings_label_auto_title_refresh: 'تحديث تلقائي للعنوان',
    settings_auto_title_refresh_off: 'معطّل',
    settings_desc_auto_title_refresh: 'تحديث عنوان المحادثة تلقائياً كل عدة رسائل.',
    providers_tab_title: 'المزوّدون',
    providers_status_configured: 'مُعدّ',
    providers_status_not_configured: 'غير مُعدّ',
    providers_enter_key: 'أدخل المفتاح',
    providers_empty: 'لم يتم العثور على مزوّدين',
    providers_save: 'حفظ',
    providers_remove: 'إزالة',
    login_title: 'تسجيل الدخول',    mcp_add_server: '+ إضافة سيرفر',
    mcp_cancel: 'إلغاء',
    mcp_saved: 'تم حفظ سيرفر MCP',
    diff_loading: 'تحميل المقارنة',
    diff_error: 'تعذر تحميل ملف التصحيح',
    ...
    login_subtitle: 'أدخل كلمة المرور للوصول إلى Hermes',
    login_placeholder: 'كلمة المرور',
    login_btn: 'دخول',
    login_invalid_pw: 'كلمة مرور غير صالحة',
    login_conn_failed: 'فشل الاتصال بالخادم',
    tab_chat: 'المحادثة',
    tab_tasks: 'المهام',
    tab_skills: 'المهارات',
    tab_memory: 'الذاكرة',
    tab_workspaces: 'المساحات',
    tab_profiles: 'الملفات',
    tab_kanban: 'كانبان',
    tab_todos: 'المهام الحالية',
    tab_insights: 'الإحصائيات',
    tab_dashboard: 'لوحة Hermes',
    tab_logs: 'السجلات',
    tab_settings: 'الإعدادات',
    dashboard_loopback_warning: 'لا يمكن فتح لوحة Hermes في إطار مضمن — تُفتح في نافذة منفصلة.',
    new_conversation: 'محادثة جديدة',
    filter_conversations: 'تصفية المحادثات…',
    loading: 'جارٍ التحميل…',
    scheduled_jobs: 'المهام المجدولة',
    new_job: 'مهمة جديدة',
    search_skills: 'ابحث في المهارات…',
    new_skill: 'مهارة جديدة',
    personal_memory: 'الذاكرة الشخصية',
    current_task_list: 'قائمة المهام الحالية',
    logs_file: 'الملف',
    logs_tail: 'آخر',
    logs_auto_refresh: 'تحديث تلقائي (5 ثوان)',
    logs_wrap: 'التفاف الأسطر',
    logs_copy_all: 'نسخ الكل',
    logs_empty: 'لا توجد سجلات.',
    logs_loading: 'جارٍ تحميل السجلات…',
    logs_load_failed: 'فشل تحميل السجلات',
    logs_severity: 'المستوى',
    logs_severity_all: 'الكل',
    logs_severity_errors: 'أخطاء',
    logs_severity_warnings: 'تحذيرات+',
    insights_title: 'الإحصائيات',
    insights_sessions: 'جلسات',
    insights_messages: 'رسائل',
    insights_tokens: 'رموز',
    insights_cost: 'التكلفة',
    workspace_desc: 'أضف وبدّل مساحات العمل لمحادثاتك.',
    new_profile: 'ملف جديد',
    transcript: 'النص',
    download_transcript: 'تحميل النص',
    import: 'استيراد',
    export_session_json: 'تصدير JSON',
    import_session_json_tooltip: 'استيراد محادثة من ملف JSON',
    empty_title: 'كيف يمكنني مساعدتك؟',
    empty_subtitle: 'اسأل أي شيء، شغّل أوامر، تصفح الملفات، أو أدر مهامك المجدولة.',
    suggest_files: 'ما الملفات الموجودة في مساحة العمل؟',
    suggest_schedule: 'ماذا في جدول أعمالي اليوم؟',
    suggest_plan: 'ساعدني في تخطيط مشروع صغير.',
    onboarding_badge: 'الإعداد الأولي',
    onboarding_title: 'مرحباً بك في Hermes',
    onboarding_lead: 'لنقم بإعداد واجهة الويب الخاصة بك في بضع خطوات.',
    onboarding_back: 'رجوع',
    onboarding_continue: 'متابعة',
    onboarding_skip: 'تخطي',
    onboarding_skipped: 'تم التخطي',
    onboarding_open: 'فتح الإعداد',
    onboarding_step_system_title: 'النظام',
    onboarding_step_setup_title: 'الإعداد',
    onboarding_step_workspace_title: 'مساحة العمل',
    onboarding_step_password_title: 'كلمة المرور',
    onboarding_step_finish_title: 'إنهاء',
    cron_no_jobs: 'لا توجد مهام مجدولة.',
    cron_status_active: 'نشط',
    cron_status_paused: 'متوقف',
    ...
    cron_job_paused: 'تم إيقاف المهمة',
    ...
    skill_load_failed: 'فشل تحميل المهارة',
    ...
    skills_empty_title: 'لا توجد مهارات بعد',
    skills_empty_sub: 'قم بإنشاء أول مهارة لتعليم Hermes مهام متكررة.',
    skills_edit: 'تعديل',
    skills_delete: 'حذف',
    skills_back_to: 'العودة إلى',
    skill_name: 'اسم المهارة',
    skill_category: 'التصنيف',
    skill_content: 'المحتوى',
    kanban_board: 'لوحة كانبان',
    kanban_search_tasks: 'ابحث عن المهام…',
    kanban_include_archived: 'تضمين المؤرشفة',
    kanban_no_matching_tasks: 'لا توجد مهام مطابقة.',
    kanban_empty: 'لا توجد مهام لعرضها.',
    kanban_refresh: 'تحديث',
    kanban_new_task: 'مهمة جديدة',
    kanban_edit_task: 'تعديل المهمة',
    kanban_only_mine: 'مهامي فقط',
    kanban_bulk_action: 'إجراء جماعي',
    kanban_title_required: 'عنوان المهمة مطلوب.',
    kanban_status_triage: 'فرز',
    kanban_status_todo: 'للعمل',
    kanban_status_ready: 'جاهز',
    kanban_status_running: 'قيد التنفيذ',
    kanban_status_blocked: 'معطّل',
    kanban_status_done: 'مكتمل',
    kanban_status_archived: 'مؤرشفة',
    todos_no_active: 'لا توجد مهام حالية.',
    memory_notes_label: 'ملاحظاتي',
    memory_saved: 'تم الحفظ',
    my_notes: 'ملاحظاتي',
    ...
    clear_conversation_message: 'مسح جميع الرسائل في هذه المحادثة؟',
    clear_failed: 'فشل المسح: ',
    sign_out: 'تسجيل الخروج',
    disable_auth: 'تعطيل المصادقة',
    composer_send: 'إرسال رسالة',
    composer_queue: 'إضافة للطابور',
    ...
    composer_placeholder: 'اكتب رسالة إلى Hermes…',
    composer_mobile_workspace: 'مساحة العمل',
    composer_mobile_model: 'النموذج',
    composer_mobile_reasoning: 'الاستدلال',
    composer_mobile_context: 'السياق',
    media_audio_label: 'صوت',
    media_svg_label: 'رسم بياني',
    media_video_label: 'فيديو',
    yolo_no_session: 'لا توجد جلسة نشطة',
    yolo_enabled: '⚡ وضع YOLO مفعّل — تم تجاهل الموافقات لهذه الجلسة',
    yolo_disabled: 'تم تعطيل وضع YOLO',
    yolo_pill_label: 'YOLO',
    approval_skip_all: '⚡ تخطي الكل',
    approval_skip_all_title: 'تخطي جميع طلبات الموافقة لهذه الجلسة',
    pdf_loading: 'جارٍ تحميل PDF…',
    pdf_too_large: 'ملف PDF كبير جداً للمعاينة',
    pdf_no_pages: 'لا يحتوي PDF على صفحات',
    pdf_error: 'فشل عرض معاينة PDF',
    pdf_download: 'تحميل PDF',
    html_loading: 'جارٍ تحميل معاينة HTML…',
    html_too_large: 'HTML كبير جداً للمعاينة',
    html_error: 'فشل عرض معاينة HTML',
    html_open_full: 'فتح الصفحة كاملة',
    html_sandbox_label: 'معاينة HTML (معزولة)',
    csv_loading: 'جارٍ تحميل CSV',
    csv_too_large: 'ملف CSV كبير جداً للعرض',
    csv_no_data: 'لا يحتوي CSV على بيانات كافية للعرض كجدول',
    csv_error: 'فشل تحميل CSV',
    csv_header_note: 'الصف الأول معروض كرأس للجدول',
    excalidraw_loading: 'جارٍ تحميل الرسم',
    excalidraw_too_large: 'ملف Excalidraw كبير جداً للمعاينة',
    excalidraw_invalid: 'تنسيق ملف Excalidraw غير صالح',
    excalidraw_error: 'فشل تحميل Excalidraw',
    excalidraw_label: 'رسم بياني',
    excalidraw_download: 'تحميل',
    excalidraw_empty: 'رسم فارغ',
    excalidraw_render_error: 'فشل عرض الرسم',
    excalidraw_simplified: 'معاينة SVG مبسطة',
    checkpoint_title: 'نقاط التحقق',
    checkpoint_empty: 'لا توجد نقاط تحقق لمساحة العمل هذه.',
    checkpoint_loading: 'جارٍ تحميل نقاط التحقق…',
    checkpoint_error: 'فشل تحميل نقاط التحقق',
    checkpoint_date: 'التاريخ',
    checkpoint_message: 'الرسالة',
    checkpoint_files: 'الملفات',
    checkpoint_view_diff: 'عرض الفروقات',
    checkpoint_restore: 'استعادة',
    checkpoint_restore_confirm_title: 'استعادة نقطة التحقق؟',
    checkpoint_restored: 'تمت استعادة نقطة التحقق',
    checkpoint_diff_title: 'تغييرات نقطة التحقق',
    checkpoint_diff_no_changes: 'لم يتم العثور على فروقات بين نقطة التحقق ومساحة العمل الحالية.',
    session_worktree_badge: 'شجرة عمل',
    fork_from_here: 'تفرع من هنا',
    forked_from: 'متفرع من',
    subagent_children: 'جلسات الوكيل الفرعي',
    provider_mismatch_label: 'عدم تطابق المزوّد',
    model_not_found_label: 'النموذج غير موجود',
    workspace_new_worktree_conversation: 'محادثة جديدة في شجرة عمل',
    workspace_worktree_created: 'تم إنشاء محادثة شجرة العمل',
    workspace_worktree_failed: 'فشل إنشاء شجرة العمل: ',
    ws_search_placeholder: 'ابحث في مساحات العمل…',
    ws_no_results: 'لم يتم العثور على مساحات عمل',
    password_placeholder: 'أدخل كلمة المرور',
    password_env_var_locked: 'مقفلة عبر متغير البيئة',
    goal_working_toward: 'العمل نحو الهدف…',
    goal_cleared: 'تم مسح الهدف.',
    goal_no_goal: 'لا يوجد هدف نشط.',
    active_conversation_none: 'لا توجد محادثة نشطة',
    // ── Phase 3: full coverage translations (batch 1) ──
    auto_compress_label: 'ضغط تلقائي',
    bg_complete: 'اكتملت المهمة الخلفية',
    bg_error_multi: 'فشلت {0} مهام خلفية',
    bg_error_single: 'فشلت مهمة خلفية: ',
    bg_failed: 'فشلت المهمة الخلفية: ',
    bg_label: 'نتيجة الخلفية:',
    bg_no_answer: '(لا يوجد رد)',
    bg_running: 'جارٍ التشغيل في الخلفية...',
    branch_failed: 'فشل التفرع: ',
    branch_forked: 'تم التفرع إلى جلسة جديدة',
    btw_asking: 'جارٍ طرح سؤال جانبي...',
    btw_done: 'تمت الإجابة على السؤال الجانبي',
    btw_failed: 'فشل السؤال الجانبي: ',
    btw_label: 'سؤال جانبي — ليس في السجل',
    btw_no_answer: 'لم يتم استلام رد.',
    busy_interrupt_confirm: 'تمت المقاطعة — جارٍ إرسال رسالة جديدة',
    busy_steer_fallback: 'التوجيه غير متاح — تمت الإضافة للطابور',
    cmd_background_usage: '/background <موجه> — تشغيل في الخلفية',
    cmd_btw_usage: '/btw <سؤال> — طرح سؤال جانبي باستخدام السياق',
    cmd_interrupt_confirm: 'تمت المقاطعة — جارٍ إرسال رسالة جديدة',
    cmd_interrupt_no_msg: 'الاستخدام: /interrupt <رسالة>',
    cmd_queue_confirm: 'تمت إضافة الرسالة للطابور',
    cmd_queue_no_msg: 'الاستخدام: /queue <رسالة>',
    cmd_steer_delivered: 'تم تسليم التوجيه للوكيل',
    cmd_steer_fallback: 'التوجيه غير متاح — تمت الإضافة للطابور',
    cmd_steer_no_msg: 'الاستخدام: /steer <رسالة>',
    cmd_voice_use_mic: 'انقر على زر الميكروفون في شريط الإدخال.',
    cmd_webui_only_session: 'هذا الأمر غير متاح للمحادثات المستوردة من CLI.',
    composer_disabled_compression: 'في انتظار اكتمال الضغط',
    compress_complete_label: 'اكتمل الضغط',
    compress_failed_label: 'فشل الضغط',
    compress_running_label: 'جارٍ الضغط',
    compressing: 'جارٍ طلب ضغط السياق...',
    focus_label: 'التركيز',
    // ── Batch 1 end ──
    clear_conversation_btn_tooltip: 'مسح جميع الرسائل',
    cron_duplicate: 'نسخ المهمة',
    export_session_json_tooltip: 'تصدير هذه المحادثة بصيغة JSON',
    kanban_assignee: 'المسند إليه',
    kanban_assignee_hint: 'شخص أو دور مسؤول عن المهمة',
    kanban_board_color: 'لون اللوحة',
    kanban_board_description: 'وصف اللوحة',
    kanban_board_icon: 'أيقونة اللوحة',
    kanban_board_name: 'اسم اللوحة',
    kanban_board_slug: 'المعرف المختصر للّوحة',
    kanban_description: 'الوصف',
    kanban_description_placeholder: 'وصف المهمة…',
    kanban_new_board: 'لوحة جديدة',
    kanban_nudge_dispatcher: 'معاينة التوزيع',
    kanban_run_dispatcher_confirm: 'تشغيل الموزع؟ سيقوم بتوزيع المهام الجاهزة على العمال.',
    kanban_add_comment: 'إضافة تعليق',
    kanban_archive_board: 'أرشفة اللوحة',
    kanban_archive_board_confirm: 'أرشفة هذه اللوحة؟',
    kanban_rename_board: 'إعادة تسمية اللوحة',
    kanban_board_archived: 'تمت أرشفة اللوحة',
    kanban_unassigned: 'غير مسند',
    kanban_block: 'تعطيل',
    kanban_unblock: 'إلغاء التعطيل',
    kanban_back_to_board: 'العودة للوحة',
    kanban_assignee_other_label: 'آخرين',
    kanban_assignee_profiles_label: 'الملفات الشخصية',
    kanban_assignee_unassigned: 'غير مسند',
    kanban_ready_needs_assignee: 'المهام الجاهزة تحتاج إلى مسند إليه',
    kanban_status_original_hint: 'الحالة الأصلية: ',
    kanban_dispatch_preview_prefix: 'معاينة: ',
    kanban_dispatch_run_prefix: 'تشغيل: ',
    kanban_dispatch_spawned: 'تم تشغيله',
    kanban_dispatch_promoted: 'تمت ترقيته',
    kanban_dispatch_reclaimed: 'تمت استعادته',
    kanban_dispatch_skipped_unassigned: 'تم تخطيه (غير مسند)',
    kanban_dispatch_skipped_nonspawnable: 'تم تخطيه (غير قابل للتشغيل)',
    kanban_dispatch_auto_blocked: 'مُعطّل تلقائياً',
    kanban_dispatch_timed_out: 'انتهت مهلة التشغيل',
    kanban_dispatch_crashed: 'تعطّل',
    kanban_cron_toast_notifications_hint: 'إظهار إشعار عند اكتمال تشغيل المهمة',
    kanban_priority: 'الأولوية',
    kanban_read_only: 'للقراءة فقط',
    kanban_run_dispatcher: 'تشغيل الموزّع',
    kanban_status: 'الحالة',
    kanban_tenant: 'المستأجر',
    kanban_tenant_placeholder: 'اسم المستأجر…',
    kanban_title: 'العنوان',
    logs_status_idle: 'خامل',
    logs_title: 'السجلات',
    mcp_restart_hint: 'تعديلات الخادم للقراءة فقط حالياً. عدّل config.yaml وأعد تشغيل Hermes.',
    mcp_servers_desc: 'عرض خوادم MCP المُعدّة في config.yaml.',
    mcp_servers_title: 'خوادم MCP',
    mcp_tools_desc: 'البحث في الأدوات المعروفة عبر خوادم MCP النشطة.',
    mcp_tools_pagination_label: 'ترقيم صفحات أدوات MCP',
    mcp_tools_runtime_note: 'يستخدم جرد الأدوات بيانات MCP النشطة المعروفة فقط.',
    mcp_tools_search_placeholder: 'ابحث عن الأدوات بالاسم أو الخادم أو الوصف…',
    mcp_tools_title: 'أدوات MCP',
    memory_empty_sub: 'ستظهر هنا الملاحظات التي تحفظها أنت أو Hermes.',
    memory_empty_title: 'لا توجد ملاحظات بعد',
    open_in_browser: 'فتح في المتصفح',
    profile_delete_title: 'حذف الملف الشخصي',
    profile_switch_title: 'تبديل الملف الشخصي',
    profiles_empty_sub: 'أنشئ ملفاً شخصياً لتخصيص المزوّدين والنماذج.',
    profiles_empty_title: 'لا توجد ملفات شخصية',
    providers_section_meta: 'إدارة مفاتيح API وإعدادات المزوّدين.',
    providers_section_title: 'المزوّدون',
    settings_auto_title_refresh_10: '10 دقائق',
    settings_auto_title_refresh_20: '20 دقيقة',
    settings_auto_title_refresh_5: '5 دقائق',
    settings_check_now: 'تحقق الآن',
    settings_desc_api_redact: 'إخفاء مفاتيح API في صفحة السجلات.',
    settings_desc_bot_name: 'الاسم الذي يستخدمه Hermes للإشارة إلى نفسه.',
    settings_desc_busy_input_mode: 'يتحكم بما يحدث عند إرسال رسالة أثناء عمل الوكيل.',
    settings_desc_check_updates: 'التحقق تلقائياً من وجود إصدارات جديدة عند بدء التشغيل.',
    settings_desc_external_sessions: 'إظهار المحادثات التي بدأت من CLI في الشريط الجانبي.',
    settings_desc_fade_text_effect: 'تأثير تلاشي الكلمات الجديدة أثناء استجابة المساعد.',
    settings_desc_model: 'النموذج الافتراضي للمحادثات الجديدة.',
    settings_desc_notifications: 'إظهار إشعارات المتصفح عند اكتمال مهمة في الخلفية.',
    settings_desc_password: 'تعيين أو تغيير كلمة مرور WebUI.',
    settings_desc_quota_chip: 'إظهار مؤشر حصة المزوّد في شريط العنوان.',
    settings_desc_session_endless_scroll: 'تحميل الرسائل القديمة تلقائياً عند التمرير للأعلى.',
    settings_desc_session_jump_buttons: 'إظهار أزرار الانتقال السريع إلى بداية ونهاية المحادثة.',
    settings_desc_sidebar_density: 'التحكم في كمية المعلومات المعروضة في قائمة المحادثات.',
    settings_desc_sync_insights: 'مزامنة بيانات الجلسة مع لوحة الإحصائيات.',
    settings_desc_token_usage: 'إظهار إحصائيات استخدام الرموز بعد كل رد.',
    settings_desc_tts_auto_read: 'قراءة الردود تلقائياً عند اكتمالها.',
    settings_desc_tts_voice: 'اختيار الصوت المستخدم لتحويل النص إلى كلام.',
    settings_desc_voice_mode: 'إظهار زر الوضع الصوتي في شريط الإدخال.',
    settings_desc_whats_new_summary: 'طلب ملخص تغييرات AI عند وجود تحديثات.',
    settings_desc_workspace_panel_open: 'إبقاء لوحة الملفات مفتوحة افتراضياً مع كل جلسة.',
    settings_label_quota_chip: 'مؤشر الحصة',
    settings_label_voice_mode: 'الوضع الصوتي',
    settings_label_whats_new_summary: 'تلخيص التحديثات',
    settings_plugins_empty: 'لا توجد إضافات مُثبّتة.',
    settings_plugins_meta: 'إدارة الإضافات وخطافات التوسعة.',
    settings_plugins_title: 'الإضافات',
    settings_section_appearance_meta: 'السمة، ألوان التمييز، والنمط البصري.',
    tasks_empty_sub: 'قم بجدولة أول مهمة دورية لـ Hermes.',
    tasks_empty_title: 'لا توجد مهام مجدولة',
    workspace_add_title: 'إضافة مساحة عمل',
    workspace_hidden_files_visible: 'الملفات المخفية معروضة',
    workspace_hidden_files_visible_title: 'الملفات المخفية مرئية — انقر للخيارات',
    workspace_use_title: 'استخدام مساحة العمل',
    workspaces_empty_sub: 'أضف مساحات عمل لتنظيم محادثاتك ومشاريعك.',
    workspaces_empty_title: 'لا توجد مساحات عمل',
    yolo_pill_title_active: 'وضع YOLO نشط — انقر للتعطيل',
    // ── Cron extended ──
    cron_deliver_label: 'وجهة التسليم',
    cron_deliver_local: 'محلي فقط',
    cron_last_output: 'آخر مخرجات',
    cron_expand_prompt: 'توسيع الموجه',
    cron_collapse_prompt: 'طي الموجه',
    cron_expand_output: 'توسيع المخرجات',
    cron_collapse_output: 'طي المخرجات',
    cron_no_runs_yet: 'لا توجد عمليات تشغيل بعد',
    cron_schedule_label: 'الجدول',
    cron_schedule_hint: "مثل: 'every 2h' أو '0 9 * * *'",
    cron_prompt_label: 'الموجه',
    cron_prompt_placeholder: 'ماذا يجب أن يفعل Hermes...',
    cron_prompt_required: 'الموجه مطلوب.',
    cron_name_label: 'الاسم',
    cron_name_placeholder: 'اسم المهمة...',
    cron_delete_confirm_title: 'حذف المهمة',
    cron_status_off: 'معطّل',
    cron_status_running: 'قيد التشغيل',
    cron_status_needs_attention: 'يحتاج انتباه',
    cron_attention_resume: 'استئناف',
    cron_attention_run_once: 'تشغيل مرة واحدة',
    cron_toast_notifications_label: 'إشعارات',
    cron_toast_notifications_enabled: 'مفعّلة',
    cron_toast_notifications_disabled: 'معطّلة',
    cron_skills_label: 'المهارات',
    cron_skills_placeholder: 'اختر المهارات...',
    cron_profile_label: 'الملف الشخصي',
    cron_profile_server_default: 'افتراضي الخادم',
    status_completed: 'مكتمل',
    status_failed: 'فشل',
    // ── Workspace extended ──
    workspace_manage: 'إدارة مساحات العمل',
    workspace_choose_path: 'اختيار مسار',
    workspace_path_label: 'مسار مساحة العمل',
    workspace_path_required: 'المسار مطلوب.',
    workspace_name_label: 'الاسم',
    workspace_name_placeholder: 'اسم مساحة العمل...',
    workspace_new_title: 'مساحة عمل جديدة',
    ...
    workspace_switched_to: 'تم التبديل إلى مساحة العمل: ',
    workspace_drag_hint: 'اسحب لإعادة الترتيب',
    // ── Session time / meta ──
    session_time_unknown: 'غير معروف',
    session_time_minutes_ago: (n) => `منذ ${n} دقيقة`,
    session_time_hours_ago: (n) => `منذ ${n} ساعة`,
    session_time_days_ago: (n) => `منذ ${n} يوم`,
    session_time_last_week: 'الأسبوع الماضي',
    ...
    session_meta_messages: 'رسائل',
    session_meta_children: 'فرعية',
    session_meta_segments: 'مقاطع',
    session_lineage_segment_untitled: 'بدون عنوان',
    session_lineage_segment_open: 'مفتوح',
    session_archive_desc: 'إخفاء هذه المحادثة حتى يتم إظهار المؤرشفة',
    ...
    session_delete_desc: 'حذف هذه المحادثة نهائياً',
    session_duplicate_desc: 'إنشاء نسخة بنفس مساحة العمل والنموذج',
    session_stop_response: 'إيقاف الرد',
    session_stop_response_desc: 'إلغاء الرد الجاري لهذه المحادثة',
    session_move_project: 'نقل إلى مشروع',
    session_move_project_desc_none: 'تعيين مشروع لهذه المحادثة',
    session_move_project_desc_has: 'تغيير مشروع هذه المحادثة',
    session_selected_count: (n) => `${n} محددة`,
    session_batch_delete_confirm: (n) => `حذف ${n} محادثات؟`,
    session_batch_archive_confirm: (n) => `أرشفة ${n} محادثات؟`,
    new_session: 'تم إنشاء جلسة جديدة',
    session_toolsets: 'أدوات الجلسة',
    session_toolsets_desc: 'تقييد الأدوات المتاحة لهذه الجلسة',
    session_toolsets_global: 'عام (افتراضي)',
    session_toolsets_apply: 'تطبيق',
    session_toolsets_clear: 'مسح (استخدام العام)',
    session_toolsets_applied: 'تم تحديث الأدوات',
    session_toolsets_cleared: 'تم مسح الأدوات — استخدام الإعداد العام',
    n_messages: (n) => n === 1 ? 'رسالة واحدة' : `${n} رسائل`,
    queued_count: (n) => n === 1 ? '1 في الانتظار' : `${n} في الانتظار`,
    // ── Logs extended ──
    logs_copied: 'تم النسخ',
    logs_no_mtime: 'غير متاح',
    logs_filter_active: (n) => `${n} متطابقة — عرض مفلتر`,
    // ── Onboarding extended ──
    onboarding_step_system_desc: 'التحقق من تثبيت Hermes Agent.',
    onboarding_step_setup_desc: 'تكوين المزوّد والنموذج.',
    onboarding_step_workspace_desc: 'اختيار مجلد العمل الافتراضي.',
    onboarding_step_password_desc: 'تأمين WebUI بكلمة مرور.',
    onboarding_step_finish_desc: 'جاهز! ابدأ المحادثة.',
    // ── Settings extended ──
    settings_checking: 'جارٍ التحقق…',
    settings_up_to_date: 'مُحدّث ✓',
    settings_updates_available: (n) => `${n} تحديث(ات) متاحة`,
    settings_updates_disabled: 'التحقق من التحديثات معطّل',
    settings_update_check_failed: 'فشل التحقق من التحديثات',
    // ── Skill extended ──
    skill_delete_confirm: (name) => `حذف المهارة "${name}"؟ لا يمكن التراجع.`,
    skill_file_load_failed: 'فشل تحميل ملف المهارة',
    skill_category_placeholder: 'مثل: devops, data-science...',
    skill_content_placeholder: 'محتوى SKILL.md...',
    slash_skill_badge: 'مهارة',
    slash_skill_desc: 'استدعاء هذه المهارة',
    // ── Misc functions ──
    downloading: (name) => `جارٍ تحميل ${name}…`,
    all_uploads_failed: (n) => `فشلت جميع عمليات الرفع (${n})`,
    ...
    upload_too_large: (maxMb, fileMb) => `الملف كبير جداً (${fileMb} ميغابايت). الحد الأقصى هو ${maxMb} ميغابايت.`,
    diff_loading: 'جارٍ تحميل الفروقات',
    diff_error: 'تعذر تحميل ملف patch',
    diff_too_large: 'ملف patch كبير جداً للعرض',
    tts_listen: 'استماع',
    tts_not_supported: 'تحويل النص إلى كلام غير مدعوم في هذا المتصفح',
    // ── Profile extended ──
    profile_name_label: 'اسم الملف',
    profile_name_placeholder: 'مثلاً: work, personal...',
    profile_base_url_label: 'عنوان URL الأساسي',
    profile_api_key_label: 'مفتاح API',
    profile_delete_confirm_title: 'حذف الملف الشخصي',
    profile_delete_confirm_message: (name) => `حذف الملف الشخصي "${name}"؟ لا يمكن التراجع.`,
    profile_delete_title: 'حذف الملف الشخصي',
    profile_deleted: 'تم حذف الملف الشخصي',
    profile_created: 'تم إنشاء الملف الشخصي',
    profile_switched: 'تم تبديل الملف الشخصي',
    profile_switched_new_conversation: 'تم تبديل الملف الشخصي — ابدأ محادثة جديدة',
    profile_default_label: 'افتراضي',
    profile_active: 'نشط',
    profile_model_label: 'النموذج',
    profile_model_use_default: 'استخدام الافتراضي',
    profile_clone_label: 'نسخ',
    profile_name_rule: 'مطلوب (أحرف وأرقام وشرطات فقط)',
    manage_profiles: 'إدارة الملفات الشخصية',
    profiles_no_profiles: 'لا توجد ملفات شخصية بعد',
    profile_gateway_running: 'البوابة قيد التشغيل',
    profile_gateway_stopped: 'البوابة متوقفة',
    profile_no_configuration: 'لا يوجد إعداد',
    profile_skill_count: (n) => `${n} مهارات`,
    profile_api_keys_configured: 'مفاتيح API مُعدّة',
    profile_api_key_placeholder: 'مفتاح API (اختياري، يرث من الإعداد العام)',
    profile_base_url_placeholder: 'عنوان URL الأساسي (اختياري، يرث من الإعداد العام)',
    profile_model_hint: 'تجاوز النموذج الافتراضي لهذا الملف الشخصي',
    profile_base_url_rule: 'يجب أن يكون URL صالح يبدأ بـ http',
    profile_switch_title: 'تبديل الملف الشخصي',
    provider_mismatch_warning: (m, p) => `"${m}" قد لا يعمل مع مزوّدك الحالي (${p}). أرسل على أي حال، أو شغّل \`hermes model\` في الطرفية للتبديل.`,
    open_in_browser: 'فتح في المتصفح',
    cmd_help: 'عرض الأوامر المتاحة',
    cmd_yolo: 'تشغيل/إيقاف وضع YOLO (تخطي الموافقات)',
    cmd_reasoning: 'التحكم في عرض تفكير النموذج',
    active_conversation_meta: (title, count) => `${title} · ${count} رسائل`,
    // ── Final missing keys (comprehensive sweep) ──
    cron_delete_confirm_message: (name) => `هل أنت متأكد من حذف المهمة "${name}"؟`,
    cron_toast_notifications_hint: 'إظهار إشعار منبثق عند اكتمال المهمة.',
    cron_view_full_output: 'عرض المخرجات الكاملة',
    kanban_board_name_required: 'اسم اللوحة مطلوب.',
    kanban_board_slug_required: 'المعرف المختصر مطلوب.',
    kanban_card_archive: 'أرشفة',
    kanban_card_complete: 'إكمال',
    kanban_children: 'المهام الفرعية',
    kanban_comments_count: (n) => `${n} تعليقات`,
    kanban_events_count: (n) => `${n} أحداث`,
    kanban_links: 'روابط',
    kanban_no_data: 'لا توجد بيانات كانبان.',
    kanban_no_description: 'لا يوجد وصف',
    kanban_parents: 'المهام الرئيسية',
    kanban_runs_count: (n) => `${n} عمليات تشغيل`,
    kanban_stats: 'إحصائيات',
    kanban_task: 'مهمة',
    kanban_unavailable: 'كانبان غير متاح.',
    kanban_visible_tasks: 'المهام المرئية',
    kanban_work_queue_hint: 'قائمة انتظار العمل',
    kanban_worker_log: 'سجل العامل',
    mcp_tools_summary_showing: (s, e, f, sn, tn, p, pages) => `عرض ${s}-${e} من ${f} أداة${sn}${tn}. صفحة ${p} من ${pages}.`,
    offline_probe: 'جارٍ التحقق من الاتصال…',
    personality_switch_hint: 'استخدم `/personality <الاسم>` للتبديل، أو `/personality none` للحذف.',
    provider_quota_last_checked: 'آخر فحص',
    provider_quota_last_checked_after_refresh: 'آخر فحص (بعد التحديث)',
    providers_models_refreshed: 'تم تحديث النماذج',
    providers_refresh_models: 'تحديث النماذج',
    providers_refreshing: 'جارٍ التحديث…',
    session_batch_archive_worktree_confirm: (n, w) => `أرشفة ${n} محادثات؟ ${w} محادثة مرتبطة بشجرة عمل ستبقي مجلداتها على القرص.`,
    session_batch_delete_worktree_confirm: (n, w) => `حذف ${n} محادثات؟ ${w} محادثة مرتبطة بشجرة عمل ستترك مجلداتها على القرص.`,
    session_delete_worktree_confirm: (path) => `حذف هذه المحادثة؟ مجلد شجرة العمل في ${path} سيبقى على القرص.`,
    session_id: 'معرف الجلسة',
    session_rename_failed_no_row: 'فشلت إعادة التسمية — عنصر الجلسة غير موجود.',
    session_worktree_remove_ahead_warning: (ahead) => `${ahead} commit غير مرفوع سيفقد.`,
    session_worktree_remove_confirm: (path) => `إزالة شجرة العمل من القرص؟\n\nالمسار: ${path}`,
    session_worktree_remove_untracked_warning: (count) => `${count} ملف غير متعقب سيحذف نهائياً.`,
    switched_workspace: 'تم التبديل إلى مساحة العمل: ',
    test_updates: 'اختبار التحديثات',
    workspace_remove_confirm_message: (name) => `إزالة مساحة العمل "${name}"؟ لن يؤثر على الملفات على القرص.`,
    // ── Auth ──
    auth_disabled: 'تم تعطيل المصادقة',
    disable_auth_confirm_message: 'تعطيل المصادقة؟ سيتمكن أي شخص من الوصول إلى WebUI.',
    disable_auth_confirm_title: 'تعطيل المصادقة',
    disable_auth_failed: 'فشل تعطيل المصادقة',
    sign_out_failed: 'فشل تسجيل الخروج',
    // ── File operations ──
    discard_file_edits_message: 'لديك تغييرات غير محفوظة. تجاهلها؟',
    discard_file_edits_title: 'تجاهل تعديلات الملف',
    folder_add_as_space_btn: 'إضافة كمساحة',
    folder_add_as_space_msg: 'إضافة هذا المجلد كمساحة عمل جديدة؟',
    folder_add_as_space_title: 'إضافة كمساحة؟',
    reveal_failed: 'فشل الكشف: ',
    reveal_in_finder: 'كشف في مدير الملفات',
    // ── Goals ──
    goal_continuing_toast: 'متابعة نحو الهدف…',
    goal_evaluating_progress: 'جارٍ تقييم تقدم الهدف…',
    // ── Insights extended ──
    insights_activity_by_day: 'النشاط حسب اليوم',
    insights_activity_by_hour: 'النشاط حسب الساعة',
    insights_daily_tokens: 'الرموز اليومية',
    insights_footer: 'بيانات الاستخدام من آخر {0} يوم',
    insights_input_tokens: 'رموز الإدخال',
    insights_model_cost: 'التكلفة',
    insights_model_name: 'النموذج',
    insights_model_sessions: 'الجلسات',
    insights_model_share: 'الحصة',
    insights_model_tokens: 'الرموز',
    insights_models: 'النماذج',
    insights_no_cost: 'لا توجد تكلفة',
    insights_no_usage_data: 'لا توجد بيانات استخدام لهذه الفترة.',
    insights_output_tokens: 'رموز الإخراج',
    insights_peak_hour: 'ساعة الذروة',
    insights_token_breakdown: 'تفصيل الرموز',
    insights_total: 'الإجمالي',
    // ── MCP extended ──
    mcp_load_failed: 'فشل تحميل خوادم MCP.',
    mcp_no_servers: 'لا توجد خوادم MCP مُعدّة.',
    mcp_status_invalid_config: 'إعداد غير صالح',
    mcp_toggle_followup: 'التحكم في التفعيل/التعطيل مؤجل.',
    mcp_tool_count: '{0} أدوات',
    mcp_tools_inactive_configured_servers: 'خوادم مُعدّة لكن غير نشطة: {0}.',
    mcp_tools_load_failed: 'فشل تحميل أدوات MCP.',
    mcp_tools_next_page: 'التالي \u203a',
    mcp_tools_next_page_aria: 'صفحة أدوات MCP التالية',
    mcp_tools_page_size_prefix: 'عرض',
    mcp_tools_page_size_suffix: 'لكل صفحة',
    mcp_tools_per_page_aria: 'أدوات MCP لكل صفحة',
    mcp_tools_previous_page: '\u2039 السابق',
    mcp_tools_previous_page_aria: 'صفحة أدوات MCP السابقة',
    mcp_tools_schema_empty: 'لا توجد معاملات.',
    mcp_tools_summary_matching: (q) => ' مطابقة لـ \"' + q + '\"',
    mcp_tools_summary_no_matches: (q) => 'لا توجد أدوات MCP تطابق \"' + q + '\" (إجمالي {0} أدوات).',
    mcp_tools_summary_none: 'لا توجد أدوات MCP للعرض.',
    mcp_tools_summary_total_note: (total) => ' (' + total + ' إجمالي أدوات MCP)',
    // ── Onboarding extended ──
    onboarding_api_key_help_keyless: 'هذا المزوّد لا يتطلب مفتاح API.',
    onboarding_api_key_help_prefix: 'مفتاح API مطلوب من ',
    onboarding_base_url_help: 'اتركه فارغاً لاستخدام العنوان الافتراضي.',
    onboarding_base_url_label: 'عنوان URL الأساسي',
    onboarding_base_url_placeholder: 'https://api.example.com/v1',
    onboarding_check_agent: 'وكيل Hermes',
    onboarding_check_agent_missing: 'لم يتم العثور على تثبيت Hermes Agent.',
    onboarding_check_agent_ready: 'تم اكتشاف Hermes Agent.',
    onboarding_check_password: 'كلمة مرور WebUI',
    onboarding_check_password_disabled: 'المصادقة معطلة.',
    onboarding_check_password_enabled: 'المصادقة مفعّلة.',
    onboarding_check_provider: 'المزوّد',
    onboarding_check_provider_partial: 'المزوّد مُعدّ جزئياً.',
    onboarding_check_provider_pending: 'المزوّد يحتاج إلى إعداد.',
    onboarding_check_provider_ready: 'المزوّد جاهز.',
    onboarding_complete: 'اكتمل الإعداد!',
    onboarding_config_file: 'ملف config.yaml',
    onboarding_current_provider: 'المزوّد الحالي',
    onboarding_custom_model_help: 'أدخل معرف نموذج مخصص إذا لم يكن في القائمة.',
    onboarding_custom_model_placeholder: 'مثل: openai/gpt-4o',
    onboarding_env_file: 'ملف .env',
    onboarding_error_base_url_required: 'عنوان URL الأساسي مطلوب.',
    onboarding_error_choose_model: 'الرجاء اختيار نموذج.',
    onboarding_error_choose_workspace: 'الرجاء اختيار مساحة عمل.',
    onboarding_error_model_required: 'النموذج مطلوب.',
    onboarding_error_probe_failed: 'فشل اختبار الاتصال',
    onboarding_error_provider_required: 'المزوّد مطلوب.',
    onboarding_error_workspace_required: 'مسار مساحة العمل مطلوب.',
    onboarding_finish_help: 'انقر فوق إنهاء لحفظ الإعدادات وبدء استخدام Hermes.',
    onboarding_missing_imports: 'واردات مفقودة',
    onboarding_model_label: 'النموذج',
    onboarding_not_set: 'غير مُعيّن',
    onboarding_notice_finish: 'أنت جاهز! اضغط إنهاء للبدء.',
    onboarding_notice_password_enabled: 'كلمة المرور مفعّلة — ستحتاجها للوصول.',
    onboarding_notice_password_recommended: 'يوصى بتعيين كلمة مرور إذا كان WebUI متاحاً على الشبكة.',
    onboarding_notice_setup_already_ready: 'المزوّد مُعدّ مسبقاً. يمكنك تخطي هذا.',
    onboarding_notice_setup_required: 'يجب إعداد مزوّد واحد على الأقل.',
    onboarding_notice_system_ready: 'تم اكتشاف Hermes Agent وجاهز.',
    onboarding_notice_system_unavailable: 'لم يتم اكتشاف Hermes Agent. قد لا تعمل بعض الميزات.',
    onboarding_notice_workspace: 'اختر مجلداً افتراضياً لمحادثاتك.',
    onboarding_oauth_provider_not_ready_body: 'يحتاج إلى OAuth أو مفتاح API.',
    onboarding_oauth_provider_not_ready_title: 'المزوّد غير مُعدّ',
    onboarding_oauth_provider_ready_body: 'تم تكوين OAuth وجاهز.',
    onboarding_oauth_provider_ready_title: 'المزوّد جاهز',
    onboarding_oauth_switch_hint: 'أو اختر مزوّداً آخر أدناه.',
    onboarding_password_help: 'اتركه فارغاً للإبقاء على الإعداد الحالي دون تغيير.',
    onboarding_password_label: 'كلمة مرور WebUI',
    onboarding_password_placeholder: 'اختر كلمة مرور...',
    onboarding_probe_error_generic: 'فشل في الاتصال بالمزوّد.',
    onboarding_probe_ok: 'الاتصال ناجح',
    onboarding_probe_probing: 'جارٍ اختبار الاتصال...',
    onboarding_probe_test_button: 'اختبار الاتصال',
    onboarding_provider_label: 'المزوّد',
    onboarding_quick_setup_badge: 'إعداد سريع',
    onboarding_unknown: 'غير معروف',
    onboarding_workspace_help: 'اختر مجلداً موجوداً أو اكتب مساراً.',
    onboarding_workspace_label: 'مساحة العمل',
    onboarding_workspace_or_path: 'مساحة العمل أو المسار',
    onboarding_workspace_placeholder: '~/workspace',
    // ── OAuth ──
    oauth_codex_error: 'فشل مصادقة OAuth.',
    oauth_codex_expired: 'انتهت صلاحية كود OAuth. حاول مرة أخرى.',
    oauth_codex_polling: 'في انتظار إكمال المصادقة...',
    oauth_codex_step1: 'انسخ الكود أعلاه.',
    oauth_codex_step2: 'الصقه في صفحة المصادقة.',
    oauth_codex_success: 'تمت مصادقة OAuth بنجاح!',
    oauth_login_codex: 'تسجيل الدخول عبر OAuth',


    // ── Batch 2: remaining translations ──
    available_personalities: 'الشخصيات المتاحة:',
    no_personalities: 'لا توجد شخصيات (أضفها إلى ~/.hermes/personalities/)',
    personalities_load_failed: 'فشل تحميل الشخصيات',
    personality_cleared: 'تم مسح الشخصية',
    personality_set: 'الشخصية: ',
    plugins_disabled: 'معطّل',
    plugins_enabled: 'مفعّل',
    plugins_load_failed: 'فشل تحميل الإضافات',
    plugins_no_description: 'لا يوجد وصف',
    plugins_no_hooks: 'لا توجد خطافات',
    plugins_registered_hooks: 'خطافات مسجلة',
    plugins_unnamed: 'بدون اسم',
    provider_quota_account_limits_loaded: 'تم تحميل حدود الحساب',
    provider_quota_active_provider: 'المزوّد النشط',
    provider_quota_credential_label: 'اعتماد {0}',
    provider_quota_credential_pool: 'مجموعة الاعتمادات',
    provider_quota_metric_limit: 'الحد',
    provider_quota_metric_remaining: 'متبقي',
    provider_quota_metric_used: 'مُستخدم',
    provider_quota_pool_no_windows: 'لا توجد نوافذ',
    provider_quota_pool_plans: 'خطط',
    provider_quota_pool_summary_available: (n) => n + ' متاح',
    provider_quota_pool_summary_checked: (n) => n + ' تم الفحص',
    provider_quota_pool_summary_exhausted: (n) => n + ' مستنفد',
    provider_quota_pool_summary_failed: (n) => n + ' فشل',
    provider_quota_refresh_failed: 'فشل تحديث الحصة',
    provider_quota_refresh_succeeded: 'تم تحديث الحصة',
    provider_quota_refresh_title: 'تحديث الحصة',
    provider_quota_refresh_usage: 'تحديث الاستخدام',
    provider_quota_refreshing: 'جارٍ التحديث\u2026',
    provider_quota_resets_meta: 'يعاد تعيين {0}',
    provider_quota_retry_after: 'أعد المحاولة بعد {0}',
    provider_quota_session_limit: 'حد الجلسة',
    provider_quota_title: 'حصة المزوّد',
    provider_quota_unavailable: 'معلومات الحصة غير متاحة',
    provider_quota_used_meta: '{0} مستخدم من {1}',
    provider_quota_weekly_limit: 'الحد الأسبوعي',
    provider_quota_window_fallback: 'نافذة {0}',
    providers_key_placeholder_new: 'أدخل مفتاح API...',
    providers_key_placeholder_replace: 'استبدل مفتاح API...',
    providers_key_removed: 'تمت إزالة المفتاح',
    providers_oauth_config_yaml_hint: 'تم التكوين في config.yaml',
    providers_oauth_hint: 'انقر للمصادقة عبر OAuth',
    providers_oauth_not_configured_hint: 'غير مُعدّ في config.yaml',
    providers_removing: 'جارٍ الإزالة\u2026',
    providers_saving: 'جارٍ الحفظ\u2026',
    providers_status_api_key: 'مفتاح API',
    providers_status_not_configured_label: 'غير مُعدّ',
    providers_status_oauth: 'OAuth',
    retry_failed: 'فشلت إعادة المحاولة: ',
    steer_leftover_queued: 'تمت إضافة التوجيه للطابور للدورة التالية',
    switch_failed: 'فشل التبديل: ',
    switched_to: 'تم التبديل إلى ',
    theme_set: 'السمة: ',
    undid_messages_suffix: 'رسالة/رسائل.',
    undid_n_messages: 'تمت إزالة',
    undo_failed: 'فشل التراجع: ',
    usage_personality_none: 'لا شيء',
    session_archived_worktree: 'تمت أرشفة المحادثة. شجرة العمل باقية على القرص.',
    session_archive_worktree_desc: 'إخفاء هذه المحادثة مع إبقاء شجرة العمل',
    session_delete_worktree_desc: 'حذف المحادثة فقط مع إبقاء شجرة العمل',
    session_deleted_worktree: 'تم حذف المحادثة. شجرة العمل باقية.',
    session_worktree_remove: 'إزالة شجرة العمل',
    session_worktree_remove_confirm_label: 'إزالة',
    session_worktree_remove_desc: 'حذف مجلد شجرة العمل من القرص',
    session_worktree_remove_dirty_warning: 'تحذير: توجد تغييرات غير ملتزم بها وستفقد.',
    session_worktree_remove_failed: 'فشلت إزالة شجرة العمل: ',
    session_worktree_remove_locked_by_stream: 'لا يمكن الإزالة — جلسة نشطة تستخدم شجرة العمل.',
    session_worktree_remove_locked_by_terminal: 'لا يمكن الإزالة — جلسة طرفية نشطة تستخدم شجرة العمل.',
    session_worktree_remove_not_exists: 'لم تعد شجرة العمل موجودة على القرص.',
    session_worktree_remove_status_failed: 'فشلت قراءة حالة شجرة العمل: ',
    session_worktree_remove_unsafe_blocked: 'حل التغييرات المحلية أو الـ commits غير المرفوعة أولاً.',
    session_worktree_removed: 'تمت إزالة شجرة العمل.',
    session_archive_failed: 'فشلت الأرشفة: ',
    session_batch_move: 'نقل إلى مشروع',
    session_duplicate_failed: 'فشل النسخ: ',
    session_pin_failed: 'فشل التثبيت: ',
    session_toolsets_failed: 'فشل تحديث الأدوات: ',
    session_toolsets_placeholder: 'tool1, tool2, ...',
    skill_metadata: 'بيانات وصفية',
    skill_rename_not_supported: 'إعادة تسمية المهارات غير مدعومة حالياً.',
    ...
    workspace_add_path_placeholder: '/path/to/workspace',
    workspace_already_saved: 'مساحة العمل هذه مضافة مسبقاً.',
    workspace_busy_switch: 'لا يمكن تبديل مساحة العمل أثناء تشغيل الوكيل.',
    workspace_choose_path_meta: 'تصفح واختر مجلداً كمساحة عمل.',
    workspace_manage_meta: 'إعادة ترتيب أو إزالة مساحات العمل.',
    workspace_new_worktree_conversation_meta: 'إنشاء شجرة عمل git معزولة لمساحة العمل هذه.',
    workspace_not_added: 'لم تتم إضافة مساحة العمل.',
    workspace_path_readonly: 'مسار مساحة العمل للقراءة فقط.',
    workspace_paths_validated_hint: 'جميع المسارات صالحة ويمكن الوصول إليها.',
    workspace_remove_confirm_title: 'إزالة مساحة العمل',
    workspace_reorder_failed: 'فشلت إعادة الترتيب: ',
    workspace_show_hidden_files_desc: 'تضمين الملفات المخفية وملفات النظام في شجرة الملفات.',
    workspace_switch_failed: 'فشل تبديل مساحة العمل: ',
    workspace_switch_prompt_confirm: 'تبديل',
    workspace_switch_prompt_message: 'هل تريد بدء محادثة جديدة في مساحة العمل هذه؟',
    workspace_switch_prompt_placeholder: 'اسم مساحة العمل...',
    workspace_switch_prompt_title: 'تبديل مساحة العمل',
    workspace_usage: 'الاستخدام: /workspace <الاسم>',
    failed_colon: 'فشل: ',
    ...
    password_env_var_locked_placeholder: 'مقفلة عبر متغير البيئة',
    logs_truncated_hint: 'مقتطع — آخر {0} سطر',
    checkpoint_diff_files_changed: '{0} ملفات متغيرة',
    checkpoint_restore_confirm_message: 'استعادة نقطة التحقق هذه؟ سيتم استبدال ملفات مساحة العمل الحالية.',
    cron_completion_status: 'حالة الاكتمال',
    cron_attention_desc: 'آخر تشغيل فشل أو المهمة بحاجة إلى انتباه',
    cron_attention_copy_diagnostics: 'نسخ معلومات التشخيص',
    cron_attention_croniter_hint: 'قد يكون جدول cron غير صالح. تحقق من الصيغة.',
    cron_attention_resume: 'استئناف',
    cron_attention_run_once: 'تشغيل مرة واحدة',
    cron_diagnostics_copied: 'تم نسخ معلومات التشخيص',
    cron_profile_server_default_hint: 'يستخدم الملف الشخصي الافتراضي لإعدادات الخادم',
    cron_schedule_once_warning: 'لن يتكرر هذا الجدول. استخدم every 2h أو cron للتكرار.',
    cron_schedule_required_example: 'مثال: every 2h أو 0 9 * * *',
    cron_skills_edit_hint: 'اختر مهارات ليتم تحميلها قبل الموجه',
 ...
 */
/**
 * RTL languages: auto-enable RTL chat layout when these are selected.
 * The user can still toggle RTL off manually in Settings → Preferences.
 */
const RTL_LOCALES = new Set(['ar', 'fa', 'he', 'ur', 'yi', 'dv', 'ps', 'syr', 'ku']);
...
function setLocale(lang) {
  ...
  // Force RTL for RTL languages, LTR for LTR languages.
  // This always overrides the manual toggle when switching languages.
  const isRtlLang = RTL_LOCALES.has(resolved);
  try { localStorage.setItem('hermes-rtl', isRtlLang ? 'true' : 'false'); } catch (_) {}
  if (document.documentElement) {
    document.documentElement.classList.toggle('chat-content-rtl', isRtlLang);
...
function applyLocaleToDOM() {
  ...
  // Also stamp data-label attributes (used by sidebar nav-tab tooltips on mobile)
  document.querySelectorAll('[data-i18n-label]').forEach(el => {
    const key = el.getAttribute('data-i18n-label');
    const val = t(key);
    if (val && val !== key) el.setAttribute('data-label', val);
  });
