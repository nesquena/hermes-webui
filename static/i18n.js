...
const LOCALES = {
  ...
  folder_add_as_space_title: 'Add as Space?',
    ...
    gateway_session_count: (n) => n === 1 ? `${n} session` : `${n} sessions`,
  ...
  folder_add_as_space_title: 'Aggiungere come Spazio?',
    ...
    gateway_session_count: (n) => n === 1 ? `${n} sessione` : `${n} sessioni`,
  ...
  folder_add_as_space_title: 'Добавить как пространство?',
    ...
    gateway_session_count: (n) => n === 1 ? `${n} сессия` : n < 5 ? `${n} сессии` : `${n} сессий`,
  ...
  folder_add_as_space_title: '¿Añadir como espacio?',
    ...
    gateway_session_count: (n) => n === 1 ? `${n} sesión` : `${n} sesiones`,
  ...
  folder_add_as_space_title: 'Als Bereich hinzufügen?',
    ...
    gateway_session_count: (n) => n === 1 ? `${n} Sitzung` : `${n} Sitzungen`,
  ...
  pt: {
    ...
    gateway_session_count: (n) => n === 1 ? `${n} sessão` : `${n} sessões`,
  ...
  tr: {
    ...
    gateway_session_count: (n) => n === 1 ? `${n} oturum` : `${n} oturum`,
  ...
  pl: {
    ...
    gateway_session_count: (n) => n === 1 ? '1 sesja' : `${n} sesji`,
