...
const LOCALES = {
  ...
  folder_add_as_space_title: 'Add as Space?',
    ...
    providers_custom_provider: 'Custom Provider',
    providers_base_url: 'Base URL',
    providers_api_mode: 'API Mode',
    providers_api_key: 'API Key',
    providers_models: 'Models',
    providers_delete_confirm: 'Delete this custom provider? This cannot be undone.',
    providers_delete_confirm_title: 'Delete custom provider',
    providers_delete: 'Delete',
    providers_name_placeholder: 'e.g. my-provider',
