...
const LOCALES = {
  ...
  folder_add_as_space_title: 'Add as Space?',
    ...
    settings_label_lineage_indicators: 'Show session lineage indicators',
    settings_desc_lineage_indicators: 'Display the git-branch icon and segment count on forked or continued sessions in the sidebar.',
  ...
  folder_add_as_space_title: 'スペースとして追加?',
    ...
    settings_label_lineage_indicators: 'セッション系統インジケーターを表示',
    settings_desc_lineage_indicators: 'サイドバーの派生または継続セッションにgit-branchアイコンとセグメント数を表示します。',
  ...
  folder_add_as_space_title: 'Добавить как пространство?',
    ...
    settings_label_lineage_indicators: 'Показывать индикаторы происхождения сессий',
    settings_desc_lineage_indicators: 'Отображать иконку git-branch и количество сегментов для ответвлённых или продолженных сессий в боковой панели.',
    cmd_reasoning: 'Toggle thinking visibility (show/hide), set effort level, or check current status',
  ...
  folder_add_as_space_title: '¿Añadir como espacio?',
    ...
    settings_label_lineage_indicators: 'Mostrar indicadores de linaje de sesión',
    settings_desc_lineage_indicators: 'Muestra el icono git-branch y el conteo de segmentos en sesiones bifurcadas o continuadas en la barra lateral.',
    cmd_reasoning: 'Toggle thinking visibility (show/hide), set effort level, or check current status',
  ...
  folder_add_as_space_title: 'Als Bereich hinzufügen?',
    ...
    settings_label_lineage_indicators: 'Sitzungsabstammungsindikatoren anzeigen',
    settings_desc_lineage_indicators: 'Git-branch-Symbol und Segmentanzahl für gegabelte oder fortgesetzte Sitzungen in der Seitenleiste anzeigen.',
    cmd_reasoning: 'Toggle thinking visibility (show/hide), set effort level, or check current status',
  ...
  folder_add_as_space_title: '添加为工作区？',
    ...
    settings_label_lineage_indicators: '显示会话谱系指示器',
    settings_desc_lineage_indicators: '在侧边栏中显示派生或连续会话的git-branch图标和分段计数。',
  ...
  folder_add_as_space_title: '\u65b0\u589e\u70ba\u5de5\u4f5c\u5340\uff1f',
    ...
    settings_label_lineage_indicators: '顯示會話譜系指示器',
    settings_desc_lineage_indicators: '在側邊欄中顯示派生或連續會話的git-branch圖標和分段計數。',
  ...
  pt: {
    ...
    settings_label_lineage_indicators: 'Mostrar indicadores de linhagem de sessão',
    settings_desc_lineage_indicators: 'Exibe o ícone git-branch e a contagem de segmentos em sessões bifurcadas ou continuadas na barra lateral.',
  ...
  ko: {
    ...
    settings_label_lineage_indicators: '세션 계통 인디케이터 표시',
    settings_desc_lineage_indicators: '사이드바에서 분기 또는 연속 세션에 git-branch 아이콘과 세그먼트 수를 표시합니다.',
    cmd_reasoning: 'Toggle thinking visibility (show/hide), set effort level, or check current status',
