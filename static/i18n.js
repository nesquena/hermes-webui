...
const LOCALES = {
  en: {
    ...
    mcp_tool_shortcuts_label: 'Pinned tool shortcuts',
    mcp_tool_shortcuts_empty: 'Pin MCP tools here, then click a chip to insert a ready-to-send tool request.',
    mcp_tool_shortcut_use: 'Use',
    mcp_tool_shortcut_pin: 'Pin',
    mcp_tool_shortcut_unpin: 'Unpin',
    mcp_tool_shortcut_inserted: (name) => `Inserted ${name} tool shortcut.`,
    mcp_tool_shortcut_insert_title: (name) => `Insert a request for ${name}`,
    // PDF preview (#480)
