...
const LOCALES = {
  ...
  folder_add_as_space_title: 'Add as Space?',
    ...
    settings_label_archive_after_days: 'Archive cutoff',
    settings_desc_archive_after_days: 'Move inactive conversations out of the main sidebar after this many days.',
    settings_archive_after_days_7: 'After 7 days',
    settings_archive_after_days_14: 'After 14 days',
    settings_archive_after_days_30: 'After 30 days',
    settings_archive_after_days_90: 'After 90 days',
    settings_label_avatar_presence_layout: 'Agent avatar placement',
    settings_avatar_presence_thread: 'Thread',
    settings_avatar_presence_composer: 'Composer',
    composer_presence_switch_profile: 'Switch profile',
    settings_label_auto_title_refresh: 'Adaptive title refresh',
    settings_auto_title_refresh_off: 'Off',
    settings_auto_title_refresh_5: '5회마다',
    settings_auto_title_refresh_10: '10회마다',
    settings_auto_title_refresh_20: '20회마다',
  ...
  folder_add_as_space_title: 'Aggiungere come Spazio?',
    ...
    settings_label_archive_after_days: 'Soglia di archiviazione',
    settings_desc_archive_after_days: 'Sposta le conversazioni inattive fuori dalla barra laterale principale dopo questo numero di giorni.',
    settings_archive_after_days_7: 'Dopo 7 giorni',
    settings_archive_after_days_14: 'Dopo 14 giorni',
    settings_archive_after_days_30: 'Dopo 30 giorni',
    settings_archive_after_days_90: 'Dopo 90 giorni',
    settings_label_avatar_presence_layout: 'Posizione avatar agente',
    settings_avatar_presence_thread: 'Conversazione',
    settings_avatar_presence_composer: 'Compositore',
    composer_presence_switch_profile: 'Cambia profilo',
  ...
  folder_add_as_space_title: 'スペースとして追加?',
    ...
    settings_label_archive_after_days: 'アーカイブしきい値',
    settings_desc_archive_after_days: '指定した日数が経過した非アクティブな会話をメインのサイドバーから移動します。',
    settings_archive_after_days_7: '7日後',
    settings_archive_after_days_14: '14日後',
    settings_archive_after_days_30: '30日後',
    settings_archive_after_days_90: '90日後',
    settings_label_avatar_presence_layout: 'エージェントアバターの表示位置',
    settings_avatar_presence_thread: 'スレッド',
    settings_avatar_presence_composer: 'コンポーザー',
    composer_presence_switch_profile: 'プロファイルを切り替え',
  ...
  folder_add_as_space_title: 'Добавить как пространство?',
    ...
    settings_label_archive_after_days: 'Порог архивации',
    settings_desc_archive_after_days: 'Перемещать неактивные диалоги из основной боковой панели через указанное число дней.',
    settings_archive_after_days_7: 'Через 7 дней',
    settings_archive_after_days_14: 'Через 14 дней',
    settings_archive_after_days_30: 'Через 30 дней',
    settings_archive_after_days_90: 'Через 90 дней',
    settings_label_avatar_presence_layout: 'Размещение аватара агента',
    settings_avatar_presence_thread: 'В диалоге',
    settings_avatar_presence_composer: 'В поле ввода',
    composer_presence_switch_profile: 'Сменить профиль',
  ...
  folder_add_as_space_title: '¿Añadir como espacio?',
    ...
    settings_label_archive_after_days: 'Umbral de archivo',
    settings_desc_archive_after_days: 'Quita de la barra lateral principal las conversaciones inactivas después de estos días.',
    settings_archive_after_days_7: 'Después de 7 días',
    settings_archive_after_days_14: 'Después de 14 días',
    settings_archive_after_days_30: 'Después de 30 días',
    settings_archive_after_days_90: 'Después de 90 días',
    settings_label_avatar_presence_layout: 'Ubicación del avatar del agente',
    settings_avatar_presence_thread: 'Hilo',
    settings_avatar_presence_composer: 'Compositor',
    composer_presence_switch_profile: 'Cambiar perfil',
  ...
  folder_add_as_space_title: 'Als Bereich hinzufügen?',
    ...
    settings_label_archive_after_days: 'Archivgrenze',
    settings_desc_archive_after_days: 'Verschiebt inaktive Unterhaltungen nach dieser Anzahl von Tagen aus der Hauptseitenleiste.',
    settings_archive_after_days_7: 'Nach 7 Tagen',
    settings_archive_after_days_14: 'Nach 14 Tagen',
    settings_archive_after_days_30: 'Nach 30 Tagen',
    settings_archive_after_days_90: 'Nach 90 Tagen',
    settings_label_avatar_presence_layout: 'Platzierung des Agenten-Avatars',
    settings_avatar_presence_thread: 'Thread',
    settings_avatar_presence_composer: 'Eingabefeld',
    composer_presence_switch_profile: 'Profil wechseln',
  ...
  folder_add_as_space_title: '添加为工作区？',
    ...
    settings_label_archive_after_days: '归档阈值',
    settings_desc_archive_after_days: '在指定天数后将不活跃的对话移出主侧边栏。',
    settings_archive_after_days_7: '7 天后',
    settings_archive_after_days_14: '14 天后',
    settings_archive_after_days_30: '30 天后',
    settings_archive_after_days_90: '90 天后',
    settings_label_avatar_presence_layout: '智能体头像位置',
    settings_avatar_presence_thread: '线程',
    settings_avatar_presence_composer: '输入框',
    composer_presence_switch_profile: '切换个人资料',
  ...
  folder_add_as_space_title: '\u65b0\u589e\u70ba\u5de5\u4f5c\u5340\uff1f',
    ...
    settings_label_archive_after_days: '封存門檻',
    settings_desc_archive_after_days: '在指定天數後將非使用中的對話移出主側邊欄。',
    settings_archive_after_days_7: '7 天後',
    settings_archive_after_days_14: '14 天後',
    settings_archive_after_days_30: '30 天後',
    settings_archive_after_days_90: '90 天後',
    settings_label_avatar_presence_layout: '代理頭像位置',
    settings_avatar_presence_thread: '執行緒',
    settings_avatar_presence_composer: '輸入框',
    composer_presence_switch_profile: '切換個人資料',
  ...
  pt: {
    ...
    settings_label_archive_after_days: 'Limite de arquivamento',
    settings_desc_archive_after_days: 'Move conversas inativas para fora da barra lateral principal após esse número de dias.',
    settings_archive_after_days_7: 'Após 7 dias',
    settings_archive_after_days_14: 'Após 14 dias',
    settings_archive_after_days_30: 'Após 30 dias',
    settings_archive_after_days_90: 'Após 90 dias',
    settings_label_avatar_presence_layout: 'Posição do avatar do agente',
    settings_avatar_presence_thread: 'Conversa',
    settings_avatar_presence_composer: 'Compositor',
    composer_presence_switch_profile: 'Trocar perfil',
  ...
  ko: {
    ...
    settings_label_archive_after_days: '보관 기준',
    settings_desc_archive_after_days: '비활성 대화를 이 일수 이후 기본 사이드바 밖으로 이동합니다.',
    settings_archive_after_days_7: '7일 후',
    settings_archive_after_days_14: '14일 후',
    settings_archive_after_days_30: '30일 후',
    settings_archive_after_days_90: '90일 후',
    settings_label_avatar_presence_layout: '에이전트 아바타 위치',
    settings_avatar_presence_thread: '스레드',
    settings_avatar_presence_composer: '작성기',
    composer_presence_switch_profile: '프로필 전환',
  ...
  fr: {
    ...
    settings_label_archive_after_days: 'Seuil d’archivage',
    settings_desc_archive_after_days: 'Déplace les conversations inactives hors de la barre latérale principale après ce nombre de jours.',
    settings_archive_after_days_7: 'Après 7 jours',
    settings_archive_after_days_14: 'Après 14 jours',
    settings_archive_after_days_30: 'Après 30 jours',
    settings_archive_after_days_90: 'Après 90 jours',
    settings_label_avatar_presence_layout: 'Emplacement de l’avatar de l’agent',
    settings_avatar_presence_thread: 'Fil',
    settings_avatar_presence_composer: 'Compositeur',
    composer_presence_switch_profile: 'Changer de profil',
  ...
  tr: {
    ...
    settings_label_archive_after_days: 'Arşiv eşiği',
    settings_desc_archive_after_days: 'Etkin olmayan konuşmaları bu kadar gün sonra ana kenar çubuğundan taşı.',
    settings_archive_after_days_7: '7 gün sonra',
    settings_archive_after_days_14: '14 gün sonra',
    settings_archive_after_days_30: '30 gün sonra',
    settings_archive_after_days_90: '90 gün sonra',
    settings_label_avatar_presence_layout: 'Agent avatar konumu',
    settings_avatar_presence_thread: 'Konu',
    settings_avatar_presence_composer: 'Mesaj kutusu',
    composer_presence_switch_profile: 'Profili değiştir',
