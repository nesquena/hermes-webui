...
const LOCALES = {
  ...
  es: {
    ...
    cmd_steer: 'Inyectar una correcci00f3n a mitad del turno sin interrumpir al agente',
    ...
    cmd_steer_fallback: 'Steer no disponible 2014 en cola para el siguiente turno',
    ...
    busy_steer_fallback: 'Steer no disponible 2014 en cola para el siguiente turno',
    busy_interrupt_confirm: 'Interrumpido \u2014 enviando nuevo mensaje',
    settings_label_busy_input_mode: 'Modo de entrada ocupada',
    settings_desc_busy_input_mode: 'Controla qu00e9 sucede al enviar mensajes mientras el agente est00e1 activo. Cola espera; Interrumpir cancela y empieza de nuevo; Steer inyecta una correcci00f3n sin interrumpir (usa cola si el agente no est00e1 disponible).',
    settings_busy_input_mode_queue: 'Poner en cola',
    settings_busy_input_mode_interrupt: 'Interrumpir turno actual',
    settings_busy_input_mode_steer: 'Steer (correcci00f3n a mitad de turno)',
