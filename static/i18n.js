...
const LOCALES = {
  en: {
    ...
    tab_surfaces: 'Surfaces',
    tab_pixel: 'Pixel',
    insights_title: 'Insights',
    insights_timeseries_title: 'Token trend',
    insights_timeseries_caption: 'Total tokens per day from messages.token_count.',
    insights_split_caption: 'Input / output / cache / reasoning by session start date.',
    insights_responsetime_title: 'Response time distribution',
    insights_heatmap_title: 'Activity heatmap (last 7 days)',
    insights_models_title: 'Token usage by model',
    insights_empty: 'No activity yet.',
    granularity_day: 'Day',
    granularity_week: 'Week',
    granularity_month: 'Month',
    refresh: 'Refresh',
    surfaces_title: 'Surfaces',
    surfaces_subtitle: 'Per-surface activity, based on state.db messages.',
    surface_last_message: 'Last message {0}',
    surface_state_working: 'Active',
    surface_state_waiting: 'Waiting',
    surface_state_idle: 'Idle',
    surface_state_offline: 'Offline',
    surface_messages_24h: '{0} msgs (24h)',
    surface_tokens_24h: '{0} tokens (24h)',
    surface_webui_active_sessions: '{0} active webui sessions',
    pixel_title: 'Pixel office',
    pixel_panel_hint: 'One pixel character per surface. Based on recent messages.',
    back: 'Back',
  ...
  es: {
    ...
    tab_todos: 'Todos',
    tab_insights: 'Insights',
    tab_surfaces: 'Canales',
    tab_pixel: 'Pixel',
    insights_title: 'Insights',
    insights_timeseries_title: 'Tendencia de tokens',
    insights_timeseries_caption: 'Tokens totales por día desde messages.token_count.',
    insights_split_caption: 'Input / output / cache / reasoning por fecha de inicio de sesión.',
    insights_responsetime_title: 'Distribución de tiempo de respuesta',
    insights_heatmap_title: 'Mapa de calor de actividad (últimos 7 días)',
    insights_models_title: 'Uso de tokens por modelo',
    insights_empty: 'Aún no hay actividad.',
    granularity_day: 'Día',
    granularity_week: 'Semana',
    granularity_month: 'Mes',
    refresh: 'Actualizar',
    surfaces_title: 'Canales',
    surfaces_subtitle: 'Actividad por canal, basada en mensajes de state.db.',
    surface_last_message: 'Último mensaje {0}',
    surface_state_working: 'Activo',
    surface_state_waiting: 'Esperando',
    surface_state_idle: 'Inactivo',
    surface_state_offline: 'Desconectado',
    surface_messages_24h: '{0} mensajes (24h)',
    surface_tokens_24h: '{0} tokens (24h)',
    surface_webui_active_sessions: '{0} sesiones webui activas',
    pixel_title: 'Oficina píxel',
    pixel_panel_hint: 'Un personaje píxel por canal, basado en mensajes recientes.',
    back: 'Atrás',
  ...
  de: {
    ...
    tab_pixel: 'Pixel',
    insights_title: 'Insights',
    insights_timeseries_title: 'Token-Verlauf',
    insights_timeseries_caption: 'Tokens pro Tag aus messages.token_count.',
    insights_split_caption: 'Input / Output / Cache / Reasoning nach Session-Startdatum.',
    insights_responsetime_title: 'Antwortzeit-Verteilung',
    insights_heatmap_title: 'Aktivitäts-Heatmap (letzte 7 Tage)',
    insights_models_title: 'Token-Nutzung nach Modell',
    insights_empty: 'Noch keine Aktivität.',
    granularity_day: 'Tag',
    granularity_week: 'Woche',
    granularity_month: 'Monat',
    refresh: 'Aktualisieren',
    surfaces_title: 'Kanäle',
    surfaces_subtitle: 'Aktivität pro Kanal, basierend auf state.db Nachrichten.',
    surface_last_message: 'Letzte Nachricht {0}',
    surface_state_working: 'Aktiv',
    surface_state_waiting: 'Warten',
    surface_state_idle: 'Leerlauf',
    surface_state_offline: 'Offline',
    surface_messages_24h: '{0} Nachrichten (24h)',
    surface_tokens_24h: '{0} Tokens (24h)',
    surface_webui_active_sessions: '{0} aktive WebUI-Sitzungen',
    pixel_title: 'Pixel-Büro',
    pixel_panel_hint: 'Eine Pixelfigur pro Kanal, basierend auf den letzten Nachrichten.',
    back: 'Zurück',
  ...
  zh: {
    ...
    tab_pixel: '像素',
    insights_title: '指标面板',
    insights_timeseries_title: 'Token 趋势',
    insights_timeseries_caption: '按消息时间戳聚合的每日 token 总量（来自 messages.token_count）',
    insights_split_caption: '按 session 起始日归集的 input / output / cache / reasoning 拆分',
    insights_responsetime_title: '响应时间分布',
    insights_heatmap_title: '活跃度热力图（最近 7 天）',
    insights_models_title: '按模型的 token 用量',
    insights_empty: '暂无活动记录',
    granularity_day: '日',
    granularity_week: '周',
    granularity_month: '月',
    refresh: '刷新',
    surfaces_title: '通道概览',
    surfaces_subtitle: '按 state.db 消息时间戳汇总的各通道活动',
    surface_last_message: '最近一条消息：{0}',
    surface_state_working: '活跃',
    surface_state_waiting: '等待',
    surface_state_idle: '闲置',
    surface_state_offline: '离线',
    surface_messages_24h: '{0} 条消息 (24h)',
    surface_tokens_24h: '{0} tokens (24h)',
    surface_webui_active_sessions: '{0} 个活跃 webui 会话',
    pixel_title: '像素办公室',
    pixel_panel_hint: '每个通道对应一个像素角色；状态基于最近消息时间',
    back: '返回',
  ...
  'zh-Hant': {
    ...
    tab_pixel: '\u50cf\u7d20',
    insights_title: '\u6307\u6a19\u9762\u677f',
    insights_timeseries_title: 'Token \u8da8\u52e2',
    insights_timeseries_caption: '\u6309\u6d88\u606f\u6642\u9593\u805a\u5408\u7684\u6bcf\u65e5 token \u7e3d\u91cf\uff08\u4f86\u81ea messages.token_count\uff09',
    insights_split_caption: '\u6309 session \u8d77\u59cb\u65e5\u6b78\u96c6\u7684 input / output / cache / reasoning \u62c6\u5206',
    insights_responsetime_title: '\u56de\u61c9\u6642\u9593\u5206\u4f48',
    insights_heatmap_title: '\u6d3b\u8e8d\u5ea6\u71b1\u529b\u5716\uff08\u6700\u8fd1 7 \u5929\uff09',
    insights_models_title: '\u6309\u6a21\u578b\u7684 token \u7528\u91cf',
    insights_empty: '\u66ab\u7121\u6d3b\u52d5\u8a18\u9304',
    granularity_day: '\u65e5',
    granularity_week: '\u9031',
    granularity_month: '\u6708',
    refresh: '\u91cd\u65b0\u8f09\u5165',
    surfaces_title: '\u901a\u9053\u6982\u89bd',
    surfaces_subtitle: '\u6309 state.db \u6d88\u606f\u6642\u9593\u6233\u5f59\u7e3d\u7684\u5404\u901a\u9053\u6d3b\u52d5',
    surface_last_message: '\u6700\u8fd1\u4e00\u689d\u6d88\u606f\uff1a{0}',
    surface_state_working: '\u6d3b\u8e8d',
    surface_state_waiting: '\u7b49\u5f85',
    surface_state_idle: '\u9592\u7f6e',
    surface_state_offline: '\u96e2\u7dda',
    surface_messages_24h: '{0} \u689d\u6d88\u606f (24h)',
    surface_tokens_24h: '{0} tokens (24h)',
    surface_webui_active_sessions: '{0} \u500b\u6d3b\u8e8d webui \u6703\u8a71',
    pixel_title: '\u50cf\u7d20\u8fa6\u516c\u5ba4',
    pixel_panel_hint: '\u6bcf\u500b\u901a\u9053\u5c0d\u61c9\u4e00\u500b\u50cf\u7d20\u89d2\u8272\uff1b\u72c0\u614b\u57fa\u65bc\u6700\u8fd1\u6d88\u606f\u6642\u9593',
    back: '\u8fd4\u56de',
