...
const LOCALES = {
  ...
  folder_add_as_space_title: 'Add as Space?',
    ...
    auth_status_protected: 'Protected',
  ...
  folder_add_as_space_title: 'Aggiungere come Spazio?',
    ...
    disable_auth_typed_confirm: 'Digita DISABILITA AUTH per confermare',
    auth_status_protected: 'Protetto',
    ...
    auth_acknowledged_label: 'Comprendo che questa istanza è accessibile senza autenticazione.',
  ...
  folder_add_as_space_title: 'Добавить как пространство?',
    ...
    auth_status_protected: 'Защищено',
    ...
    auth_acknowledged_label: 'Я понимаю, что этот экземпляр доступен без авторизации.',
  ...
  folder_add_as_space_title: '¿Añadir como espacio?',
    ...
    disable_auth_typed_confirm: 'Escriba DESACTIVAR AUTH para confirmar',
    auth_status_protected: 'Protegido',
    ...
    auth_acknowledged_label: 'Entiendo que esta instancia es accesible sin autenticación.',
    bg_error_single: (title) => `"${title}" has encountered an error`,
    bg_error_multi: (count) => `${count} sessions have encountered an error`,
    // skill form
    skill_name: 'Nombre',
  ...
  folder_add_as_space_title: 'Als Bereich hinzufügen?',
    ...
    auth_status_protected: 'Geschützt',
    ...
    auth_acknowledged_label: 'Ich verstehe, dass diese Instanz ohne Authentifizierung zugänglich ist.',
  ...
  'zh-Hant': {
    ...
    disable_auth_typed_confirm: 'Digite DESATIVAR AUTH para confirmar',
    auth_status_protected: 'Protegido',
    ...
    auth_acknowledged_label: 'Entendo que esta instância está acessível sem autenticação.',
  ...
  ko: {
    ...
    disable_auth_typed_confirm: '확인하려면 인증 비활성화를 입력하세요',
    auth_status_protected: '보호됨',
    auth_status_password: '비밀번호 인증',
    auth_status_passkey_only: '패스키 전용',
    auth_status_unauthenticated: '미인증',
    auth_warning_badge: '인증 비활성화됨',
    auth_acknowledged_label: '이 인스턴스가 인증 없이 접근 가능함을 이해합니다.',
    bg_error_single: (title) => `"${title}" has encountered an error`,
    bg_error_multi: (count) => `${count} sessions have encountered an error`,
    // skill form
    skill_name: 'Name',
  ...
  fr: {
    ...
    auth_acknowledged_label: 'Je comprends que cette instance est accessible sans authentification.',
    skill_name: 'Nom',
  ...
  tr: {
    ...
    auth_status_protected: 'Korumalı',
    ...
    auth_acknowledged_label: 'Bu örneğin kimlik doğrulaması olmadan erişilebilir olduğunu anlıyorum.',
