...
const LOCALES = {
  ...
  folder_add_as_space_title: 'Add as Space?',
    ...
    scripts_subtab: 'Scripts',
    scripts_empty_title: 'Select a script',
    scripts_no_scripts: 'No scripts found in ~/.hermes/scripts or the active profile scripts directory.',
    scripts_scope_global: 'global',
    scripts_scope_profile: 'profile',
    scripts_detail_title: 'Script',
    scripts_path_label: 'Path',
    scripts_scope_label: 'Scope',
    scripts_description_label: 'Description',
    scripts_source_label: 'Script',
    new_job: 'New job',
    loading: 'Loading...',
  ...
  folder_add_as_space_title: 'Aggiungere come Spazio?',
    ...
    scripts_subtab: 'Script',
    scripts_empty_title: 'Seleziona uno script',
    scripts_no_scripts: 'Nessuno script trovato in ~/.hermes/scripts o nella directory script del profilo attivo.',
    scripts_scope_global: 'Globale',
    scripts_scope_profile: 'Profilo',
    scripts_detail_title: 'Dettagli script',
    scripts_path_label: 'Percorso',
    scripts_scope_label: 'Ambito',
    scripts_description_label: 'Descrizione',
    scripts_source_label: 'Script',
    new_job: 'Nuovo job',
    loading: 'Caricamento...',
  ...
  folder_add_as_space_title: 'スペースとして追加?',
    ...
    scripts_subtab: 'スクリプト',
    scripts_empty_title: 'スクリプトを選択',
    scripts_no_scripts: '~/.hermes/scripts またはアクティブなプロファイルの scripts ディレクトリにスクリプトが見つかりません。',
    scripts_scope_global: 'グローバル',
    scripts_scope_profile: 'プロファイル',
    scripts_detail_title: 'スクリプト詳細',
    scripts_path_label: 'パス',
    scripts_scope_label: 'スコープ',
    scripts_description_label: '説明',
    scripts_source_label: 'スクリプト',
    new_job: '新規ジョブ',
    loading: '読み込み中...',
  ...
  folder_add_as_space_title: 'Добавить как пространство?',
    ...
    scripts_subtab: 'Скрипты',
    scripts_empty_title: 'Выберите скрипт',
    scripts_no_scripts: 'Скрипты не найдены в ~/.hermes/scripts или каталоге скриптов активного профиля.',
    scripts_scope_global: 'Глобальный',
    scripts_scope_profile: 'Профиль',
    scripts_detail_title: 'Сведения о скрипте',
    scripts_path_label: 'Путь',
    scripts_scope_label: 'Область',
    scripts_description_label: 'Описание',
    scripts_source_label: 'Скрипт',
  ...
  folder_add_as_space_title: '¿Añadir como espacio?',
    ...
    scripts_subtab: 'Scripts',
    scripts_empty_title: 'Selecciona un script',
    scripts_no_scripts: 'No se encontraron scripts en ~/.hermes/scripts ni en el directorio de scripts del perfil activo.',
    scripts_scope_global: 'Global',
    scripts_scope_profile: 'Perfil',
    scripts_detail_title: 'Detalles del script',
    scripts_path_label: 'Ruta',
    scripts_scope_label: 'Ámbito',
    scripts_description_label: 'Descripción',
    scripts_source_label: 'Script',
    new_job: 'Nueva tarea',
    loading: 'Cargando...',
  ...
  folder_add_as_space_title: 'Als Bereich hinzufügen?',
    ...
    scripts_subtab: 'Skripte',
    scripts_empty_title: 'Skript auswählen',
    scripts_no_scripts: 'Keine Skripte in ~/.hermes/scripts oder im Skriptverzeichnis des aktiven Profils gefunden.',
    scripts_scope_global: 'Global',
    scripts_scope_profile: 'Profil',
    scripts_detail_title: 'Skriptdetails',
    scripts_path_label: 'Pfad',
    scripts_scope_label: 'Bereich',
    scripts_description_label: 'Beschreibung',
    scripts_source_label: 'Skript',
    new_job: 'Neuer Job',
    loading: 'Lädt...',
  ...
  folder_add_as_space_title: '添加为工作区？',
    ...
    scheduled_jobs: '定时任务',
    scripts_subtab: '脚本',
    scripts_empty_title: '选择脚本',
    scripts_no_scripts: '在 ~/.hermes/scripts 或当前配置文件的 scripts 目录中未找到脚本。',
    scripts_scope_global: '全局',
    scripts_scope_profile: '配置文件',
    scripts_detail_title: '脚本详情',
    scripts_path_label: '路径',
    scripts_scope_label: '范围',
    scripts_description_label: '描述',
    scripts_source_label: '脚本',
    new_job: '新任务',
    search_skills: '搜索技能…',
    new_skill: '新技能',
    save_skill: '保存技能',
  ...
  pt: {
    ...
    scripts_subtab: 'Scripts',
    scripts_empty_title: 'Selecione um script',
    scripts_no_scripts: 'Nenhum script encontrado em ~/.hermes/scripts ou no diretório de scripts do perfil ativo.',
    scripts_scope_global: 'Global',
    scripts_scope_profile: 'Perfil',
    scripts_detail_title: 'Detalhes do script',
    scripts_path_label: 'Caminho',
    scripts_scope_label: 'Escopo',
    scripts_description_label: 'Descrição',
    scripts_source_label: 'Script',
    new_job: 'Nova tarefa',
    loading: 'Carregando...',
    search_skills: 'Buscar skills...',
  ...
  ko: {
    ...
    scripts_subtab: '스크립트',
    scripts_empty_title: '스크립트 선택',
    scripts_no_scripts: '~/.hermes/scripts 또는 활성 프로필 scripts 디렉터리에서 스크립트를 찾을 수 없습니다.',
    scripts_scope_global: '전역',
    scripts_scope_profile: '프로필',
    scripts_detail_title: '스크립트 세부 정보',
    scripts_path_label: '경로',
    scripts_scope_label: '범위',
    scripts_description_label: '설명',
    scripts_source_label: '스크립트',
    new_job: '새 작업',
    loading: '로딩 중...',
    search_skills: 'Search skills...',
    new_skill: 'New skill',
  ...
  fr: {
    ...
    scripts_subtab: 'Scripts',
    scripts_empty_title: 'Sélectionner un script',
    scripts_no_scripts: 'Aucun script trouvé dans ~/.hermes/scripts ou le dossier scripts du profil actif.',
    scripts_scope_global: 'Global',
    scripts_scope_profile: 'Profil',
    scripts_detail_title: 'Détails du script',
    scripts_path_label: 'Chemin',
    scripts_scope_label: 'Portée',
    scripts_description_label: 'Description',
    scripts_source_label: 'Script',
