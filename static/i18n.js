...
const LOCALES = {
  ...
  ko: {
    ...
    cancelling: '취소 중\u2026',
    cancel_failed: '취소 실패: ',
    mic_denied: '마이크 권한을 주지 않으면 심바가 형아 목소리를 들을 수 없어! 브라우저 마이크 권한을 켜줘🐾',
    mic_no_speech: '심바 귀에는 아무 소리도 안 들렸어! 조금만 더 가까이서 말해줘🐾',
    mic_network: '네트워크가 아파서 심바가 받아쓰기를 할 수 없어🐾',
    mic_error: '음성 입력 중에 심바 머리가 뱅글뱅글 돌았어🐾: ',
