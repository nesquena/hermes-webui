...
const LOCALES = {
  ...
  folder_add_as_space_title: 'Add as Space?',
    ...
    tab_logs: 'Logs',
    tab_voice: 'Voice',
    voice_panel_title: 'Voice transcription',
    voice_record: 'Record',
    voice_stop: 'Stop',
    voice_recording: 'Recording… click to stop',
    voice_transcribing: 'Transcribing…',
    voice_idle: 'Click the microphone to start dictating',
    voice_copy: 'Copy',
    voice_insert: 'Insert to chat',
    voice_copied: 'Transcript copied',
    voice_inserted: 'Inserted into composer',
    voice_history: 'History',
    voice_history_empty: 'No transcripts yet',
    voice_clear_history: 'Clear history',
    voice_delete: 'Delete',
    voice_unconfigured: 'No transcription models configured. Add one in Settings → Voice.',
    voice_unconfigured_short: 'No transcription models configured.',
    voice_open_settings: 'Configure in Settings',
    voice_mic_denied: 'Microphone access was denied',
    voice_unsupported: 'This browser cannot record audio',
    voice_model: 'Model',
    settings_tab_voice: 'Voice',
    voice_settings_title: 'Voice transcription',
    voice_settings_meta: 'Register OpenAI-compatible speech-to-text endpoints (e.g. a local IBM Granite server). Switch between them on the fly from the Voice tab.',
    voice_default_model: 'Default model',
    voice_add_model: '+ Add transcription model',
    voice_no_models: 'No models yet — add one below.',
    voice_saved: 'Saved.',
    voice_env_note: 'A read-only model is also provided from GRANITE_STT_* environment variables.',
    voice_field_label: 'Display name (e.g. Granite 2B)',
    voice_field_id: 'id (a-z, 0-9, -, _)',
    voice_field_model: 'Model name (e.g. granite-speech-3.3-2b)',
    voice_api_key_optional: 'API key (optional)',
