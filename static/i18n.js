...
const LOCALES = {
  ...
  folder_add_as_space_title: 'Add as Space?',
    ...
    settings_bot_logo_clear: 'Use default logo',
    settings_bot_favicon_clear: 'Use default favicon',
    ...
    settings_desc_bot_logo: 'Optional image URL used for the header and new-chat logo. Must be 64×64 to 4096×4096. Leave blank for the Hermes default.',
    settings_desc_bot_favicon: 'Optional image URL used only for browser tab and app icons. Must be 16×16 to 512×512. Leave blank for the Hermes default.',
