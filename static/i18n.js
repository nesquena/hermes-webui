...
const LOCALES = {
  ...
  folder_add_as_space_title: 'Add as Space?',
    ...
    // Knowledge
    knowledge_title: 'Knowledge & Notes',
    knowledge_local_only: 'Local-only search across indexed files and Obsidian notes.',
    knowledge_search_placeholder: 'Search local knowledge...',
    knowledge_search: 'Search',
    knowledge_ask_placeholder: 'Ask local knowledge...',
    knowledge_ask: 'Ask knowledge',
    knowledge_save_answer: 'Save answer',
    knowledge_extract_note: 'Extractive local-only context; citations are from indexed source files.',
    knowledge_unavailable: 'Local knowledge index is unavailable.',
    knowledge_no_results: 'No matching local knowledge found.',
    knowledge_empty_title: 'Search local knowledge',
    knowledge_empty_sub: 'Results and source previews stay local and redact sensitive snippets.',
    knowledge_note_title_placeholder: 'Quick note title',
    knowledge_note_content_placeholder: 'Capture a local Obsidian note...',
    knowledge_capture_note: 'Capture note',
    knowledge_note_saved: 'Note saved.',
