...
const LOCALES = {
  ...
  untitled:'Untitled',
    ...
    tasks_empty_title: 'Select a task',
    tasks_empty_sub: 'Pick a scheduled task from the sidebar to view its details, or create a new one.',
    workspaces_empty_title: 'Select a workspace',
    workspaces_empty_sub: 'Pick a workspace from the sidebar to view its details, or create a new one.',
    profiles_empty_title: 'Select a profile',
    profiles_empty_sub: 'Pick a profile from the sidebar to view its details, or create a new one.',
