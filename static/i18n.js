...
const LOCALES = {
  ...
  folder_add_as_space_title: 'Add as Space?',
    ...
    session_thread_new: 'New thread conversation',
    session_thread_new_desc: 'Start a fresh linked conversation without copying messages',
    session_thread_continue: 'Continue in linked chat',
    session_thread_continue_desc: 'Start a fresh linked chat without copying messages',
    session_thread_created: 'Started a fresh linked chat. Nothing was carried over automatically.',
    session_thread_continue_failed: 'Linked chat failed: ',
    session_thread_create_failed: 'Thread creation failed: ',
    ...
    new_thread_conversation: 'New thread conversation',
    thread_conversation_empty: 'Start fresh linked chat',
    conversation_threads: 'Conversation threads',
    thread_view_empty: 'No conversation threads yet. Use a conversation menu to start a linked thread.',
    thread_no_sessions: 'No linked conversations yet.',
    thread_current: 'Current',
    thread_missing_session: 'Missing conversation',
    thread_created_from: (title) => `Started from ${title || 'conversation'}`,
    thread_new_from_current: 'Start a linked thread from the current conversation',
    thread_export_manifest: 'Export manifest',
    thread_manifest_exported: 'Thread manifest exported',
    thread_manifest_export_failed: 'Thread manifest export failed: ',
    thread_badge_title: (count) => `${count} linked conversation${count === 1 ? '' : 's'}`,
    ...
    session_thread_part: (title, seq, total) => `${title || 'Thread'} · Part ${seq} / ${total}`,
    session_thread_badge: 'Thread',
    session_link_to_thread: 'Link to thread',
    session_link_to_thread_desc: 'Attach this conversation to an existing thread, or create a new metadata-only thread',
    session_link_to_thread_prompt: 'Paste an existing thread ID, or leave blank to create a new thread from this conversation.',
    session_linked_to_thread: 'Conversation linked to thread',
    session_link_to_thread_failed: 'Thread link failed: ',
    thread_open_latest: 'Open latest',
    thread_next_action: 'Next action',
    thread_unlink: 'Unlink',
    thread_export_transcript: 'Export transcript bundle',
    thread_export_transcript_copied: 'Transcript bundle copied',
    thread_export_manifest_copied: 'Manifest copied',
    thread_export_failed: 'Thread export failed: ',
