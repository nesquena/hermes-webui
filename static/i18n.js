...
const LOCALES = {
  ...
  untitled:'Untitled',
    ...
    settings_label_show_thinking: 'Show thinking blocks',
    ...
    settings_desc_show_thinking: 'Display reasoning/thinking cards from models that emit them (Claude, DeepSeek, QwQ, etc.). Data is always preserved; this only toggles visibility.',
