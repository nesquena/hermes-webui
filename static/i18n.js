...
const LOCALES = {
  ...
  folder_add_as_space_title: 'Add as Space?',
    ...
    providers_self_hosted_section_title: 'Open / self-hosted',
    providers_self_hosted_section_hint: 'Configure Ollama, LM Studio, or another OpenAI-compatible server. Test the base URL, pick a model, then save.',
    providers_self_hosted_save: 'Save endpoint',
    providers_self_hosted_saved: 'Self-hosted provider saved',
  ...
  folder_add_as_space_title: 'Aggiungere come Spazio?',
    ...
    providers_self_hosted_section_title: 'Open / self-hosted',
    providers_self_hosted_section_hint: 'Configura Ollama, LM Studio o un altro server compatibile OpenAI. Testa l\'URL base, scegli un modello e salva.',
    providers_self_hosted_save: 'Salva endpoint',
    providers_self_hosted_saved: 'Provider self-hosted salvato',
  ...
  folder_add_as_space_title: 'スペースとして追加?',
    ...
    providers_self_hosted_section_title: 'オープン / セルフホスト',
    providers_self_hosted_section_hint: 'Ollama、LM Studio、または他の OpenAI 互換サーバーを設定します。ベース URL をテストし、モデルを選んで保存してください。',
    providers_self_hosted_save: 'エンドポイントを保存',
    providers_self_hosted_saved: 'セルフホストプロバイダを保存しました',
  ...
  folder_add_as_space_title: '添加为工作区？',
    ...
    providers_self_hosted_section_title: '开放 / 自托管',
    providers_self_hosted_section_hint: '配置 Ollama、LM Studio 或其他 OpenAI 兼容服务器。测试基础 URL，选择模型后保存。',
    providers_self_hosted_save: '保存端点',
    providers_self_hosted_saved: '自托管提供商已保存',
  ...
  'zh-Hant': {
    ...
    providers_self_hosted_section_title: '開放 / 自託管',
    providers_self_hosted_section_hint: '設定 Ollama、LM Studio 或其他 OpenAI 相容伺服器。測試基礎 URL，選擇模型後儲存。',
    providers_self_hosted_save: '儲存端點',
    providers_self_hosted_saved: '自託管提供者已儲存',
    providers_key_placeholder_new: 'sk-...',
  ...
  pt: {
    ...
    providers_self_hosted_section_title: 'Aberto / auto-hospedado',
    providers_self_hosted_section_hint: 'Configure Ollama, LM Studio ou outro servidor compatível com OpenAI. Teste a URL base, escolha um modelo e salve.',
    providers_self_hosted_save: 'Salvar endpoint',
    providers_self_hosted_saved: 'Provedor auto-hospedado salvo',
  ...
  fr: {
    ...
    providers_self_hosted_section_title: 'Ouvert / auto-hébergé',
    providers_self_hosted_section_hint: 'Configurez Ollama, LM Studio ou un autre serveur compatible OpenAI. Testez l\'URL de base, choisissez un modèle puis enregistrez.',
    providers_self_hosted_save: 'Enregistrer l\'endpoint',
    providers_self_hosted_saved: 'Fournisseur auto-hébergé enregistré',
  ...
  tr: {
    ...
    providers_self_hosted_section_title: 'Açık / kendi kendine barındırılan',
    providers_self_hosted_section_hint: 'Ollama, LM Studio veya başka bir OpenAI uyumlu sunucu yapılandırın. Temel URL\'yi test edin, model seçin ve kaydedin.',
    providers_self_hosted_save: 'Uç noktayı kaydet',
    providers_self_hosted_saved: 'Kendi barındırılan sağlayıcı kaydedildi',
