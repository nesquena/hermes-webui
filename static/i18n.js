...
const LOCALES = {
  ...
  folder_add_as_space_title: 'スペースとして追加?',
    ...
    settings_label_session_jump_buttons: 'セッション移動ボタンを表示',
    settings_desc_session_jump_buttons: '長いセッション履歴を読むときに、先頭と末尾へ移動する浮動ボタンを表示します。',
  ...
  es: {
    ...
    session_jump_start_label: 'Ir al inicio de la sesión',
    session_jump_end: 'Final',
    session_jump_end_label: 'Ir al final de la sesión',
  ...
  folder_add_as_space_title: '¿Añadir como espacio?',
    ...
    settings_desc_session_jump_buttons: 'Muestra botones flotantes Inicio y Final al leer historiales de sesión largos.',
  ...
  de: {
    ...
    session_jump_start_label: 'Zum Anfang der Session springen',
    session_jump_end: 'Ende',
    session_jump_end_label: 'Zum Ende der Session springen',
  ...
  folder_add_as_space_title: 'Als Bereich hinzufügen?',
    ...
    settings_label_session_jump_buttons: 'Session-Sprungbuttons anzeigen',
    settings_desc_session_jump_buttons: 'Zeigt schwebende Anfang- und Ende-Buttons beim Lesen langer Session-Historien.',
  ...
  zh: {
    ...
    session_jump_start: '开始',
    session_jump_start_label: '跳转到会话开头',
    session_jump_end: '结束',
    session_jump_end_label: '跳转到会话末尾',
    queued_label: '响应后发送',
  ...
  folder_add_as_space_title: '\u6dfb\u52a0\u4e3a\u5de5\u4f5c\u533a\uff1f',
    ...
    settings_desc_session_jump_buttons: '阅读较长会话历史时显示浮动的开始和结束按钮。',
  ...
  'zh-Hant': {
    ...
    session_jump_start_label: '跳到對話開頭',
    session_jump_end: '結尾',
    session_jump_end_label: '跳到對話結尾',
    model_unavailable: '\uff08\u4e0d\u53ef\u7528\uff09',
  ...
  folder_add_as_space_title: '\u65b0\u589e\u70ba\u5de5\u4f5c\u5340\uff1f',
    ...
    settings_desc_session_jump_buttons: '閱讀較長會話歷史時顯示浮動的開始和結尾按鈕。',
  ...
  ko: {
    ...
    settings_desc_session_jump_buttons: '긴 세션 기록을 읽을 때 시작과 끝으로 이동하는 플로팅 버튼을 표시합니다.',
