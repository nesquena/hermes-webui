...
const LOCALES = {
  ...
  folder_add_as_space_title: 'Add as Space?',
    ...
    settings_desc_auto_title_refresh: 'Automatically re-generates the session title based on the latest exchange, keeping it relevant as the conversation evolves. Each refresh uses an LLM call — consider cost implications on paid providers, especially with shorter intervals. Requires an LLM title generation model to be configured; if none is set, falls back to the conversation model.',
  ...
  folder_add_as_space_title: 'Добавить как пространство?',
    ...
    settings_desc_auto_title_refresh: 'Автоматически переформулирует заголовок сессии на основе последнего обмена, чтобы он оставался актуальным по мере развития беседы. Каждое обновление использует вызов LLM — учитывайте расходы на платных провайдерах. Требует настроенную модель генерации заголовков; если она не настроена, используется модель беседы.',
  ...
  folder_add_as_space_title: '¿Añadir como espacio?',
    ...
    settings_desc_auto_title_refresh: 'Regenera automáticamente el título de la sesión basándose en el último intercambio, manteniéndolo relevante a medida que evoluciona la conversación. Cada actualización usa una llamada LLM — considere las implicaciones de costo en proveedores de pago. Requiere un modelo LLM de generación de títulos configurado; si no, se usa el modelo de conversación.',
  ...
  folder_add_as_space_title: 'Als Bereich hinzufügen?',
    ...
    settings_desc_auto_title_refresh: 'Generiert den Sitzungstitel automatisch anhand des letzten Austauschs neu und hält ihn so aktuell, während sich das Gespräch entwickelt. Jede Aktualisierung verwendet einen LLM-Aufruf — bitte die Kosten bei kostenpflichtigen Anbietern beachten. Erfordert ein konfiguriertes LLM-Titelgenerierungsmodell; falls nicht vorhanden, wird das Konversationsmodell verwendet.',
  ...
  folder_add_as_space_title: '\u6dfb\u52a0\u4e3a\u5de5\u4f5c\u533a\uff1f',
    ...
    settings_desc_auto_title_refresh: '\u57fa\u4e8e\u6700\u65b0\u5bf9\u8bdd\u81ea\u52a8\u91cd\u65b0\u751f\u6210\u4f1a\u8bdd\u6807\u9898\uff0c\u4f7f\u5176\u968f\u5bf9\u8bdd\u53d1\u5c55\u4fdd\u6301\u76f8\u5173\u3002\u6bcf\u6b21\u5237\u65b0\u4f1a\u8c03\u7528 LLM \u2014 \u8bf7\u6ce8\u610f\u4ed8\u8d39\u6a21\u578b\u7684\u6210\u672c\u5f71\u54cd\u3002\u9700\u8981\u914d\u7f6e LLM \u6807\u9898\u751f\u6210\u6a21\u578b\uff1b\u82e5\u672a\u914d\u7f6e\uff0c\u5c06\u56de\u9000\u5230\u4f1a\u8bdd\u6a21\u578b\u3002',
  ...
  folder_add_as_space_title: '\u65b0\u589e\u70ba\u5de5\u4f5c\u5340\uff1f',
    ...
    settings_desc_auto_title_refresh: '\u57fa\u65bc\u6700\u65b0\u5c0d\u8a71\u81ea\u52d5\u91cd\u65b0\u751f\u6210\u6703\u8a71\u6a19\u984c\uff0c\u4f7f\u5176\u968f\u5c0d\u8a71\u767c\u5c55\u4fdd\u6301\u76f8\u95dc\u3002\u6bcf\u6b21\u5237\u65b0\u6703\u547c\u53eb LLM \u2014 \u8acb\u6ce8\u610f\u4ed8\u8cbb\u6a21\u578b\u7684\u6210\u672c\u5f71\u97ff\u3002\u9700\u8981\u914d\u7f6e LLM \u6a19\u984c\u751f\u6210\u6a21\u578b\uff1b\u82e5\u672a\u914d\u7f6e\uff0c\u5c07\u9000\u56de\u5230\u6703\u8a71\u6a21\u578b\u3002',
