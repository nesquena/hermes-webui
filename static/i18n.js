...
const LOCALES = {
  ...
  folder_add_as_space_title: 'Add as Space?',
    ...
    custom_relays_new_subtitle: 'Configure a new relay endpoint',
    custom_relays_name: 'Display Name',
    custom_relays_name_placeholder: 'e.g. CLI Proxy (local)',
    custom_relays_base_url: 'Base URL',
    custom_relays_base_url_placeholder: 'http://127.0.0.1:8317/v1',
    custom_relays_api_key: 'API Key',
    custom_relays_key_env_hint: 'Stored in ~/.hermes/.env as',
    custom_relays_models: 'Models (one per line)',
    custom_relays_probe: 'Test & Fetch Models',
    custom_relays_probe_ok: 'Fetched {0} model(s).',
    custom_relays_probe_empty: 'Endpoint reachable but returned no models.',
    custom_relays_probe_failed: 'Probe failed: {0}',
    custom_relays_saved: 'Custom relay saved.',
    custom_relays_deleted: 'Custom relay removed.',
    custom_relays_confirm_delete: 'Remove "{0}"?',
    custom_relays_slug_preview: 'Slug: @custom:{0}  ·  env: {1}',
    custom_relays_slug_empty_hint: '⚠ Name has no ASCII letters/digits — add at least one (e.g. "relay1" or "cli-proxy"). Pure CJK names aren\'t supported because the slug is used in env-var names and the agent\'s routing grammar.',
    cancel: 'Cancel',
  ...
  folder_add_as_space_title: '添加为工作区？',
    ...
    custom_relays_new_subtitle: '配置一个新的中转端点',
    custom_relays_name: '显示名',
    custom_relays_name_placeholder: '例如：CLI Proxy（本地）',
    custom_relays_base_url: 'Base URL',
    custom_relays_base_url_placeholder: 'http://127.0.0.1:8317/v1',
    custom_relays_api_key: 'API Key',
    custom_relays_key_env_hint: '存入 ~/.hermes/.env 的环境变量',
    custom_relays_models: '模型列表（每行一个）',
    custom_relays_probe: '测试连接并拉取模型',
    custom_relays_probe_ok: '已获取 {0} 个模型。',
    custom_relays_probe_empty: '端点可达，但未返回任何模型。',
    custom_relays_probe_failed: '测试失败：{0}',
    custom_relays_saved: '中转已保存。',
    custom_relays_deleted: '中转已删除。',
    custom_relays_confirm_delete: '确认删除「{0}」？',
    custom_relays_slug_preview: 'Slug：@custom:{0}  ·  env：{1}',
    custom_relays_slug_empty_hint: '⚠ 名称里没有任何 ASCII 字母/数字 — 至少加一个（例如 "relay1" 或 "cli-proxy"）。纯中文名字不支持，因为 slug 会用于环境变量名和 agent 的路由语法（@custom:<slug>:<model>）。',
  ...
  folder_add_as_space_title: '\u65b0\u589e\u70ba\u5de5\u4f5c\u5340\uff1f',
    ...
    custom_relays_new_subtitle: '設定一個新的中轉端點',
    custom_relays_name: '顯示名稱',
    custom_relays_name_placeholder: '例如：CLI Proxy（本機）',
    custom_relays_base_url: 'Base URL',
    custom_relays_base_url_placeholder: 'http://127.0.0.1:8317/v1',
    custom_relays_api_key: 'API 金鑰',
    custom_relays_key_env_hint: '存於 ~/.hermes/.env 的環境變數',
    custom_relays_models: '模型清單（每行一個）',
    custom_relays_probe: '測試連線並抓取模型',
    custom_relays_probe_ok: '已抓取 {0} 個模型。',
    custom_relays_probe_empty: '端點可達，但未回傳任何模型。',
    custom_relays_probe_failed: '測試失敗：{0}',
    custom_relays_saved: '中轉已儲存。',
    custom_relays_deleted: '中轉已刪除。',
    custom_relays_confirm_delete: '確認刪除「{0}」？',
    custom_relays_slug_preview: 'Slug：@custom:{0}  ·  env：{1}',
    custom_relays_slug_empty_hint: '⚠ 名稱裡沒有任何 ASCII 字母/數字 — 請至少加入一個（例如 "relay1" 或 "cli-proxy"）。純中文名稱不支援，因為 slug 會用於環境變數名與 agent 的路由語法（@custom:<slug>:<model>）。',
