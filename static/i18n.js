...
const LOCALES = {
  ...
  cmd_pet:'Wake or sleep desktop pet',
  ...
  folder_add_as_space_title: 'Add as Space?',
    ...
    desktop_pet_title: 'Desktop pet',
    settings_label_desktop_pet_autostart: 'Desktop Pet (Beta)',
    settings_desc_desktop_pet: 'Show a small native companion that stays outside the browser, surfaces running sessions, completed work, approvals, and quick replies, and opens the matching WebUI session when you click a bubble. First launch may set up the local desktop shell.',
    ...
    settings_desktop_pet_setup_prepare: 'Waking up the desktop buddy...',
    settings_desktop_pet_setup_build_wait: 'Opening a tiny window outside the browser...',
    settings_desktop_pet_setup_build_continue: 'Teaching the pet how to follow your sessions...',
    settings_desktop_pet_setup_pick_spot: 'Finding a good spot on your desktop...',
    settings_desktop_pet_setup_link_sessions: 'Hooking up session updates and completions...',
    settings_desktop_pet_setup_pack_bubbles: 'Packing bubbles, approvals, and quick replies...',
    settings_desktop_pet_setup_polish: 'Polishing the little desktop shell...',
    settings_desktop_pet_setup_build_finish: 'Almost ready. The first launch usually takes the longest...',
    settings_desktop_pet_setup_build_elapsed: (seconds) => 'Still working. First launch has been running for '+seconds+'s...',
    ...
    desktop_pet_welcome_countdown: (seconds) => 'Closing in '+seconds+'s',
    desktop_pet_welcome_copy: 'I can watch running sessions, completions, approvals, and quick replies while WebUI stays in your browser.',
    ...
    desktop_pet_ready_meta_messages: (n) => `${n} message${n === 1 ? '' : 's'}`,
    desktop_pet_time_just_now: 'just now',
    desktop_pet_time_minutes_ago: (n) => `${n}m ago`,
    desktop_pet_time_hours_ago: (n) => `${n}h ago`,
    desktop_pet_time_days_ago: (n) => `${n}d ago`,
    desktop_pet_latest: 'Latest',
    desktop_pet_approve: '✓ Approve',
  ...
  cmd_pet:'Attiva o sospendi desktop pet',
  ...
  folder_add_as_space_title: '添加为工作区？',
    ...
    desktop_pet_title: '桌面宠物',
    settings_label_desktop_pet_autostart: '桌面宠物（Beta）',
    settings_desc_desktop_pet: '在浏览器外显示一个小型桌面伙伴，提醒运行中的会话、已完成的任务、审批请求和快捷回复；点击气泡会打开对应的 WebUI 会话。首次启动时可能需要先准备本地桌面壳。',
    ...
    settings_desktop_pet_setup_prepare: '正在叫醒桌面小伙伴...',
    settings_desktop_pet_setup_build_wait: '正在把小窗口搬到浏览器外面...',
    settings_desktop_pet_setup_build_continue: '正在教它盯住运行中的会话...',
    settings_desktop_pet_setup_pick_spot: '正在给宠物找一个合适的落脚点...',
    settings_desktop_pet_setup_link_sessions: '正在接上会话更新和完成提醒...',
    settings_desktop_pet_setup_pack_bubbles: '正在打包气泡、审批和快捷回复...',
    settings_desktop_pet_setup_polish: '正在擦亮这个小小的桌面壳...',
    settings_desktop_pet_setup_build_finish: '快好了，首次启动通常最慢...',
    settings_desktop_pet_setup_build_elapsed: (seconds) => '还在认真准备中，首次启动已运行 '+seconds+' 秒...',
    ...
    desktop_pet_welcome_title: '你好呀',
    desktop_pet_welcome_countdown: (seconds) => '将在 '+seconds+' 秒后关闭',
    desktop_pet_welcome_copy: '我会在浏览器外提醒运行中的会话、已完成的任务、审批请求和快捷回复。',
    desktop_pet_welcome_action: '我知道了',
    ...
    desktop_pet_approve: '✓ 批准',
    desktop_pet_deny: '✕ 拒绝',
    desktop_pet_pick_one: '请选择：',
  ...
  folder_add_as_space_title: '\u65b0\u589e\u70ba\u5de5\u4f5c\u5340\uff1f',
    ...
    desktop_pet_title: '桌面寵物',
    settings_label_desktop_pet_autostart: '桌面寵物（Beta）',
    settings_desc_desktop_pet: '在瀏覽器外顯示一個小型桌面夥伴，提醒執行中的會話、已完成的工作、審批請求和快捷回覆；點擊氣泡會開啟對應的 WebUI 會話。首次啟動時可能需要先準備本地桌面殼。',
    ...
    settings_desktop_pet_setup_prepare: '正在叫醒桌面小夥伴...',
    settings_desktop_pet_setup_build_wait: '正在把小視窗搬到瀏覽器外面...',
    settings_desktop_pet_setup_build_continue: '正在教它盯住執行中的會話...',
    settings_desktop_pet_setup_pick_spot: '正在給寵物找一個合適的落腳點...',
    settings_desktop_pet_setup_link_sessions: '正在接上會話更新和完成提醒...',
    settings_desktop_pet_setup_pack_bubbles: '正在打包氣泡、審批和快捷回覆...',
    settings_desktop_pet_setup_polish: '正在擦亮這個小小的桌面殼...',
    settings_desktop_pet_setup_build_finish: '快好了，首次啟動通常最慢...',
    settings_desktop_pet_setup_build_elapsed: (seconds) => '還在認真準備中，首次啟動已執行 '+seconds+' 秒...',
    ...
    desktop_pet_welcome_title: '你好呀',
    desktop_pet_welcome_countdown: (seconds) => '將在 '+seconds+' 秒後關閉',
    desktop_pet_welcome_copy: '我會在瀏覽器外提醒執行中的會話、已完成的工作、審批請求和快捷回覆。',
    desktop_pet_welcome_action: '我知道了',
  ...
  pt: {
    ...
    cmd_pet: 'Acordar ou dormir o pet de desktop',
  ...
  tr: {
    ...
    _label: 'Türkçe',
    _speech: 'tr-TR',
    // Desktop Pet beta strings intentionally fall back to English until Turkish
    // product copy is translated; keep the key set complete so locale coverage
    // tests catch future omissions.
    cmd_pet: 'Control the Desktop Pet (usage: /pet wakeup|sleep)',
    cmd_pet_usage: 'Usage: /pet wakeup|sleep',
    cmd_pet_wakeup_done: 'Desktop pet wakeup requested.',
    cmd_pet_sleep_done: 'Desktop pet closed.',
    cmd_pet_unavailable: 'Desktop pet is unavailable:',
    desktop_pet_title: 'Desktop pet',
    settings_label_desktop_pet_autostart: 'Desktop Pet (Beta)',
    settings_desc_desktop_pet: 'Show a small native companion that stays outside the browser, surfaces running sessions, completed work, approvals, and quick replies, and opens the matching WebUI session when you click a bubble. First launch may set up the local desktop shell.',
    settings_open_desktop_pet: 'Start desktop pet',
