...
const LOCALES = {
  ...
  folder_add_as_space_title: 'Add as Space?',
    ...
    safe_config_title: 'Safe config.yaml',
    safe_config_desc: 'View the active profile config with secrets redacted. This panel is read-only so hidden values are never overwritten.',
    safe_config_refresh: 'Refresh config',
    safe_config_copy: 'Copy redacted YAML',
    safe_config_loading: 'Loading…',
    safe_config_meta: (filename, count) => `${filename} · ${count} redacted value${Number(count)===1?'':'s'}`,
    safe_config_failed: 'Failed to load config: ',
    safe_config_copied: 'Copied redacted config.',
    safe_config_copy_failed: 'Copy failed: ',
