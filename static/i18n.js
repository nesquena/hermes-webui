...
const LOCALES = {
  ...
  folder_add_as_space_title: 'Add as Space?',
    ...
    cron_deliver_origin: 'Origin (same chat)',
    ...
    workspace_add_title: 'Add workspace',
    workspace_rename_title: 'Rename space',
    // profile form
    profile_name_label: 'Name',
    profile_base_url_label: 'Base URL',
    profile_api_key_label: 'API key',
    profile_name_required: 'Name is required',
    profile_model_required: 'Model is required',
    ...
    profile_delete_confirm: (name) => `Delete profile "${name}"?`,
    ...
    approval_skip: 'Skip',
    approval_skip_title: 'Skip this approval prompt',
  ...
  tr: {
    offline_title: 'Bağlantı koptu',
    offline_browser_detail: 'Tarayıcınız bu cihazın çevrimdışı olduğunu bildiriyor.',
    offline_network_detail: 'Hermes şu anda bu tarayıcıdan erişilebilir değil.',
    offline_autorefresh: 'Hermes tekrar erişilebilir olduğunda sayfayı otomatik olarak yenileyeceğim.',
    offline_check_now: 'Şimdi kontrol et',
    offline_checking: 'Kontrol ediliyor…',
    offline_stream_waiting: 'Bağlantı koptu. Yenilemek için bekleniyor…',
    _lang: 'tr',
    _label: 'Türkçe',
    _speech: 'tr-TR',
    // boot.js
    cancelling: 'İptal ediliyor\u2026',
    cancel_failed: 'İptal başarısız: ',
    mic_denied: 'Mikrofon erişimi reddedildi. Tarayıcı izinlerini kontrol edin.',
    mic_no_speech: 'Ses algılanmadı. Tekrar deneyin.',
    mic_network: 'Ses tanıma kullanılamıyor.',
    mic_error: 'Ses girişi hatası: ',
    // Composer voice buttons (#1488 — distinct labels for dictation vs voice mode)
    voice_dictate: 'Dikte et',
    ...
    voice_error: 'Bu tarayıcıda ses desteklenmiyor',
    ...
    image_pasted: 'Görsel yapıştırıldı: ',
    // messages.js
    ...
    diff_loading: 'Diff yükleniyor',
    diff_error: 'Yama dosyası yüklenemedi',
    diff_too_large: 'Yama dosyası satır içi gösterim için çok büyük',
    tree_view: 'Ağaç',
    raw_view: 'Ham',
    parse_failed_note: 'ayrıştırma başarısız',
    you: 'Sen',
    mcp_servers_title: 'MCP Sunucuları',
    mcp_servers_desc: 'config.yaml içinde yapılandırılmış MCP sunucularını görüntüleyin.',
    mcp_no_servers: 'Yapılandırılmış MCP sunucusu yok.',
    mcp_add_server: '+ Sunucu Ekle',
    mcp_field_name: 'Sunucu Adı',
    mcp_transport_label: 'Taşıma Türü',
    mcp_field_command: 'Komut',
    mcp_field_args: 'Argümanlar (virgülle ayrılmış)',
    mcp_field_url: 'URL',
    mcp_field_timeout: 'Zaman aşımı (saniye)',
    mcp_save: 'Kaydet',
    mcp_cancel: 'İptal',
    mcp_name_required: 'Sunucu adı zorunludur.',
    mcp_url_required: 'HTTP taşıması için URL zorunludur.',
    mcp_command_required: 'stdio taşıması için komut zorunludur.',
    mcp_saved: 'MCP sunucusu kaydedildi.',
    mcp_save_failed: 'MCP sunucusu kaydedilemedi.',
    mcp_delete_confirm_title: 'MCP Sunucusunu Sil',
    mcp_delete_confirm_message: '"{0}" MCP sunucusu silinsin mi? Bu işlem geri alınamaz.',
    mcp_deleted: 'MCP sunucusu silindi.',
    mcp_delete_failed: 'MCP sunucusu silinemedi.',
    mcp_load_failed: 'MCP sunucuları yüklenemedi.',
    mcp_restart_hint: 'Sunucu değişiklikleri şimdilik salt okunur. Değişikliklerin etkili olması için config.yaml dosyasını düzenleyip Hermes\'i yeniden başlatın.',
    mcp_toggle_followup: 'Etkinleştirme/devre dışı bırakma kontrolleri, MCP yeniden yükleme semantiği netleşene kadar kasıtlı olarak ertelenmiştir.',
    mcp_status_active: 'Aktif',
    mcp_status_configured: 'Yapılandırıldı',
    mcp_status_disabled: 'Devre dışı',
    mcp_status_invalid_config: 'Geçersiz yapılandırma',
    mcp_status_unknown: 'Bilinmiyor',
    mcp_tool_count: '{0} araç',
    mcp_enabled_yes: 'Etkin',
    mcp_enabled_no: 'Devre dışı',
    mcp_tools_title: 'MCP Araçları',
    mcp_tools_desc: 'Aktif MCP sunucularındaki bilinen araçları arayın.',
    mcp_tools_search_placeholder: 'Araçları ada, sunucuya veya açıklamaya göre arayın…',
    mcp_tools_no_tools: 'Aktif çalışma zamanı envanterinde MCP aracı yok.',
    ...
    mcp_tools_runtime_note: 'Araç envanteri yalnızca zaten bilinen aktif MCP çalışma zamanı verilerini kullanır; WebUI sunucuları başlatmaz veya sorgulamaz.',
    mcp_tools_summary_no_matches: (query,total) => `"${query}" ile eşleşen MCP aracı yok (toplam ${total} MCP aracı).`,
    mcp_tools_summary_none: 'Gösterilecek MCP aracı yok.',
    mcp_tools_summary_matching: (query) => ` "${query}" ile eşleşen`,
    mcp_tools_summary_total_note: (total) => ` (toplam ${total} MCP aracı)`,
    mcp_tools_summary_showing: (start,end,filtered,searchNote,totalNote,page,pages) => `${filtered} MCP aracından ${start}-${end} arası gösteriliyor${searchNote}${totalNote}. Sayfa ${page}/${pages}.`,
    mcp_tools_page_size_prefix: 'Göster',
    mcp_tools_page_size_suffix: 'sayfa başına',
    mcp_tools_per_page_aria: 'Sayfa başına MCP aracı',
    mcp_tools_inactive_configured_servers: (servers) => `Yapılandırılmış ancak bu WebUI çalışma zamanında etkin değil: ${servers}.`,
    mcp_tools_pagination_label: 'MCP araçları sayfalaması',
    ...
    html_sandbox_label: 'HTML Önizleme (korumalı alan)',
    thinking: 'Düşünüyor',
    expand_all: 'Tümünü genişlet',
    collapse_all: 'Tümünü daralt',
    edit_failed: 'Düzenleme başarısız: ',
    regen_failed: 'Yeniden oluşturma başarısız: ',
    reconnect_active: 'Bir yanıt hala oluşturuluyor. Hazır olunca yeniden yüklensin mi?',
    reconnect_finished: 'Son ayrıldığınızda bir yanıt oluşturuluyordu. Mesajlar güncellenmiş olabilir.',
    // approval card
    approval_heading: 'Onay gerekiyor',
    approval_desc_prefix: 'Tehlikeli komut algılandı',
    approval_btn_once: 'Bir kez izin ver',
    approval_btn_once_title: 'Bu komuta bir kez izin ver (Enter)',
    approval_btn_session: 'Oturum boyunca izin ver',
    approval_btn_session_title: 'Bu konuşma oturumu için izin ver',
    approval_btn_always: 'Her zaman izin ver',
    approval_btn_always_title: 'Bu komut desenine her zaman izin ver',
    approval_btn_deny: 'Reddet',
    approval_btn_deny_title: 'Reddet — bu komutu çalıştırma',
    approval_responding: 'Yanıtlanıyor\u2026',
    clarify_heading: 'Açıklama gerekli',
    clarify_hint: 'Bir seçenek seçin veya kendi yanıtınızı yazın.',
    clarify_other: 'Diğer',
    clarify_send: 'Gönder',
    clarify_input_placeholder: 'Yanıtınızı yazın…',
    clarify_responding: 'Yanıtlanıyor\u2026',
    untitled: 'Başlıksız',
    n_messages: (n) => `${n} mesaj`,
    load_older_messages: '↑ Daha eski mesajları yüklemek için kaydırın veya tıklayın',
    session_jump_start: 'Başlangıç',
    session_jump_start_label: 'Oturumun başına atla',
    session_jump_end: 'Son',
    session_jump_end_label: 'Oturumun sonuna atla',
    queued_label: 'Yanıttan sonra gönderilir',
    queued_count: (n) => n === 1 ? '1 sırada' : `${n} sırada`,
    queued_cancel: 'Sıradaki mesajı iptal et',
    model_unavailable: ' (kullanılamıyor)',
    model_unavailable_title: 'Bu model artık mevcut sağlayıcı listenizde yok',
    provider_mismatch_warning: (m,p)=>`"${m}" yapılandırılmış sağlayıcınızla (${p}) çalışmayabilir. Yine de gönderin veya terminalde \`hermes model\` çalıştırarak değiştirin.`,
    provider_mismatch_label: 'Sağlayıcı uyuşmazlığı',
    model_not_found_label: 'Model bulunamadı',
    model_custom_label: 'Özel model ID',
    model_custom_placeholder: 'örn. openai/gpt-5.4',
    model_search_placeholder: 'Modelleri ara…',
    model_search_no_results: 'Model bulunamadı',
    model_group_configured: 'Yapılandırıldı',
    ws_search_placeholder: 'Çalışma alanlarını ara…',
    ws_no_results: 'Çalışma alanı bulunamadı',
    workspace_new_worktree_conversation: 'Worktree\'de yeni konuşma',
    workspace_new_worktree_conversation_meta: 'Bu çalışma alanı için yalıtılmış bir git worktree oluşturun.',
    workspace_worktree_created: 'Worktree konuşması oluşturuldu',
    workspace_worktree_failed: 'Worktree oluşturma başarısız: ',
    session_worktree_badge: 'Worktree',
    model_scope_advisory: 'Bir sonraki mesajınızdan itibaren bu konuşma için geçerlidir.',
    model_scope_toast: 'Bir sonraki mesajınızdan itibaren bu konuşma için geçerlidir.',
    // commands.js
    cmd_clear: 'Konuşma mesajlarını temizle',
    cmd_compress: 'Konuşma bağlamını manuel olarak sıkıştır (kullanım: /compress [odak konusu])',
    ctx_compress_hint: 'Yer açmak için bağlamı sıkıştır →',
    ctx_compress_action: '⚠ Şimdi sıkıştırarak bağlamı boşalt',
    cmd_compact_alias: '/compress için eski takma ad',
    cmd_model: 'Model değiştir (örn. /model gpt-4o)',
    cmd_workspace: 'Çalışma alanını ada göre değiştir',
    cmd_terminal: 'Çalışma alanı terminalini aç',
    cmd_new: 'Yeni sohbet oturumu başlat',
    cmd_usage: 'Token kullanımı gösterimini aç/kapat',
    cmd_theme: 'Görünümü değiştir (tema: system/dark/light, cilt: default/ares/mono/slate/poseidon/sisyphus/charizard)',
    cmd_personality: 'Ajan kişiliğini değiştir',
    cmd_skills: 'Mevcut Hermes becerilerini listele',
    available_commands: 'Mevcut komutlar:',
    type_slash: 'Komutları görmek için / yazın',
    conversation_cleared: 'Konuşma temizlendi',
    command_label: 'Komut',
    context_compaction_label: 'Bağlam sıkıştırma',
    preserved_task_list_label: 'Korunan görev listesi',
    reference_only_label: 'Yalnızca referans',
    model_usage: 'Kullanım: /model <ad>',
    no_model_match: 'Eşleşen model yok: "',
    switched_to: 'Şuna geçildi: ',
    workspace_usage: 'Kullanım: /workspace <ad>',
    no_workspace_match: 'Eşleşen çalışma alanı yok: "',
    switched_workspace: 'Çalışma alanı değiştirildi: ',
    workspace_switch_failed: 'Çalışma alanı değiştirme başarısız: ',
    new_session: 'Yeni oturum oluşturuldu',
    compressing: 'Bağlam sıkıştırma isteniyor...',
    compress_running_label: 'Sıkıştırılıyor',
    compress_complete_label: 'Sıkıştırma tamamlandı',
    auto_compress_label: 'Otomatik sıkıştırma',
    compress_failed_label: 'Sıkıştırma başarısız',
    focus_label: 'Odak',
    token_usage_on: 'Token kullanımı açık',
    token_usage_off: 'Token kullanımı kapalı',
    theme_usage: 'Kullanım: /theme ',
    theme_set: 'Tema: ',
    no_active_session: 'Aktif oturum yok',
    cmd_queue: 'Sonraki tur için mesaj sıraya al',
    cmd_goal: 'Kalıcı hedef ayarla veya görüntüle',
    goal_evaluating_progress: 'Hedef ilerlemesi değerlendiriliyor…',
    goal_working_toward: 'Hedefe doğru çalışılıyor…',
    goal_continuing_toast: 'Hedefe doğru devam ediliyor…',
    goal_status_none: 'Aktif hedef yok. /goal <metin> ile bir hedef belirleyin.',
    ...
    goal_set: (turns, goal) => `⊙ Hedef belirlendi (${turns} tur bütçe): ${goal}`,
    goal_paused: (goal) => `⏸ Hedef duraklatıldı: ${goal}`,
    goal_resumed: (goal) => `▶ Hedef sürdürüldü: ${goal}`,
    goal_cleared: 'Hedef temizlendi.',
    goal_no_goal: 'Aktif hedef yok.',
    goal_achieved: (reason) => `✓ Hedefe ulaşıldı: ${reason}`,
    goal_paused_budget_exhausted: (turns, max_turns) => `⏸ Hedef duraklatıldı — ${turns}/${max_turns} tur kullanıldı. Devam etmek için /goal resume, durdurmak için /goal clear kullanın.`,
    goal_continuing: (turns, max_turns, reason) => `↻ Hedefe doğru devam ediliyor (${turns}/${max_turns}): ${reason}`,
    cmd_interrupt: 'Mevcut turu iptal et ve yeni mesaj gönder',
    cmd_steer: 'Ajanı kesmeden tur ortası düzeltme ekle',
    cmd_queue_no_msg: 'Kullanım: /queue <mesaj>',
    cmd_queue_not_busy: 'Aktif görev yok — normal şekilde gönderin',
    cmd_queue_confirm: 'Mesaj sıraya alındı',
    cmd_interrupt_no_msg: 'Kullanım: /interrupt <mesaj>',
    cmd_interrupt_confirm: 'Kesildi — yeni mesaj gönderiliyor',
    cmd_steer_no_msg: 'Kullanım: /steer <mesaj>',
    cmd_steer_fallback: 'Yönlendirme kullanılamıyor — bunun yerine sonraki tur için sıraya alındı',
    cmd_steer_delivered: 'Yönlendirme iletildi — ajan bunu sonraki araç sonucunda görecek',
    steer_leftover_queued: 'Yönlendirme sonraki tur için sıraya alındı',
    busy_steer_fallback: 'Yönlendirme kullanılamıyor — sonraki tur için sıraya alındı',
    busy_interrupt_confirm: 'Kesildi — yeni mesaj gönderiliyor',
    settings_label_busy_input_mode: 'Meşgulken giriş modu',
    settings_desc_busy_input_mode: 'Ajan çalışırken mesaj gönderdiğinizde ne olacağını kontrol eder. Sıraya al beklemede tutar; Kes ve gönder iptal edip yeniden başlatır; Yönlendir tur ortasında kesmeden düzeltme ekler (ajan veya akış kullanılamadığında sıraya düşer).',
    settings_label_fade_text_effect: 'Metin geçiş efekti',
    settings_desc_fade_text_effect: 'Asistan yanıt verirken yeni gelen kelimeleri yumuşak geçişle göster. OpenWebUI benzeri; maksimum performans için varsayılan olarak kapalıdır.',
    settings_busy_input_mode_queue: 'Sıraya al',
    settings_busy_input_mode_interrupt: 'Kes ve gönder',
    settings_busy_input_mode_steer: 'Yönlendir (tur ortası düzeltme)',
    slash_skill_badge:'Beceri',
    slash_skill_desc:'Bu beceriyi çağır',
    cmd_stop:'Mevcut yanıtı durdur',
    cmd_title:'Oturum başlığını al veya ayarla',
    cmd_retry:'Son mesajı yeniden gönder',
    cmd_undo:'Son alışverişi geri al',
    cmd_btw:'Yan soru sor (geçici)',
    cmd_btw_usage:'/btw <soru> — oturum bağlamını kullanarak yan soru sor',
    cmd_background:'Arka planda istem çalıştır',
    cmd_background_usage:'/background <istem> — engellemeden paralel çalıştır',
    cmd_branch:'Bu konuşmayı yeni bir oturuma dallandır',
    cmd_branch_usage:'/branch [ad] — konuşmayı dallandır (isteğe bağlı adla)',
    branch_forked:'Yeni oturuma dallandırıldı',
    branch_failed:'Dallandırma başarısız: ',
    fork_from_here:'Buradan dallandır',
    forked_from:'Dallandırıldığı yer',
    subagent_children:'Alt ajan oturumları',
    btw_asking:'Yan soru soruluyor...',
    btw_label:'Yan soru — geçmişte değil',
    btw_done:'Yan soru yanıtlandı',
    btw_no_answer:'Yanıt alınamadı.',
    btw_failed:'Yan soru başarısız: ',
    bg_running:'Arka planda çalışıyor...',
    bg_complete:'Arka plan görevi tamamlandı',
    bg_label:'Arka plan sonucu:',
    bg_no_answer:'(yanıt yok)',
    bg_failed:'Arka plan görevi başarısız: ',
    undo_exchange:'Son alışverişi geri al',
    cmd_status:'Oturum bilgisini göster',
    cmd_voice:'Mikrofon girişini aç/kapat',
    stream_stopped:'Yanıt durduruldu.',
    no_active_task:'Durdurulacak aktif görev yok.',
    ...
    undid_messages_suffix:'mesaj.',
    status_heading:'Oturum Durumu',
    status_session_id:'Oturum ID',
    status_title:'Başlık',
    status_model:'Model',
    ...
    status_agent_running:'Ajan çalışıyor',
    status_profile: 'Profil',
    status_hermes_home: 'Hermes ana dizini',
    ...
    status_no_tokens: 'Token kullanılmadı',
    ...
    title_set:'Başlık ayarlandı: ',
    cmd_webui_only_session:'Bu komut CLI\'dan içe aktarılan oturumlar için kullanılamaz.',
    cmd_voice_use_mic:'Oluşturucudaki mikrofon düğmesine tıklayın.',
    usage_heading:'Token Kullanımı',
    usage_default_model:'varsayılan',
    usage_unknown:'bilinmiyor',
    usage_input_tokens:'Girdi tokenları',
    usage_output_tokens:'Çıktı tokenları',
    usage_total:'Toplam token',
    usage_estimated_cost:'Tahmini maliyet',
    usage_settings_tip:'Not: maliyet tahminleri yaklaşıktır.',
    usage_load_failed:'Kullanım yüklenemedi: ',
    usage_personality_none:'yok',
    // Session toolsets (#493)
    session_toolsets:'Oturum Araç Setleri',
    session_toolsets_desc:'Bu oturum için kullanılabilir araçları kısıtla (boş = genel yapılandırmayı kullan)',
    ...
    untitled:'Başlıksız',
    no_personalities: 'Kişilik bulunamadı (~/.hermes/personalities/ dizinine ekleyin)',
    available_personalities: 'Mevcut kişilikler:',
    personality_switch_hint: '\\n\\nDeğiştirmek için `/personality <ad>` kullanın veya temizlemek için `/personality none`.',
    personalities_load_failed: 'Kişilikler yüklenemedi',
    personality_cleared: 'Kişilik temizlendi',
    personality_set: 'Kişilik: ',
    failed_colon: 'Başarısız: ',
    // ui.js
    no_workspace: 'Çalışma alanı yok',
    terminal_open_title: 'Çalışma alanı terminalini aç',
    terminal_no_workspace_title: 'Terminal açmak için bir çalışma alanı seçin',
    terminal_title: 'Terminal',
    terminal_clear: 'Temizle',
    terminal_copy_output: 'Çıktıyı kopyala',
    terminal_restart: 'Yeniden başlat',
    terminal_collapse: 'Daralt',
    terminal_expand: 'Genişlet',
    terminal_close: 'Kapat',
    terminal_input_placeholder: 'Komut çalıştır...',
    terminal_start_failed: 'Terminal başlatılamadı: ',
    terminal_input_failed: 'Terminal girişi başarısız: ',
    terminal_copy_failed: 'Kopyalama başarısız: ',
    terminal_error: 'Terminal hatası',
    workspace_empty_no_path: 'Çalışma alanı seçilmedi. Dosyalara göz atmak için Ayarlar → Çalışma Alanı\'ndan bir alan belirleyin.',
    workspace_empty_dir: 'Bu çalışma alanı boş.',
    workspace_show_hidden_files: 'Gizli dosyaları göster',
    workspace_show_hidden_files_desc: '.DS_Store, .git, node_modules ve diğer gizli / sistem dosyalarını dosya ağacına dahil et.',
    ...
    dialog_prompt_title: 'Değer girin',
    dialog_confirm_btn: 'Onayla',
    // workspace.js
    unsaved_confirm: 'Önizlemede kaydedilmemiş değişiklikler var. Vazgeçip yine de gidilsin mi?',
    discard: 'Vazgeç',
    save: 'Kaydet',
    edit: 'Düzenle',
    clear: 'Temizle',
    ...
    reveal_failed: 'Gösterme başarısız: ',
    ...
    session_rename_desc: 'Bu konuşmanın başlığını düzenle',
    new_file_prompt: 'Yeni dosya adı (örn. notlar.md):',
    ...
    folder_create_failed: 'Klasör oluşturma başarısız: ',
    workspace_auto_create_folder: 'Klasör yoksa oluştur',
    ...
    upload_too_large: (maxMb, fileMb) => `Dosya çok büyük (${fileMb} MB). Maksimum yükleme boyutu ${maxMb} MB.`,
    all_uploads_failed: (n) => `${n} yüklemenin tümü başarısız`,
    archive_extracted: (n, c) => `${c} arşivden ${n} dosya çıkarıldı`,
    session_pin: 'Konuşmayı sabitle',
    session_unpin: 'Sabitlemeyi kaldır',
    session_pin_desc: 'Bu konuşmayı en üstte tut',
    session_unpin_desc: 'Sabitlenenlerden kaldır',
    session_pin_failed: 'Sabitleme başarısız: ',
    session_move_project: 'Projeye taşı',
    session_move_project_desc_has: 'Bu konuşmanın projesini değiştir',
    session_move_project_desc_none: 'Bu konuşmaya bir proje ata',
    session_archive: 'Konuşmayı arşivle',
    session_restore: 'Konuşmayı geri getir',
    session_archive_desc: 'Arşiv gösterilene kadar bu konuşmayı gizle',
    session_archive_worktree_desc: 'Bu konuşmayı gizle; worktree\'sini diskte tut',
    session_restore_desc: 'Bu konuşmayı ana listeye geri getir',
    session_archived: 'Oturum arşivlendi',
    session_archived_worktree: 'Oturum arşivlendi. Worktree diskte kaldı.',
    session_restored: 'Oturum geri getirildi',
    session_archive_failed: 'Arşivleme başarısız: ',
    session_duplicate: 'Konuşmayı çoğalt',
    session_duplicate_desc: 'Aynı çalışma alanı ve modelle bir kopya oluştur',
    session_duplicated: 'Oturum çoğaltıldı',
    session_duplicate_failed: 'Çoğaltma başarısız: ',
    session_stop_response: 'Yanıtı durdur',
    session_stop_response_desc: 'Bu konuşma için çalışan yanıtı iptal et',
    session_delete: 'Konuşmayı sil',
    session_delete_desc: 'Bu konuşmayı kalıcı olarak kaldır',
    session_delete_confirm: 'Bu konuşma silinsin mi?',
    session_delete_worktree_desc: 'Yalnızca WebUI konuşmasını sil; worktree diskte kalsın',
    session_delete_worktree_confirm: (path) => `Bu konuşma silinsin mi? ${path} konumundaki worktree diskte kalacak.`,
    session_deleted: 'Konuşma silindi',
    session_deleted_worktree: 'Konuşma silindi. Worktree diskte kaldı.',
    session_worktree_remove: 'Worktree\'yi kaldır',
    session_worktree_remove_desc: (path) => `${path} konumundaki git worktree\'yi diskten sil`,
    session_worktree_remove_confirm: (path) => `Git worktree diskten kaldırılsın mı?\\n\\nYol: ${path}\\n\\nBu işlem tüm worktree dizinini silecek. Oturum verileri WebUI\'de kalır.`,
    session_worktree_remove_not_exists: (path) => `${path} konumundaki worktree artık diskte mevcut değil.`,
    session_worktree_remove_confirm_label: 'Kaldır',
    session_worktree_removed: 'Worktree kaldırıldı.',
    session_worktree_remove_failed: 'Worktree kaldırılamadı: ',
    session_worktree_remove_status_failed: 'Worktree durumu okunamadı: ',
    session_worktree_remove_locked_by_stream: 'Kaldırılamaz — aktif bir akış oturumu bu worktree\'yi kullanıyor.',
    session_worktree_remove_locked_by_terminal: 'Kaldırılamaz — aktif bir terminal oturumu bu worktree\'yi kullanıyor.',
    session_worktree_remove_unsafe_blocked: 'Bu worktree\'yi kaldırmadan önce yerel değişiklikleri veya gönderilmemiş commit\'leri çözün.',
    session_worktree_remove_dirty_warning: 'UYARI: Bu worktree\'de kaydedilmemiş değişiklikler var ve bunlar kaybolacak.',
    ...
    session_select_mode: 'Seç',
    session_select_mode_desc: 'Toplu yönetim için konuşmaları seç',
    session_select_all: 'Tümünü seç',
    session_deselect_all: 'Tüm seçimleri kaldır',
    session_selected_count: '{0} seçili',
    session_batch_archive: 'Arşivle',
    session_batch_delete: 'Sil',
    session_batch_move: 'Projeye taşı',
    session_batch_delete_confirm: '{0} konuşma silinsin mi?',
    session_batch_archive_confirm: '{0} konuşma arşivlensin mi?',
    session_batch_delete_worktree_confirm: '{0} konuşma silinsin mi? {1} worktree destekli konuşmanın worktree dizinleri diskte kalacak.',
    session_batch_archive_worktree_confirm: '{0} konuşma arşivlensin mi? {1} worktree destekli konuşmanın worktree dizinleri diskte kalacak.',
    session_no_selection: 'Hiç konuşma seçilmedi',
    // settings panel
    ...
    settings_section_appearance_title: 'Görünüm',
    settings_section_appearance_meta: 'Tema, vurgu renkleri ve görsel stil.',
    settings_section_preferences_title: 'Tercihler',
    settings_section_preferences_meta: 'Hermes Web UI için varsayılanlar ve davranış.',
    settings_section_system_title: 'Sistem',
    settings_section_system_meta: 'Sürüm ve erişim kontrolleri.',
    ...
    settings_updates_disabled: 'Güncelleme kontrolleri devre dışı',
    settings_update_check_failed: 'Güncelleme kontrolü başarısız',
    settings_label_workspace_panel_open: 'Çalışma alanı panelini varsayılan olarak açık tut',
    settings_desc_workspace_panel_open: 'Etkinleştirildiğinde, çalışma alanı / dosya gezgini paneli her yeni oturumda otomatik olarak açılır. İstediğiniz zaman manuel olarak kapatabilirsiniz.',
    settings_label_session_jump_buttons: 'Oturum atlama düğmelerini göster',
    settings_desc_session_jump_buttons: 'Uzun oturum geçmişlerini okurken yüzen Başlangıç ve Son düğmelerini göster.',
    settings_label_session_endless_scroll: 'Yukarı kaydırırken eski mesajları yükle',
    settings_desc_session_endless_scroll: 'Etkinleştirildiğinde, yukarı kaydırdıkça eski mesajlar otomatik yüklenir. Devre dışıyken eski mesajlar düğmesini kullanın.',
    open_in_browser: 'Tarayıcıda aç',
    settings_dropdown_conversation: 'Konuşma',
    settings_dropdown_appearance: 'Görünüm',
    ...
    settings_desc_model: 'Yeni konuşmalar için kullanılır. Mevcut konuşmalar seçili modellerini korur.',
    settings_label_send_key: 'Gönder Tuşu',
    settings_label_theme: 'Tema',
    settings_label_skin: 'Cilt',
    ...
    settings_autosave_failed: 'Kaydetme başarısız',
    settings_autosave_retry: 'Tekrar dene',
    settings_label_language: 'Dil',
    settings_label_token_usage: 'Token kullanımını göster',
    settings_label_sidebar_density: 'Kenar çubuğu yoğunluğu',
    cmd_reasoning: 'Düşünme görünürlüğünü değiştir (göster/gizle), çaba seviyesini ayarla veya mevcut durumu kontrol et',
    settings_label_external_sessions: 'WebUI dışı oturumları göster',
    settings_label_sync_insights: 'Analizlerle senkronize et',
    settings_label_check_updates: 'Güncellemeleri kontrol et',
    settings_label_whats_new_summary: "Yenilikleri AI ile özetle",
    settings_label_bot_name: 'Asistan Adı',
    settings_label_password: 'Erişim Parolası',
    settings_saved: 'Ayarlar kaydedildi',
    settings_save_failed: 'Kaydetme başarısız: ',
    settings_load_failed: 'Ayarlar yüklenemedi: ',
    settings_saved_pw: 'Ayarlar kaydedildi — parola koruması etkin ve bu tarayıcı oturumda kalacak',
    settings_saved_pw_updated: 'Ayarlar kaydedildi — parola güncellendi',
    // login page (used server-side via /api/i18n/login endpoint)
    login_title: 'Giriş yap',
    login_subtitle: 'Devam etmek için parolanızı girin',
    login_placeholder: 'Parola',
    login_btn: 'Giriş yap',
    login_invalid_pw: 'Geçersiz parola',
    login_conn_failed: 'Bağlantı başarısız',
    dialog_confirm_title: 'İşlemi onayla',
    dialog_prompt_title: 'Değer girin',
    dialog_confirm_btn: 'Onayla',
    discard: 'Vazgeç',
    ...
    kanban_work_queue_hint: 'Bu Hermes Agent iş kuyruğudur. Bir görev oluşturun veya sınıflandırın, atayın, Hazır durumuna getirin, ardından dağıtıcının almasına izin verin.',
    ...
    kanban_status_triage: 'Sınıflandırma',
    kanban_status_todo: 'Yapılacak',
    kanban_status_ready: 'Hazır',
    kanban_status_running: 'Çalışıyor',
    kanban_status_blocked: 'Engelli',
    kanban_status_done: 'Tamamlandı',
    kanban_comments_count: 'Yorumlar ({0})',
    kanban_events_count: 'Olaylar ({0})',
    kanban_links: 'Bağlantılar',
    kanban_parents: 'Üstler',
    kanban_children: 'Altlar',
    kanban_runs_count: 'Çalıştırmalar ({0})',
    kanban_no_comments: 'Yorum yok',
    kanban_no_events: 'Olay yok',
    kanban_no_runs: 'Çalıştırma yok',
    kanban_title: 'Başlık',
    kanban_description: 'Açıklama',
    kanban_description_placeholder: 'İsteğe bağlı — ne yapılması gerekiyor, kabul kriterleri, bağlantılar',
    kanban_status: 'Durum',
    kanban_assignee: 'Atanan',
    kanban_assignee_placeholder: 'İsteğe bağlı — herhangi bir çalışan için boş bırakın',
    kanban_tenant: 'Kiracı',
    kanban_tenant_placeholder: 'İsteğe bağlı — proje veya takım kısa adı',
    kanban_priority: 'Öncelik',
    kanban_priority_hint: 'Yüksek sayılar önce çalışır. Varsayılan 0.',
    kanban_title_required: 'Başlık zorunludur.',
    kanban_new_task: 'Yeni görev',
    kanban_edit_task: 'Görevi düzenle',
    kanban_status_original_hint: 'Gerçek durum: {0}. Bu iletişim kutusu yalnızca Sınıflandırma/Yapılacak/Hazır düzenlemelerini destekler.',
    kanban_run_dispatcher: 'Dağıtıcıyı çalıştır',
    kanban_run_dispatcher_confirm: 'Bu panodaki Hazır görevleri alacak ve çalışan alt süreçler başlatacak (görev başına bir, tıklama başına en fazla 8). Devam edilsin mi?',
    kanban_assignee_profiles_label: 'Hermes profilleri',
    kanban_assignee_other_label: 'Diğer (CLI kulvarları / kaldırılan profiller)',
    kanban_assignee_unassigned: '— Atanmamış (otomatik çalıştırılmaz) —',
    kanban_ready_needs_assignee: 'Atanmamış + Hazır seçtiniz. Dağıtıcı bu görevi atlayacak. Onaylamak için tekrar gönderin veya bir profil seçin.',
    kanban_dispatch_preview_prefix: 'Önizleme:',
    kanban_dispatch_run_prefix: 'Dağıtıldı:',
    kanban_dispatch_spawned: 'başlatıldı',
    kanban_dispatch_promoted: 'yükseltildi',
    kanban_dispatch_reclaimed: 'geri alındı',
    kanban_dispatch_skipped_unassigned: 'atlandı (atanmamış)',
    kanban_dispatch_skipped_nonspawnable: 'atlandı (bilinmeyen profil)',
    kanban_dispatch_auto_blocked: 'otomatik engellendi',
    kanban_dispatch_timed_out: 'zaman aşımı',
    kanban_dispatch_crashed: 'çöktü',
    kanban_add_comment: 'Yorum ekle',
    kanban_only_mine: 'Sadece benimkiler',
    kanban_bulk_action: 'Toplu işlem',
    kanban_nudge_dispatcher: 'Dağıtıcıyı önizle',
    kanban_stats: 'İstatistikler',
    kanban_worker_log: 'Çalışan günlüğü',
    kanban_block: 'Engelle',
    kanban_unblock: 'Engeli kaldır',
    kanban_back_to_board: 'Panoya dön',
    kanban_lanes_by_profile: 'Profile göre kulvarlar',
    kanban_new_board: 'Yeni pano…',
    kanban_rename_board: 'Mevcut panoyu yeniden adlandır…',
    kanban_archive_board: 'Mevcut panoyu arşivle…',
    kanban_archive_board_confirm: '"{name}" panosu arşivlensin mi? Görevler diskte kalır ve pano kanban/boards/_archived/ dizininden geri getirilebilir.',
    kanban_board_archived: 'Pano arşivlendi',
    kanban_board_name: 'Ad',
    kanban_board_slug: 'Kısa ad (küçük harf, tire)',
    ...
    kanban_board_name_required: 'Ad zorunludur',
    kanban_board_slug_required: 'Kısa ad zorunludur',
    kanban_card_complete: 'tamamlandı',
    kanban_card_archive: 'arşivle',
    kanban_unassigned: 'atanmamış',
    kanban_status_archived: 'Arşivlendi',
    tab_todos: 'Yapılacaklar',
    tab_insights: 'Analizler',
    tab_dashboard: 'Hermes Dashboard',
    dashboard_loopback_warning: 'Dashboard sunucuda yalnızca yerel döngü ile çalışır. Sunucunun kendisinden tarayın veya --host 0.0.0.0 (güvensiz) ile yeniden başlatın.',
    tab_logs: 'Günlükler',
    tab_settings: 'Ayarlar',
    new_conversation: 'Yeni konuşma',
    filter_conversations: 'Konuşmaları filtrele...',
    session_time_unknown: 'Bilinmiyor',
    session_time_minutes_ago: (n) => `${n}dk`,
    session_time_hours_ago: (n) => `${n}sa`,
    session_time_days_ago: (n) => `${n}g`,
    session_time_last_week: '1h',
    ...
    session_time_bucket_older: 'Daha eski',
    scheduled_jobs: 'Zamanlanmış işler',
    new_job: 'Yeni iş',
    loading: 'Yükleniyor...',
    search_skills: 'Becerileri ara...',
    new_skill: 'Yeni beceri',
    personal_memory: 'Kişisel bellek',
    current_task_list: 'Mevcut görev listesi',
    // Logs
    logs_title: 'Günlükler',
    logs_file: 'Dosya',
    logs_tail: 'Kuyruk',
    logs_auto_refresh: 'Otomatik yenile (5sn)',
    ...
    logs_status_idle: 'Son satırları görüntülemek için bir günlük dosyası seçin.',
    logs_no_mtime: 'henüz yazılmadı',
    logs_truncated_hint: 'Büyük bir günlük dosyasının kuyruğu gösteriliyor; belleği sınırlı tutmak için eski baytlar atlandı.',
    logs_copied: 'Günlükler kopyalandı',
    logs_severity: 'Önem',
    logs_severity_all: 'Tümü',
    logs_severity_errors: 'Hatalar',
    logs_severity_warnings: 'Uyarılar+',
    logs_filter_active: 'gösteriliyor (filtre aktif)',
    // Insights
    insights_title: 'Kullanım Analizi',
    insights_sessions: 'Oturumlar',
    insights_messages: 'Mesajlar',
    insights_tokens: 'Tokenlar',
    insights_cost: 'Tahmini Maliyet',
    insights_no_cost: 'Yok',
    insights_models: 'Modeller',
    insights_activity_by_day: 'Güne Göre Aktivite',
    insights_activity_by_hour: 'Saate Göre Aktivite',
    insights_peak_hour: 'Zirve: {hour}',
    insights_token_breakdown: 'Token Dağılımı',
    insights_input_tokens: 'Girdi',
    insights_output_tokens: 'Çıktı',
    insights_total: 'Toplam',
    insights_daily_tokens: 'Günlük Token',
    insights_model_name: 'Model',
    insights_model_sessions: 'Oturumlar',
    insights_model_tokens: 'Tokenlar',
    insights_model_cost: 'Maliyet',
    insights_model_share: 'Pay',
    ...
    session_meta_messages: (n) => `${n} msj`,
    session_meta_children: (n) => `${n} alt`,
    session_meta_segments: (n) => `${n} önceki tur`,
    session_lineage_segment_untitled: 'Başlıksız bölüm',
    session_lineage_segment_open: 'Soy bölümünü aç',
    ...
    settings_desc_sound: 'Asistan yanıtı tamamladığında bir ses çal.',
    // TTS (#499)
    tts_listen: 'Dinle',
    tts_not_supported: 'Bu tarayıcıda konuşma sentezi desteklenmiyor.',
    settings_label_tts: 'Yanıtlar için Metin-Konuşma',
    settings_desc_tts: "Her asistan mesajında, tarayıcınızın konuşma sentezini kullanarak sesli okumak için bir hoparlör düğmesi göster.",
    settings_label_tts_auto_read: 'Yanıtları otomatik sesli oku',
    settings_desc_tts_auto_read: 'Her yeni asistan yanıtı tamamlandığında otomatik olarak seslendir. Siz yazmaya başladığınızda duraklar.',
    // Composer voice-mode pref (#1488)
    settings_label_voice_mode: 'Eller serbest ses modu düğmesi',
    settings_desc_voice_mode: 'Dikte mikrofonunun yanında ses modu düğmesini (ses dalga formu) göster. Doğal konuşmanızı sağlar — Hermes bir duraklamadan sonra otomatik gönderir ve yanıtları sesli okur. Hem konuşma tanıma hem de TTS destekleyen bir tarayıcı gerektirir.',
    settings_label_tts_voice: 'Ses',
    settings_desc_tts_voice: "Tercih edilen ses. Tarayıcınızın mevcut seslerinden doldurulur.",
    ...
    settings_desc_notifications: 'Uygulama arka plandayken bir yanıt tamamlandığında sistem bildirimi göster.',
    settings_desc_token_usage: 'Her asistan yanıtının altında girdi/çıktı token sayısını gösterir. Ayrıca /usage ile de açılıp kapatılabilir.',
    settings_label_api_redact: 'API yanıtlarında hassas verileri gizle',
    settings_desc_api_redact: 'Kendi sunucusunda çalıştıran kullanıcılar şeffaflık için devre dışı bırakabilir (paylaşımlı örnekler için önerilmez).',
    settings_sidebar_density_compact: 'Sıkışık',
    settings_sidebar_density_detailed: 'Detaylı',
    settings_desc_sidebar_density: 'Sol kenar çubuğundaki oturum listesinde ne kadar üstveri gösterileceğini kontrol eder.',
    settings_label_auto_title_refresh: 'Uyarlanabilir başlık yenileme',
    settings_auto_title_refresh_off: 'Kapalı',
    settings_auto_title_refresh_5: 'Her 5 alışverişte',
    settings_auto_title_refresh_10: 'Her 10 alışverişte',
    settings_auto_title_refresh_20: 'Her 20 alışverişte',
    settings_desc_auto_title_refresh: 'Konuşma geliştikçe başlığı güncel tutmak için son alışverişe göre oturum başlığını otomatik olarak yeniden oluşturur. Bir LLM başlık oluşturma modelinin yapılandırılmış olmasını gerektirir.',
    settings_desc_external_sessions: 'CLI, Telegram, Discord, Slack ve diğer kanallardaki konuşmaları oturum listesinde göster. İçe aktarıp devam etmek için tıklayın.',
    settings_desc_sync_insights: 'WebUI token kullanımını state.db ile eşler, böylece hermes /insights tarayıcı oturum verilerini de içerir. Varsayılan olarak kapalıdır.',
    settings_desc_check_updates: 'WebUI veya Agent\'ın daha yeni sürümleri mevcut olduğunda bir başlık göster. Periyodik olarak arka planda git fetch çalıştırır.',
    settings_desc_whats_new_summary: "Yenilikler eylemini, ham diff\'i açmak yerine önce kısa, insanca okunabilir bir özet oluşturacak şekilde değiştirir. Normal diff karşılaştırması özetten sonra kullanılabilir.",
    settings_desc_bot_name: 'Asistan için kullanıcı arayüzü genelinde gösterilecek ad. Varsayılan Hermes.',
    settings_desc_password: 'Ayarlamak veya değiştirmek için yeni bir parola girin. Mevcut ayarı korumak için boş bırakın.',
    password_placeholder: 'Yeni parola girin…',
    password_env_var_locked: 'HERMES_WEBUI_PASSWORD ortam değişkeni şu anda ayarlı ve öncelikli. Buradan parola yönetmek için değişkeni kaldırıp sunucuyu yeniden başlatın.',
    password_env_var_locked_placeholder: 'Kilitli: HERMES_WEBUI_PASSWORD ortam değişkeni ayarlı',
    disable_auth: 'Kimlik Doğrulamayı Kapat',
    sign_out: 'Çıkış Yap',
    // Providers panel
    providers_tab_title: 'Sağlayıcılar',
    providers_section_title: 'Sağlayıcılar',
    providers_section_meta: 'AI sağlayıcıları için API anahtarlarını yönetin. Değişiklikler hemen etkili olur.',
    ...
    providers_oauth_hint: 'OAuth ile kimlik doğrulandı. API anahtarı gerekmez.',
    providers_oauth_config_yaml_hint: 'Token config.yaml aracılığıyla yapılandırıldı. Güncellemek için config.yaml içindeki sağlayıcılar bölümünü düzenleyin veya hermes auth çalıştırın.',
    providers_oauth_not_configured_hint: 'Kimlik doğrulanmadı. Bu sağlayıcıyı yapılandırmak için terminalde hermes auth çalıştırın.',
    providers_save: 'Kaydet',
    providers_remove: 'Kaldır',
    ...
    providers_key_placeholder_new: 'sk-...',
    providers_key_placeholder_replace: 'Değiştirmek için yeni anahtar girin…',
    provider_quota_title: 'Aktif sağlayıcı kotası',
    provider_quota_active_provider: 'Aktif sağlayıcı',
    provider_quota_last_checked_after_refresh: 'Yenilemeden sonra son kontrol',
    provider_quota_last_checked: 'Son kontrol {0}',
    provider_quota_refresh_usage: 'Kullanımı yenile',
    provider_quota_refreshing: 'Yenileniyor...',
    provider_quota_refresh_title: 'Sağlayıcı kullanım limitlerini şimdi yenile',
    provider_quota_refresh_succeeded: 'Sağlayıcı kullanımı yenilendi',
    provider_quota_refresh_failed: 'Sağlayıcı kullanımı yenileme başarısız',
    provider_quota_session_limit: '5 saatlik limit',
    provider_quota_weekly_limit: 'Haftalık limit',
    provider_quota_window_fallback: 'Pencere',
    provider_quota_metric_remaining: 'Kalan',
    provider_quota_metric_used: 'Kullanılan',
    provider_quota_metric_limit: 'Limit',
    provider_quota_status_available: 'kullanılabilir',
    provider_quota_status_exhausted: 'tükendi',
    provider_quota_status_unavailable: 'kullanılamıyor',
    provider_quota_status_failed: 'başarısız',
    ...
    provider_quota_status_unsupported: 'desteklenmiyor',
    provider_quota_used_meta: '{0} kullanıldı',
    provider_quota_resets_meta: '{0} sıfırlanır',
    provider_quota_credential_pool: 'Kimlik havuzu',
    provider_quota_credential_label: 'Kimlik {0}',
    provider_quota_pool_plans: 'Planlar: {0}',
    provider_quota_pool_no_windows: 'Hesap limiti penceresi bildirilmedi.',
    provider_quota_account_limits_loaded: 'Hesap limitleri yüklendi.',
    provider_quota_unavailable: 'Kota durumu kullanılamıyor',
    provider_quota_retry_after: '{0} sonra tekrar dene',
    provider_quota_pool_summary_available: '{0}/{1} kullanılabilir',
    provider_quota_pool_summary_exhausted: '{0} tükendi',
    provider_quota_pool_summary_failed: '{0} başarısız',
    provider_quota_pool_summary_checked: '{0} kontrol edildi',
    cancel: 'İptal',
    create_job: 'İş oluştur',
    save_skill: 'Beceriyi kaydet',
    editing: 'Düzenleniyor',
    // Empty state
    empty_title: 'Nasıl yardımcı olabilirim?',
    empty_subtitle: 'Bir şey sorun, komut çalıştırın, dosyaları keşfedin veya zamanlanmış işlerinizi yönetin.',
    suggest_files: 'Bu çalışma alanında hangi dosyalar var?',
    suggest_schedule: 'Bugünkü programımda neler var?',
    suggest_plan: 'Küçük bir proje planlamama yardım et.',
    // onboarding
    onboarding_badge: 'İLK ÇALIŞTIRMA',
    onboarding_title: 'Hermes Web UI\'a Hoş Geldiniz',
    onboarding_lead: 'Hızlı bir kurulum Hermes\'i doğrulayacak, gerçek bir sağlayıcı yapılandırması kaydedecek, bir çalışma alanı ve model seçecek ve isteğe bağlı olarak uygulamayı bir parola ile koruyacak.',
    ...
    onboarding_step_system_desc: 'Hermes Agent ve yapılandırma görünürlüğünü doğrulayın.',
    ...
    onboarding_step_workspace_title: 'Çalışma alanı + model',
    onboarding_step_workspace_desc: 'Yeni oturumlar ve sohbet için varsayılanları seçin.',
    onboarding_step_password_title: 'İsteğe bağlı parola',
    onboarding_step_password_desc: 'Paylaşmadan önce Web UI\'ı koruyun.',
    onboarding_step_finish_title: 'Bitir',
    onboarding_step_finish_desc: 'Gözden geçirin ve uygulamaya girin.',
    onboarding_notice_system_ready: 'Hermes Agent Web UI\'dan erişilebilir görünüyor.',
    onboarding_notice_system_unavailable: 'Hermes Agent henüz tam olarak kullanılabilir değil. Bootstrap yükleyebilir, ancak sağlayıcı kurulumu yine de terminal gerektirebilir.',
    onboarding_check_agent: 'Hermes Agent',
    onboarding_check_agent_ready: 'Algılandı ve içe aktarılabilir',
    onboarding_check_agent_missing: 'Eksik veya kısmen içe aktarılabilir',
    onboarding_check_password: 'Parola',
    onboarding_check_password_enabled: 'Zaten etkin',
    onboarding_check_password_disabled: 'Henüz etkin değil',
    ...
    onboarding_notice_setup_required: 'Burada basit bir sağlayıcı yolu seçin. Gelişmiş OAuth akışları şimdilik Hermes CLI\'a aittir.',
    onboarding_notice_setup_already_ready: 'Çalışan bir Hermes sağlayıcı kurulumu zaten algılandı. Burada tutabilir veya değiştirebilirsiniz.',
    onboarding_oauth_provider_ready_title: 'Sağlayıcı zaten kimlik doğruladı',
    onboarding_oauth_provider_ready_body: 'Bu örnek, Hermes CLI aracılığıyla kurulmuş bir OAuth sağlayıcısı (<strong>{provider}</strong>) kullanacak şekilde yapılandırılmış. Burada API anahtarı gerekmez — kurulumu tamamlamak için Devam\'a tıklayın.',
    onboarding_oauth_provider_not_ready_title: 'OAuth sağlayıcısı henüz kimlik doğrulamadı',
    onboarding_oauth_provider_not_ready_body: 'Bu örnek, API anahtarı yerine OAuth kullanan <strong>{provider}</strong> kullanacak şekilde yapılandırılmış. Kimlik doğrulamak için terminalde <code>hermes auth</code> veya <code>hermes model</code> çalıştırın, ardından Web UI\'ı yeniden yükleyin.',
    onboarding_oauth_switch_hint: 'Veya API anahtarı kurulumuna geçmek için aşağıdan farklı bir sağlayıcı seçin:',
    oauth_login_codex: 'Codex ile giriş yap (ChatGPT)',
    ...
    onboarding_notice_workspace: 'Bu değerler normal uygulama ile aynı ayar API\'lerini kullanır.',
    onboarding_workspace_label: 'Çalışma alanı',
    onboarding_workspace_or_path: 'Veya bir çalışma alanı yolu girin',
    onboarding_workspace_placeholder: '/home/kullanici/calisma-alani',
    ...
    provider_category_self_hosted: 'Açık / self-hosted',
    provider_category_specialized: 'Özelleşmiş',
    ...
    onboarding_api_key_help_keyless: 'Çoğu LM Studio / Ollama / vLLM kurulumu anahtarsız çalışır — sunucunuz kimlik doğrulama gerektirmiyorsa boş bırakın. Doğrulamak için Bağlantıyı test et düğmesini kullanın.',
    onboarding_api_key_help_prefix: 'Hermes .env dosyanıza şu kullanılarak gizli olarak kaydedilir:',
    onboarding_base_url_label: 'Temel URL',
    onboarding_base_url_placeholder: 'https://sunucu-adresiniz.example/v1',
    onboarding_base_url_help: 'OpenAI uyumlu yönlendiriciler, self-hosted sunucular, LiteLLM, Ollama, LM Studio, vLLM veya benzer uç noktalar için kullanın.',
    ...
    onboarding_custom_model_placeholder: 'model-adiniz',
    onboarding_custom_model_help: 'Özel uç noktalar için sunucunuzun beklediği tam model kimliğini girin.',
    onboarding_notice_password_enabled: 'Bir parola zaten yapılandırılmış. Yalnızca değiştirmek istiyorsanız yeni bir tane girin.',
    onboarding_notice_password_recommended: 'UI\'ı localhost dışına açacaksanız isteğe bağlı ancak önerilir.',
    onboarding_password_label: 'Parola (isteğe bağlı)',
    onboarding_password_placeholder: 'Atlamak için boş bırakın',
    onboarding_password_help: 'Parolalar mevcut ayarlar API\'si aracılığıyla saklanır ve sunucu tarafında hashlenir.',
    onboarding_notice_finish: 'Bunlardan herhangi birini daha sonra değiştirmek için Ayarlar\'ı tekrar açabilirsiniz.',
    ...
    onboarding_password_keep_existing: 'Mevcut parolayı koru',
    onboarding_password_remains_disabled: 'Devre dışı kalacak',
    onboarding_password_skipped: 'Şimdilik atlandı',
    onboarding_finish_help: 'Bitirmek, ayarlarda <code>onboarding_completed</code> değerini saklar ve sizi normal uygulamaya bırakır.',
    ...
    onboarding_error_base_url_required: 'Özel uç noktalar için Temel URL zorunludur.',
    ...
    onboarding_probe_error_generic: 'Yapılandırılan temel URL\'ye erişilemedi.',
    onboarding_probe_error_invalid_url: 'Temel URL http:// veya https:// ile başlamalıdır.',
    onboarding_probe_error_dns: 'Ana bilgisayar çözümlenemedi. URL\'yi kontrol edin veya ana bilgisayarın IP adresini kullanın.',
    onboarding_probe_error_connect_refused: 'Bağlantı reddedildi — sunucu o adreste çalışmıyor olabilir. Docker içinden, localhost yerine ana bilgisayar IP\'sini deneyin.',
    ...
    onboarding_probe_error_http_4xx: 'Uç nokta bir istemci hatası döndürdü. Kimlik doğrulamayı ve URL yolunu kontrol edin (genellikle /v1 ile biter).',
    onboarding_probe_error_http_5xx: 'Uç nokta bir sunucu hatası döndürdü. LM Studio / Ollama sunucu günlüklerini kontrol edin.',
    onboarding_probe_error_parse: 'Uç nokta beklenen şekilde bir model listesi döndürmedi. URL\'nin OpenAI uyumlu API köküne işaret ettiğini doğrulayın.',
    onboarding_probe_error_unreachable: 'Yapılandırılan temel URL\'ye erişilemedi.',
    onboarding_error_probe_failed: 'Yapılandırılan temel URL doğrulanamadı.',
    onboarding_error_workspace_required: 'Çalışma alanı zorunludur.',
    onboarding_error_model_required: 'Model zorunludur.',
    onboarding_complete: 'Kurulum tamamlandı',
    // panel/runtime i18n
    error_prefix: 'Hata: ',
    not_available: 'Yok',
    never: 'hiç',
    ...
    switch_failed: 'Değiştirme başarısız: ',
    name_required: 'Ad zorunludur',
    content_required: 'İçerik zorunludur',
    view: 'Görüntüle',
    dismiss: 'Kapat',
    disable: 'Devre dışı bırak',
    cron_no_jobs: 'Zamanlanmış iş bulunamadı.',
    cron_status_off: 'kapalı',
    cron_status_paused: 'duraklatıldı',
    cron_status_error: 'hata',
    cron_status_active: 'aktif',
    cron_status_running: 'çalışıyor\u2026',
    cron_status_needs_attention: 'dikkat gerekiyor',
    cron_attention_desc: 'Bu yinelenen işin bir sonraki çalışma zamanı yok. Zamanlayıcı bir sonraki çalışmayı hesaplayamamış olabilir.',
    cron_attention_croniter_hint: 'Gateway çalışma zamanında croniter paketi eksik olabilir. Gateway\'i cron desteğiyle yeniden başlatın, ardından bu işi sürdürün.',
    cron_attention_resume: 'Sürdür ve yeniden hesapla',
    cron_jobs_project: 'Cron İşleri',
    cron_attention_run_once: 'Şimdi bir kez çalıştır',
    cron_attention_copy_diagnostics: 'Tanılamayı kopyala',
    cron_diagnostics_copied: 'Cron tanılaması kopyalandı',
    cron_next: 'Sonraki',
    cron_last: 'Son',
    cron_run_now: 'Şimdi çalıştır',
    cron_pause: 'Duraklat',
    cron_resume: 'Sürdür',
    cron_job_name_placeholder: 'İş adı',
    cron_schedule_placeholder: 'Zamanlama',
    cron_prompt_placeholder: 'İstem',
    cron_last_output: 'Son çıktı',
    cron_all_runs: 'Tüm çalıştırmalar',
    cron_hide_runs: 'Çalıştırmaları gizle',
    cron_no_runs_yet: '(henüz çalıştırma yok)',
    cron_schedule_required_example: 'Zamanlama zorunludur (örn. "0 9 * * *" veya "every 1h")',
    cron_schedule_required: 'Zamanlama zorunludur',
    cron_prompt_required: 'İstem zorunludur',
    cron_job_created: 'İş oluşturuldu',
    cron_duplicate: 'Çoğalt',
    cron_duplicated: 'İş çoğaltıldı (duraklatıldı)',
    cron_job_triggered: 'İş tetiklendi',
    cron_job_paused: 'İş duraklatıldı',
    cron_job_resumed: 'İş sürdürüldü',
    cron_job_updated: 'İş güncellendi',
    cron_delete_confirm_title: 'Cron işini sil',
    cron_delete_confirm_message: 'Bu işlem geri alınamaz.',
    ...
    cron_deliver_telegram: 'Telegram',
    cron_deliver_discord: 'Discord',
    cron_deliver_origin: 'Kaynak (aynı sohbet)',
    cron_profile_label: 'Profil',
    cron_profile_server_default: 'sunucu varsayılanı',
    cron_profile_server_default_hint: 'Çalışma zamanında WebUI sunucu varsayılan profilini kullanır. Profili olmayan mevcut işler bu eski davranışı korur.',
    cron_toast_notifications_label: 'Tamamlanma bildirimleri',
    cron_toast_notifications_hint: 'Bu cron tamamlandığında bir bildirim göster. Görevler rozeti ve yeni çalıştırma işaretçisi bu kapalıyken de güncellenir.',
    cron_toast_notifications_enabled: 'Etkin',
    cron_toast_notifications_disabled: 'Devre dışı',
    cron_skills_label: 'Beceriler',
    cron_skills_placeholder: 'Beceri ekle (isteğe bağlı)…',
    cron_skills_edit_hint: 'Beceri listesi oluşturulduktan sonra düzenlenemez.',
    // workspace form
    workspace_name_label: 'Ad',
    workspace_name_placeholder: 'İsteğe bağlı dost ad',
    workspace_path_label: 'Yol',
    workspace_path_required: 'Yol zorunludur',
    workspace_path_readonly: 'Yol değiştirilemez. Yalnızca yeniden adlandırın.',
    workspace_new_title: 'Yeni alan',
    workspace_add_title: 'Çalışma alanı ekle',
    workspace_rename_title: 'Alanı yeniden adlandır',
    // profile form
    profile_name_label: 'Ad',
    profile_base_url_label: 'Temel URL',
    profile_api_key_label: 'API anahtarı',
    profile_name_required: 'Ad zorunludur',
    profile_model_required: 'Model zorunludur',
    profile_provider_label: 'Sağlayıcı',
    profile_already_exists: 'Profil zaten mevcut',
    profile_create_failed: 'Profil oluşturulamadı: ',
    profile_delete_confirm: (name) => `"${name}" profili silinsin mi?`,
    profile_delete_failed: 'Profil silinemedi: ',
    profile_update_failed: 'Profil güncellenemedi: ',
    // cron form
    cron_name_label: 'Ad',
    cron_name_placeholder: 'İsteğe bağlı',
    cron_schedule_label: 'Zamanlama',
    cron_schedule_hint: "Yinelenen işler için 'every 1h' veya cron ifadesi kullanın. '30m' gibi salt süreler bir kez çalışır.",
    cron_schedule_once_warning: "'30m' gibi süre biçimleri bir kez çalışır ve çalıştıktan sonra kaldırılır. Yinelenen bir iş tutmak için 'every 30m' kullanın.",
    cron_prompt_label: 'İstem',
    cmd_yolo: 'YOLO modunu aç/kapat (onayları atla)',
    cmd_help: 'Kullanılabilir komutları göster',
    cmd_compact: 'Sohbet bağlamını sıkıştır',
    yolo_no_session: 'Aktif oturum yok',
    yolo_enabled: '⚡ YOLO modu AÇIK — bu oturumda onaylar atlandı',
    yolo_disabled: 'YOLO modu KAPALI',
    yolo_pill_label: 'YOLO',
    yolo_pill_title_active: 'YOLO modu aktif — devre dışı bırakmak için tıklayın',
    approval_skip_all: '⚡ Bu oturumda tümünü atla',
    approval_skip_all_title: 'Bu oturum için tüm onay istemlerini atla',
    approval_skip: 'Atla',
    approval_skip_title: 'Bu onay istemini atla',
    // composer action tooltips
    composer_send: 'Mesaj gönder',
    composer_queue: 'Mesajı sıraya al',
    composer_interrupt: 'Kes ve gönder',
    composer_steer: 'Mevcut yanıtı yönlendir',
    composer_stop: 'Oluşturmayı durdur',
    composer_disabled_clarify: 'Açıklama talebine yanıt verin',
    ...
    composer_mobile_model: 'Model',
    composer_mobile_reasoning: 'Akıl Yürütme',
    composer_mobile_context: 'Bağlam',
    media_audio_label: 'Ses',
    media_svg_label: 'Diyagram',
    media_video_label: 'Video',
    csv_loading: 'CSV yükleniyor',
    csv_too_large: 'CSV dosyası satır içi gösterim için çok büyük',
    csv_no_data: 'CSV dosyası tablo olarak gösterilecek yeterli veriye sahip değil',
    csv_error: 'CSV dosyası yüklenemedi',
    csv_header_note: 'İlk satır tablo başlığı olarak gösterilir',
    excalidraw_loading: 'Diyagram yükleniyor',
    excalidraw_too_large: 'Excalidraw dosyası satır içi gösterim için çok büyük',
    ...
    excalidraw_download: 'İndir',
    excalidraw_empty: 'Boş diyagram',
    excalidraw_render_error: 'Diyagram oluşturulamadı',
    excalidraw_simplified: 'Basitleştirilmiş SVG önizleme — Excalidraw tuvaliyle piksel olarak aynı değil',
    // ── Checkpoints / Rollback ──
    ...
    checkpoint_view_diff: 'Diff\'i görüntüle',
    checkpoint_restore: 'Geri yükle',
    checkpoint_restore_confirm_title: 'Kontrol noktası geri yüklensin mi?',
    checkpoint_restore_confirm_message: (ckpt) => `Çalışma alanı "${ckpt}" kontrol noktasına geri yüklensin mi? Bu işlem dosyaları kaydedilmiş sürümlerle değiştirecek. Bu kontrol noktasından sonra eklenen dosyalar silinmeyecek.`,
    ...
    active_conversation_meta: (title, count) => `${title} · ${count} mesaj`,
    active_conversation_none: 'Aktif konuşma seçilmedi.',
    agent_soul: 'Ajan Ruhu',
    auth_disabled: 'Kimlik doğrulama kapatıldı — parola koruması kaldırıldı',
    bg_error_multi: (count) => `${count} oturum hata ile karşılaştı`,
    bg_error_single: (title) => `"${title}" bir hata ile karşılaştı`,
    clear_conversation_btn_tooltip: 'Bu konuşmadaki tüm mesajları temizle',
    clear_conversation_message: 'Tüm mesajlar silinsin mi? Bu işlem geri alınamaz.',
    clear_conversation_title: 'Konuşmayı temizle',
    ...
    disable_auth_confirm_title: 'Parola korumasını kapat',
    disable_auth_failed: 'Kimlik doğrulama kapatılamadı: ',
    discard_file_edits_message: 'Çalışma alanı değiştirmek önizlemedeki kaydedilmemiş dosya düzenlemelerini silecek.',
    discard_file_edits_title: 'Dosya düzenlemeleri silinsin mi?',
    export_session_json: 'JSON',
    export_session_json_tooltip: 'Oturumu JSON olarak dışa aktar',
    import_session_json_tooltip: "JSON'dan oturum içe aktar",
    jump_to_question: 'soruya git',
    jump_to_question_label: 'Bu yanıtın sorusuna atla',
    linked_files: 'Bağlı Dosyalar',
    manage_profiles: 'Profilleri yönet',
    memory_notes_label: 'bellek (notlar)',
    memory_saved: 'Bellek kaydedildi',
    my_notes: 'Notlarım',
    new_session_creating: 'Yeni konuşma oluşturuluyor…',
    no_notes_yet: 'Henüz not yok.',
    no_profile_yet: 'Henüz profil yok.',
    no_soul_yet: 'Henüz ruh tanımlanmadı.',
    plugins_disabled: 'Devre dışı',
    plugins_enabled: 'Etkin',
    plugins_load_failed: 'Eklentiler yüklenemedi: ',
    plugins_no_description: 'Açıklama sağlanmadı.',
    ...
    profile_base_url_placeholder: 'Temel URL (isteğe bağlı, örn. http://localhost:11434)',
    profile_base_url_rule: 'Temel URL http:// veya https:// ile başlamalıdır',
    profile_clone_label: 'Aktif profilden yapılandırmayı klonla',
    profile_created: (name) => `Profil oluşturuldu: ${name}`,
    profile_default_label: '(varsayılan)',
    profile_delete_confirm_message: 'Bu profil için tüm oturumlar, yapılandırma, beceriler ve bellek kalıcı olarak silinecek. Bu işlem geri alınamaz.',
    ...
    profile_gateway_running: 'Gateway çalışıyor',
    profile_gateway_stopped: 'Gateway durdu',
    profile_model_hint: 'Bu yeni profil için yapılandırılmış sağlayıcı ve modellerden seçin.',
    profile_model_label: 'Model / sağlayıcı',
    profile_model_use_default: 'Aktif profil varsayılanını kullan',
    profile_name_placeholder: 'Profil adı (küçük harf, a-z 0-9 tire)',
    profile_name_rule: 'Yalnızca küçük harf, rakam, tire, alt çizgi',
    profile_no_configuration: 'Yapılandırma yok',
    profile_skill_count: (count) => `${count} beceri`,
    profile_switch_title: 'Bu profile geç',
    profile_switched: (name) => `Profile geçildi: ${name}`,
    profile_switched_new_conversation: (name) => `Profile geçildi: ${name} — yeni konuşma başlatıldı`,
    profile_use: 'Kullan',
    profiles_empty_sub: 'Ayarlarını görüntülemek ve düzenlemek için kenar çubuğundan bir ajan profili seçin veya yeni bir tane oluşturun.',
    profiles_empty_title: 'Profil seçin',
    profiles_load_failed: 'Profiller yüklenemedi',
    profiles_no_profiles: 'Profil bulunamadı.',
    selected_text_reply: 'Seçimle yanıtla',
    selected_text_reply_appended: 'Seçilen metin oluşturucuya eklendi',
    selected_text_reply_title: 'Seçilen sohbet metnini alıntı bağlamı olarak ekle',
    session_hidden: 'Oturum listeden gizlendi',
    session_hide_external: 'Listeden gizle',
    session_hide_external_desc: "Bu içe aktarılan oturumu kaynak geçmişini silmeden WebUI'dan gizle.",
    settings_desc_previous_messaging_sessions: 'Daha yeni bir Hermes sürümüne yükseltme ile değiştirilen eski Discord, Telegram, Slack ve Weixin oturumlarını göster.',
    settings_desc_quota_chip: 'Oluşturucu alt bilgisinde ortam kalan kota göstergesini (örn. OpenRouter kredi bakiyesi) görüntüler.',
    settings_desc_rtl: 'Arapça, İbranice gibi diller için sohbet mesajlarının ve oluşturucu girişinin hizalamasını çevirir.',
    settings_label_previous_messaging_sessions: 'Önceki mesajlaşma oturumlarını göster',
    settings_label_quota_chip: 'Oluşturucuda sağlayıcı kota çipini göster',
    settings_label_rtl: 'Sağdan sola sohbet düzeni',
    settings_plugins_empty: "Şu anda hiçbir Hermes eklentisi görünmüyor. Hermes CLI'dan eklenti yükleyin veya etkinleştirin.",
    settings_plugins_meta: 'Yüklü Hermes eklentilerini ve kaydettikleri yaşam döngüsü kancalarını görüntüleyin.',
    settings_plugins_title: 'Eklentiler',
    settings_tab_plugins: 'Eklentiler',
    settings_unsaved_changes: 'Kaydedilmemiş değişiklikler var.',
    sign_out_failed: 'Çıkış başarısız: ',
    skill_category: 'Kategori',
    skill_category_placeholder: 'İsteğe bağlı, örn. devops',
    skill_content: 'SKILL.md içeriği',
    skill_content_placeholder: 'YAML ön madde + markdown gövde',
    ...
    skill_metadata: 'Üstveri',
    skill_name: 'Ad',
    skill_name_required: 'Beceri adı zorunludur',
    skill_rename_not_supported: 'Beceriyi yeniden adlandırma desteklenmez. Yeni bir beceri oluşturup eskisini silin.',
    skill_updated: 'Beceri güncellendi',
    skills_back_to: "{0}'a geri dön",
    skills_delete: 'Sil',
    skills_edit: 'Düzenle',
    skills_empty_sub: 'İçeriğini görüntülemek için kenar çubuğundan bir beceri seçin veya yeni bir tane oluşturun.',
    skills_empty_title: 'Beceri seçin',
    skills_no_match: 'Eşleşen beceri yok.',
    status_completed: 'tamamlandı',
    status_failed: 'başarısız',
    tasks_empty_sub: 'Detaylarını ve çalıştırmalarını görüntülemek için kenar çubuğundan bir iş seçin veya yeni bir tane oluşturun.',
    tasks_empty_title: 'Zamanlanmış iş seçin',
    todos_no_active: 'Bu oturumda aktif görev listesi yok.',
    user_profile: 'Kullanıcı Profili',
    workspace_add_path_placeholder: 'Çalışma alanı yolu ekle (örn. /home/user/my-project)',
    workspace_added: 'Çalışma alanı eklendi',
    workspace_already_saved: 'Çalışma alanı zaten kayıtlı — listeden seçin',
    workspace_busy_switch: 'Ajan çalışırken çalışma alanı değiştirilemez',
    workspace_choose_path: 'Çalışma alanı yolu seçin',
    workspace_choose_path_meta: 'Doğrulanmış bir yol ekleyin ve bu konuşmayı değiştirin',
    workspace_drag_hint: 'Yeniden sıralamak için sürükleyin',
    workspace_manage: 'Çalışma alanlarını yönet',
    workspace_manage_meta: 'Alanlar panelini aç',
    workspace_not_added: 'Çalışma alanı eklenmedi',
    workspace_paths_validated_hint: 'Yollar kaydedilmeden önce mevcut dizin olarak doğrulanır.',
    ...
    workspace_reorder_failed: 'Yeniden sıralama başarısız',
    workspace_switch_prompt_confirm: 'Değiştir',
    workspace_switch_prompt_message: 'Ekleyip bu konuşmayı değiştirmek için mutlak bir çalışma alanı yolu girin.',
    workspace_switch_prompt_placeholder: '/Users/kullanici/proje',
    workspace_switch_prompt_title: 'Çalışma alanını değiştir',
    workspace_switched_to: (name) => `${name} alanına geçildi`,
    workspace_use: 'Kullan',
