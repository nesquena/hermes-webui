...
const LOCALES = {
  ...
  folder_add_as_space_title: 'Add as Space?',
    ...
    workspace_busy_switch: 'Cannot move this chat while its agent is running',
    workspace_action_new_chat: 'New chat',
    workspace_action_move_chat: 'Move chat',
    workspace_action_set_default: 'Use for new chats',
    workspace_action_show_sessions: 'Show chats',
    workspace_new_chat_in: (name) => `New chat in ${name}`,
    workspace_moved_to: (name) => `Moved chat to ${name}`,
    workspace_default_set: (name) => `New chats will use ${name}`,
    workspace_sessions_filtered: (name) => `Showing chats in ${name}`,
    workspace_filter_label: 'Workspace',
    workspace_filter_clear: 'Clear',
