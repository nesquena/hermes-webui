...
const LOCALES = {
  en: {
    ...
    cmd_theme: 'Switch appearance (theme: system/dark/light/hermesos-light, skin: default/ares/mono/slate/poseidon/sisyphus/charizard)',
  ...
  folder_add_as_space_title: 'Add as Space?',
    ...
    settings_section_preferences_meta: 'Defaults and UI behavior for HermesOS.',
    ...
    onboarding_title: 'Welcome to HermesOS',
  ...
  folder_add_as_space_title: 'スペースとして追加?',
    ...
    settings_section_preferences_meta: 'HermesOS のデフォルトと UI 動作。',
  ...
  folder_add_as_space_title: '¿Añadir como espacio?',
    ...
    onboarding_title: 'Bienvenido a HermesOS',
  ...
  folder_add_as_space_title: '添加为工作区？',
    ...
    sidebar_collapse_title: '隐藏聊天列表',
    sidebar_expand_title: '显示聊天列表',
    settings_label_default_profile_label: '默认配置档昵称',
    settings_desc_default_profile_label: '在界面中显示内置 "default" 配置档的标签（输入框芯片、配置档选择器）。底层名称仍为 "default"，只改变显示效果。留空则显示 "default"。',
    providers_authenticate: '认证',
    providers_reauthenticate: '重新认证',
    providers_refresh_models: '刷新模型',
    providers_refreshing: '刷新中…',
    providers_models_refreshed: '模型已刷新',
    providers_models_refresh_empty: '请先添加 API 密钥 — 提供商拒绝了未认证请求',
    voice_section_title: '语音 / 转写',
    voice_section_desc: '麦克风按钮使用的语音转文字提供商。本地模式免费但小型 VM 上较慢；Groq 是最快的云端选项。',
    voice_provider_label: '转写提供商',
    voice_model_label: '模型',
    voice_key_label: 'API 密钥',
    voice_saved: '语音设置已保存',
    ...
    settings_section_preferences_meta: 'HermesOS 的默认和 UI 行为。',
  ...
  folder_add_as_space_title: '\u65b0\u589e\u70ba\u5de5\u4f5c\u5340\uff1f',
    ...
    settings_section_preferences_meta: 'HermesOS 的預設值與介面行為。',
    ...
    onboarding_title: '\u6b61\u8fce\u4f7f\u7528 HermesOS',
    onboarding_unknown: '\u672a\u77e5',
  ...
  pt: {
    ...
    settings_section_preferences_meta: 'Padrões e comportamento UI do HermesOS.',
    settings_section_system_title: 'Sistema',
    ...
    onboarding_title: 'Bem-vindo ao HermesOS',
  ...
  ko: {
    ...
    settings_section_preferences_meta: 'HermesOS의 기본값과 UI 동작.',
