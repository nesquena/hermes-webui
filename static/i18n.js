...
const LOCALES = {
  en: {
    ...
    onboarding_lead: 'A quick guided setup will check your Hermes install, choose a workspace and model, and optionally protect the app with a password.',
    ...
    onboarding_step_workspace_desc: 'Pick defaults for new sessions.',
    ...
    onboarding_check_provider_ready: 'Config detected',
    ...
    onboarding_workspace_help: 'If provider readiness is uncertain, choose the model you expect to use and finish any remaining login/API-key setup later with <code>hermes model</code>.',
  ...
  es: {
    ...
    onboarding_lead: 'Una guía rápida comprobará tu instalación de Hermes, elegirá un espacio de trabajo y un modelo, y opcionalmente protegerá la app con una contraseña.',
    ...
    onboarding_step_workspace_desc: 'Elige los valores predeterminados para las nuevas sesiones.',
    ...
    onboarding_check_provider_ready: 'Configuración detectada',
    ...
    onboarding_workspace_help: 'Si no está claro si el proveedor está listo, elige el modelo que esperas usar y termina cualquier inicio de sesión o configuración de API key más tarde con <code>hermes model</code>.',
