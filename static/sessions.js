...
async function newSession(flash, options={}){
  ...
  _newSessionInFlight=(async()=>{
    ...
    S.session=data.session;if(typeof invalidatePreviewRawContent==='function') invalidatePreviewRawContent();if(typeof _adoptRegenerationRevision==='function') _adoptRegenerationRevision(data.session);S.messages=data.session.messages||[];
