// i18n bundle: zh (AST-split from i18n.js).
(window.__I18N=window.__I18N||{})["zh"] = {
    offline_title: '连接已断开',
    ...
    steer_fail_no_cached_agent: '此会话无缓存代理 — 请尝试刷新',
  ...
  folder_add_as_space_title: '添加为工作区？',
    ...
    settings_aux_task_session_search: '会话搜索',
    settings_aux_task_session_search_desc: '历史对话召回',
    ...
    settings_desc_chat_activity_display_mode: '紧凑的工作日志将支持活动归纳为简洁摘要。透明流模式则将每个思考/工具使用事件按时间顺序单独列为可展开的行。',
