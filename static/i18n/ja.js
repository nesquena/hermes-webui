// i18n bundle: ja (AST-split from i18n.js).
(window.__I18N=window.__I18N||{})["ja"] = {
  ...
  folder_add_as_space_title: 'スペースとして追加?',
    ...
    settings_aux_task_session_search: 'セッション検索',
    settings_aux_task_session_search_desc: '過去の会話の呼び出し',
