    ...
    *,
    ...
    try:
        ...
        try:
            ...
            # A browser-supplied value belongs to this run and must not be
            # replaced by a concurrent profile write. Turns without an explicit
            # value retain CLI parity by falling back to agent.reasoning_effort.
            try:
