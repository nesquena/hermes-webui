...
CLAUDE_MANAGED_POST_EXEC_HANDOFF_TIMEOUT_SECONDS = 2.0
CLAUDE_MANAGED_POST_EXEC_CONFIRM_DELAY_SECONDS = 0.1
# One pre-exec probe, two post-exec probes, the handoff bound, the confirm
# delay, and one second for process scheduling and readiness delivery.
CLAUDE_MANAGED_LAUNCH_TIMEOUT_SECONDS = (
    3 * CLAUDE_AGENTS_TIMEOUT_SECONDS
