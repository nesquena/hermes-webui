...
def get_available_models() -> dict:
    ...
    def _build_available_models_uncached() -> dict:
        ...
        # Disabled: auto-detection from auth store can show providers the user didn't configure.
        # Only use active_provider from config.yaml.
        # auth_store = {}
        # try:
        ...
        # Disabled: only use providers explicitly configured in config.yaml.
        # Auto-detection from env vars and hermes_cli has been disabled
        ...
        # Only show models for the active provider (and named custom providers).
        # This prevents showing providers the user hasn't configured.
