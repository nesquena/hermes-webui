...
>
> Automated tests: 679 total (679 passing, 0 skipped, 0 known failures). Includes onboarding coverage for bootstrap/static wizard presence and the `/api/onboarding/*` backend.
