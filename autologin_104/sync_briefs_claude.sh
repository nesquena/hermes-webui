...
echo
echo "============================================="
echo "🗂️  Step 5: 更新招募人才知識庫"
echo "============================================="
# 把新評分的人選彙整進 talent.db（body 沒變的向量會沿用，很快）
python3 talent_kb/build_db.py || echo "⚠️  知識庫更新失敗（不影響主流程）"

echo
echo "============================================="
echo "✓ 全部結束 $(date '+%Y-%m-%d %H:%M:%S')"
echo "  知識庫網頁：python3 talent_kb/server.py → http://localhost:8090"
echo "============================================="
