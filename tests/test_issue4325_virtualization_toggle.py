...
def test_virtualize_transcript_setting_is_default_on_and_allowed():
    ...
    assert config._SETTINGS_DEFAULTS["virtualize_transcript"] is True
    assert config._SETTINGS_DEFAULTS["virtualize_transcript_optin"] is False
    assert "virtualize_transcript" in config._SETTINGS_BOOL_KEYS
    assert "virtualize_transcript_optin" in config._SETTINGS_BOOL_KEYS
