...
def test_security_helper_sends_enforcing_csp_with_hardening_directives(monkeypatch):
    ...
    assert "connect-src 'self' http://127.0.0.1:* http://localhost:* http://ipc.localhost https://127.0.0.1:* https://localhost:* http://[::1]:* https://[::1]:* ws://127.0.0.1:* ws://localhost:* https://cdn.jsdelivr.net" in policy
...
def test_enforcing_csp_honors_valid_extra_connect_origins(monkeypatch):
    ...
    assert (
        ...
        "http://[::1]:* https://[::1]:* ws://127.0.0.1:* ws://localhost:* https://cdn.jsdelivr.net "
        "https://metrics.example.com wss://events.example.com:443; "
    ) in policy
