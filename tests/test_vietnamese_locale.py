...
def test_vietnamese_locale_includes_representative_translations():
    ...
    expected = [
        ...
        "tasks_views_label: 'Chế độ xem tác vụ'",
        "tab_tasks_jobs: 'Công việc'",
        "tab_tasks_scripts: 'Tập lệnh'",
        "tasks_scripts_empty_title: 'Duyệt tập lệnh trong sidebar'",
        "tasks_scripts_empty_sub: 'Mở rộng một tập lệnh trong sidebar để xem mô tả và mã nguồn của nó.'",
