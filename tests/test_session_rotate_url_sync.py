...
def test_stream_completion_syncs_rotated_session_id_to_tab_state():
    ...
    completion_block = MESSAGES_JS[completion_pos : completion_pos + 1200]
    settled_block = MESSAGES_JS[settled_pos : settled_pos + 2200]
