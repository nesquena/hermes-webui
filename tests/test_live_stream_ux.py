...
def test_apererror_recovers_on_recovery_control_event():
    ...
    assert "if(await _restoreSettledSession(source, {preserveVisibleOnShorterTerminalSnapshot:true,transportGeneration:retainedTransportGeneration})) return;" in MESSAGES_JS
