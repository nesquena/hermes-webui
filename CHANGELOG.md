...
- Compressed sessions with hidden "resume active task" context no longer treat a short fresh greeting such as `你好` as implicit permission to continue an old agent task. Explicit continuation prompts still keep the compacted task context.
