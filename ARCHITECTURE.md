...
The Hermes Co-Work Web UI is a lightweight, single-file web application that gives Nathan
...
- Python interpreter: /home/hermes/.hermes/hermes-agent/venv/bin/python
...
- Access from Mac: SSH tunnel: ssh -N -L 8787:127.0.0.1:8787 hermes@45.79.100.32
...
See: /home/hermes/webui-mvp/tests/conftest.py
...
## 12. Common Debugging Commands
    ...
    ls -lt /home/hermes/.hermes/webui-mvp/sessions/
    cat /home/hermes/.hermes/webui-mvp/sessions/SESSION_ID.json | python3 -m json.tool
    ...
    ls /home/hermes/.hermes/webui-mvp/sessions/ | xargs -I{} python3 -c "
    import json, sys
    d = json.load(open('/home/hermes/.hermes/webui-mvp/sessions/{}'))
...
## 14. Version History
    ...
    v0.6  Sprint 4 (March 30, 2026):
            Relocation: source moved to /home/hermes/webui-mvp/, symlink back
...
4. Run the test suite first to confirm baseline: cd /home/hermes/.hermes/hermes-agent &&
   venv/bin/python -m pytest webui-mvp/tests/test_sprint1.py -v
...
Moved /home/hermes/.hermes/hermes-agent/webui-mvp/ to /home/hermes/webui-mvp/.
...
/home/hermes/webui-mvp/static/style.css: the 23KB CSS block from the Python raw string.
...
#### New Endpoints
    ...
    GET  /static/*             Serves files from /home/hermes/webui-mvp/static/ with
...
Extracted 902-line JavaScript from server.py HTML string to /home/hermes/webui-mvp/static/app.js.
...
/home/hermes/webui-mvp/static/index.html and served via disk read on each request.
