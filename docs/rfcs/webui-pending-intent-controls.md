...
cannot disagree with journal/replay order. Live-only metering publishes under
that ordering lock without a journal row, sequence reservation, or replay cursor.
Eager cancellation also publishes its
