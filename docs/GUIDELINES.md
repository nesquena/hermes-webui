...
loading the reporter's actual scene is what breaks that agreement. If you had to construct the
fixture yourself, say so in the PR and say why the issue gave you nothing to load.
