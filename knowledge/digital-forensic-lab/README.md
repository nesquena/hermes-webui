...
- `knowledge/digital-forensic-lab/knowledge-source-map.yaml`

Roadmap:

- `knowledge/digital-forensic-lab/learning-roadmap.md`
...
- `knowledge/digital-forensic-lab/working-library/library-index.yaml`
