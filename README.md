...
Over **388 contributors** have shipped code that landed in a release tag. The full, continuously-updated credit roll — including everyone with one or two PRs and the special-thanks roll for design and architectural work — lives in [`CONTRIBUTORS.md`](CONTRIBUTORS.md). A snapshot of the most prolific contributors:

### Top contributors (by PR count, including absorbed/batch-released work)

| # | Contributor | PRs | First → latest release |
|---|---|---:|---|
| 1 | [@rodboev](https://github.com/rodboev) | 336 | `v0.51.223` → `v0.52.113` |
| 2 | [@franksong2702](https://github.com/franksong2702) | 301 | `v0.49.3` → `v0.52.113` |
| 3 | [@Michaelyklam](https://github.com/Michaelyklam) | 157 | `v0.50.240` → `v0.51.198` |
| 4 | [@ai-ag2026](https://github.com/ai-ag2026) | 125 | `v0.50.279` → `v0.52.113` |
| 5 | [@bergeouss](https://github.com/bergeouss) | 80 | `v0.48.0` → `v0.51.703` |
| 6 | [@AJV20](https://github.com/AJV20) | 57 | `v0.51.93` → `v0.51.346` |
| 7 | [@webtecnica](https://github.com/webtecnica) | 47 | `v0.51.850` → `v0.52.113` |
| 8 | [@starship-s](https://github.com/starship-s) | 45 | `v0.50.123` → `v0.52.113` |
| 9 | [@dso2ng](https://github.com/dso2ng) | 43 | `v0.50.227` → `v0.51.578` |
| 10 | [@allenliang2022](https://github.com/allenliang2022) | 38 | `v0.51.185` → `v0.52.113` |

See [`CONTRIBUTORS.md`](CONTRIBUTORS.md) for the full ranked list of all 388 contributors — the 3+ PR tables, the 1–2 PR roll, and the special-thanks notes for design and architectural contributions.
