...
- OpenHuman-inspired context-layer MVPs now exist as metadata-only Capy Spaces surfaces:
  ...
  - Progress/compaction surfaces: product-home plus Space-detail progress events, Research Harness/creator visual-QA/source-refresh/demo-suite/browser-smoke/layout-repair/shared-data/widget-upsert/recovery-widget-toggle/recovery-restore progress producers, and product-visible compaction receipts for run-all, individual demo, creator preview/commit, active-context, and scoped-progress outputs.
