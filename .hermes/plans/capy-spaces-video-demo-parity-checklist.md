...
- **Progress panel visible:** **MVP implemented at product-home aggregate level.** Research Harness progress updates and creator visual-QA commit gates now emit structured metadata-only events; long-running browser/development/repair flows still need broader producer coverage.
