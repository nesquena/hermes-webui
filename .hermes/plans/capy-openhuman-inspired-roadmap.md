...
Remaining:
- Broaden cron/daemon triggering and additional source-specific fetchers while keeping existing manual/scheduled UI trigger receipts, GitHub issue/PR/release metadata ingestion, and all public UI metadata-only.
